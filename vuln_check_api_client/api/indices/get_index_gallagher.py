...
from ...models.get_index_gallagher_start_cursor import GetIndexGallagherStartCursor
from ...models.render_response_with_metadata_array_advisory_gallagher_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGallagherStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGallagherPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGallagherPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGallagherPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"gallagher\"
    ...
    **Index Description:** Gallagher Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/gallagher?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGallagherStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Gallagher Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGallagherPaginatePagination, str]
     """
