...
from ...models.get_index_nec_start_cursor import GetIndexNecStartCursor
from ...models.render_response_with_metadata_array_advisory_nec_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNecStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNECPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNECPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNECPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nec\"
    ...
    **Index Description:** NEC Security Information Notices
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNecStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NEC Security Information Notices
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNECPaginatePagination, str]
     """
