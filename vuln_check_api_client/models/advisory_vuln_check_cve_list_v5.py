...
T = TypeVar("T", bound="AdvisoryVulnCheckCVEListV5")


@_attrs_define
class AdvisoryVulnCheckCVEListV5:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_vuln_check_cve_list_v5 = cls(
            cve=cve,
        ...
        advisory_vuln_check_cve_list_v5.additional_properties = d
        return advisory_vuln_check_cve_list_v5
