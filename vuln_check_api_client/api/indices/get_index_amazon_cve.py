...
from ...models.get_index_amazon_cve_start_cursor import GetIndexAmazonCveStartCursor
from ...models.render_response_with_metadata_array_advisory_amazon_cve_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAmazonCveStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"amazon-cve\"
    ...
    **Index Description:** Amazon CVEs
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/amazon-cve?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAmazonCveStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Amazon CVEs
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAmazonCVEPaginatePagination, str]
     """
