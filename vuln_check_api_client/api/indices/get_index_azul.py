...
from ...models.get_index_azul_start_cursor import GetIndexAzulStartCursor
from ...models.render_response_with_metadata_array_advisory_azul_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAzulStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"azul\"
    ...
    **Index Description:** Azul Common Vulnerabilities and Exposures
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/azul?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAzulStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Azul Common Vulnerabilities and Exposures
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAzulPaginatePagination, str]
     """
