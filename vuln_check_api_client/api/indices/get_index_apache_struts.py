...
from ...models.get_index_apache_struts_start_cursor import GetIndexApacheStrutsStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_struts_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheStrutsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheStrutsPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheStrutsPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheStrutsPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-struts\"
    ...
    **Index Description:** Apache Struts Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-struts?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheStrutsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Struts Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheStrutsPaginatePagination, str]
     """
