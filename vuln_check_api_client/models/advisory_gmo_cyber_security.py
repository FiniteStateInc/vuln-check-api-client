...
T = TypeVar("T", bound="AdvisoryGMOCyberSecurity")


@_attrs_define
class AdvisoryGMOCyberSecurity:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_gmo_cyber_security = cls(
            affected=affected,
            cve=cve,
        ...
        advisory_gmo_cyber_security.additional_properties = d
        return advisory_gmo_cyber_security
