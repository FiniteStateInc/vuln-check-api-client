...
from ...models.get_index_trustwave_start_cursor import GetIndexTrustwaveStartCursor
from ...models.render_response_with_metadata_array_advisory_trustwave_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTrustwaveStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTrustwavePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTrustwavePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTrustwavePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"trustwave\"
    ...
    **Index Description:** Trustwave Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/trustwave?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTrustwaveStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Trustwave Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTrustwavePaginatePagination, str]
     """
