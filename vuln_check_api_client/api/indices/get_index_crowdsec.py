...
from ...models.get_index_crowdsec_start_cursor import GetIndexCrowdsecStartCursor
from ...models.render_response_with_metadata_array_advisory_crowd_sec_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCrowdsecStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCrowdSecPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCrowdSecPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCrowdSecPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"crowdsec\"
    ...
    **Index Description:** CrowdSec Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/crowdsec?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCrowdsecStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CrowdSec Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCrowdSecPaginatePagination, str]
     """
