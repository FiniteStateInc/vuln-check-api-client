...
from ...models.get_index_atlassian_start_cursor import GetIndexAtlassianStartCursor
from ...models.render_response_with_metadata_array_advisory_atlassian_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAtlassianStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"atlassian\"
    ...
    **Index Description:** Atlassian Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/atlassian?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAtlassianStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Atlassian Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAtlassianAdvisoryPaginatePagination, str]
     """
