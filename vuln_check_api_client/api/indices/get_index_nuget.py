...
from ...models.get_index_nuget_start_cursor import GetIndexNugetStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNugetStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nuget\"
    ...
    **Index Description:** Nuget (C#/F#) packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nuget?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNugetStartCursor]):
        cve (Union[Unset, str]):
