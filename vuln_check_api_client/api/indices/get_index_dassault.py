...
from ...models.get_index_dassault_start_cursor import GetIndexDassaultStartCursor
from ...models.render_response_with_metadata_array_advisory_dassault_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDassaultStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDassaultPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDassaultPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDassaultPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"dassault\"
    ...
    **Index Description:** Dassault Systèmes Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/dassault?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDassaultStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Dassault Systèmes Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDassaultPaginatePagination, str]
     """
