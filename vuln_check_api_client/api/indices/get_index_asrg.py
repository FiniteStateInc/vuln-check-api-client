...
from ...models.get_index_asrg_start_cursor import GetIndexAsrgStartCursor
from ...models.render_response_with_metadata_array_advisory_asrg_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAsrgStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"asrg\"
    ...
    **Index Description:** ASRG Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/asrg?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAsrgStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** ASRG Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryASRGPaginatePagination, str]
     """
