...
from ...models.get_index_osv_start_cursor import GetIndexOsvStartCursor
from ...models.render_response_with_metadata_array_advisory_osv_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOsvStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"osv\"
    ...
    **Index Description:** Open Source Vulnerabilities Database
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOsvStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Open Source Vulnerabilities Database
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOSVPaginatePagination, str]
     """
