...
from ...models.get_index_sigmahq_sigma_rules_start_cursor import GetIndexSigmahqSigmaRulesStartCursor
from ...models.render_response_with_metadata_array_advisory_sigma_rule_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSigmahqSigmaRulesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySigmaRulePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySigmaRulePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySigmaRulePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sigmahq-sigma-rules\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the sigmahq-sigma-rules
    index. \
    ...
    **Index Description:** Sigma Rules
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sigmahq-sigma-rules?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSigmahqSigmaRulesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Sigma Rules
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySigmaRulePaginatePagination, str]
     """
