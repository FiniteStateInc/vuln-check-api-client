...
from ...models.get_index_rustsec_advisories_start_cursor import GetIndexRustsecAdvisoriesStartCursor
from ...models.render_response_with_metadata_array_advisory_rustsec_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRustsecAdvisoriesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRustsecAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRustsecAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRustsecAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"rustsec-advisories\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the rustsec-advisories
    index. \
    ...
    **Index Description:** RustSec Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/rustsec-advisories?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRustsecAdvisoriesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** RustSec Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRustsecAdvisoryPaginatePagination, str]
     """
