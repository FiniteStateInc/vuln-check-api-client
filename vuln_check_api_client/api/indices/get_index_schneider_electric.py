...
from ...models.get_index_schneider_electric_start_cursor import GetIndexSchneiderElectricStartCursor
from ...models.render_response_with_metadata_array_advisory_schneider_electric_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSchneiderElectricStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySchneiderElectricAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySchneiderElectricAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySchneiderElectricAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"schneider-electric\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the schneider-electric
    index. \
    ...
    **Index Description:** Schneider Electric Security Notifications
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/schneider-electric?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSchneiderElectricStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Schneider Electric Security Notifications
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySchneiderElectricAdvisoryPaginatePagination, str]
     """
