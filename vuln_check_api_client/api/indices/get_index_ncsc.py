...
from ...models.get_index_ncsc_start_cursor import GetIndexNcscStartCursor
from ...models.render_response_with_metadata_array_advisory_ncsc_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNcscStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ncsc\"
    ...
    **Index Description:** NCSC Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ncsc?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNcscStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NCSC Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNCSCPaginatePagination, str]
     """
