...
from ...models.get_index_xen_start_cursor import GetIndexXenStartCursor
from ...models.render_response_with_metadata_array_advisory_xen_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexXenStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"xen\"
    ...
    **Index Description:** Xen Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexXenStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Xen Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryXenPaginatePagination, str]
     """
