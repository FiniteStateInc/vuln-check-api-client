...
from ...models.get_index_with_secure_start_cursor import GetIndexWithSecureStartCursor
from ...models.render_response_with_metadata_array_advisory_with_secure_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexWithSecureStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryWithSecurePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryWithSecurePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryWithSecurePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"with-secure\"
    ...
    **Index Description:** With Secure Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/with-secure?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexWithSecureStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** With Secure Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryWithSecurePaginatePagination, str]
     """
