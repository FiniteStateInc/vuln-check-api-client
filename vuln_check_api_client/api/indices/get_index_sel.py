...
from ...models.get_index_sel_start_cursor import GetIndexSelStartCursor
from ...models.render_response_with_metadata_array_advisory_sel_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSelStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySelPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySelPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySelPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sel\"
    ...
    **Index Description:** Schweitzer Engineering Laboratories Security Notifications
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSelStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Schweitzer Engineering Laboratories Security Notifications
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySelPaginatePagination, str]
     """
