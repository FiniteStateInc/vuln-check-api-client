...
from ...models.get_index_powerdns_start_cursor import GetIndexPowerdnsStartCursor
from ...models.render_response_with_metadata_array_advisory_power_dns_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPowerdnsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"powerdns\"
    ...
    **Index Description:** PowerDNS Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/powerdns?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPowerdnsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** PowerDNS Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPowerDNSPaginatePagination, str]
     """
