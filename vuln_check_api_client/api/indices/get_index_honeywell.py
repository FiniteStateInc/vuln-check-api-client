...
from ...models.get_index_honeywell_start_cursor import GetIndexHoneywellStartCursor
from ...models.render_response_with_metadata_array_advisory_honeywell_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHoneywellStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"honeywell\"
    ...
    **Index Description:** Honeywell Cyber Security Notifications
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/honeywell?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHoneywellStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Honeywell Cyber Security Notifications
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHoneywellPaginatePagination, str]
     """
