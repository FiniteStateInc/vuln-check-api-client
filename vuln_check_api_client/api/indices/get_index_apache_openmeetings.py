...
from ...models.get_index_apache_openmeetings_start_cursor import GetIndexApacheOpenmeetingsStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_open_meetings_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheOpenmeetingsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-openmeetings\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-openmeetings
    index. \
    ...
    **Index Description:** Apache OpenMeetings Security Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-openmeetings?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheOpenmeetingsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache OpenMeetings Security Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheOpenMeetingsPaginatePagination, str]
     """
