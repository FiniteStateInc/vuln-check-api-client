...
from ...models.get_index_f_secure_start_cursor import GetIndexFSecureStartCursor
from ...models.render_response_with_metadata_array_advisory_f_secure_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFSecureStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryFSecurePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryFSecurePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryFSecurePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"f-secure\"
    ...
    **Index Description:** F-Secure Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/f-secure?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFSecureStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** F-Secure Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryFSecurePaginatePagination, str]
     """
