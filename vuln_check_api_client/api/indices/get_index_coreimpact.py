...
from ...models.get_index_coreimpact_start_cursor import GetIndexCoreimpactStartCursor
from ...models.render_response_with_metadata_array_advisory_core_impact_exploit_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCoreimpactStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCoreImpactExploitPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCoreImpactExploitPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCoreImpactExploitPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"coreimpact\"
    ...
    **Index Description:** Core Impact
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/coreimpact?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCoreimpactStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Core Impact
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCoreImpactExploitPaginatePagination, str]
     """
