...
from ...models.get_index_canvas_start_cursor import GetIndexCanvasStartCursor
from ...models.render_response_with_metadata_array_advisory_canvas_exploit_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCanvasStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCanvasExploitPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCanvasExploitPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCanvasExploitPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"canvas\"
    ...
    **Index Description:** CANVAS Exploit Packs
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/canvas?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCanvasStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CANVAS Exploit Packs
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCanvasExploitPaginatePagination, str]
     """
