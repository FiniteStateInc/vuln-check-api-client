...
from ...models.get_index_unify_start_cursor import GetIndexUnifyStartCursor
from ...models.render_response_with_metadata_array_advisory_unify_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexUnifyStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"unify\"
    ...
    **Index Description:** Unify Product Security Advisories and Security Notes
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/unify?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexUnifyStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Unify Product Security Advisories and Security Notes
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryUnifyPaginatePagination, str]
     """
