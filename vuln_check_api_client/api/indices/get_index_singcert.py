...
from ...models.get_index_singcert_start_cursor import GetIndexSingcertStartCursor
from ...models.render_response_with_metadata_array_advisory_sing_cert_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSingcertStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"singcert\"
    ...
    **Index Description:** CSA Alerts and Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/singcert?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSingcertStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CSA Alerts and Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySingCertPaginatePagination, str]
     """
