...
from ...models.get_index_sap_start_cursor import GetIndexSapStartCursor
from ...models.render_response_with_metadata_array_advisory_sap_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSapStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sap\"
    ...
    **Index Description:** SAP Security Patch Days
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSapStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SAP Security Patch Days
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySAPPaginatePagination, str]
     """
