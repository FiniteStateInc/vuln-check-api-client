...
from ...models.get_index_harmonyos_start_cursor import GetIndexHarmonyosStartCursor
from ...models.render_response_with_metadata_array_advisory_harmony_os_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHarmonyosStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHarmonyOSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHarmonyOSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHarmonyOSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"harmonyos\"
    ...
    **Index Description:** HarmonyOS Security Updates
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/harmonyos?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHarmonyosStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** HarmonyOS Security Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHarmonyOSPaginatePagination, str]
     """
