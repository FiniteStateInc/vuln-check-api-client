...
from ...models.get_index_ruckus_start_cursor import GetIndexRuckusStartCursor
from ...models.render_response_with_metadata_array_advisory_ruckus_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRuckusStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRuckusPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRuckusPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRuckusPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ruckus\"
    ...
    **Index Description:** Ruckus Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ruckus?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRuckusStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Ruckus Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRuckusPaginatePagination, str]
     """
