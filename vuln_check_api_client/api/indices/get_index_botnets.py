...
from ...models.get_index_botnets_start_cursor import GetIndexBotnetsStartCursor
from ...models.render_response_with_metadata_array_advisory_botnet_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBotnetsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBotnetPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBotnetPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBotnetPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"botnets\"
    ...
    **Index Description:** VulnCheck Botnets
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/botnets?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBotnetsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck Botnets
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBotnetPaginatePagination, str]
     """
