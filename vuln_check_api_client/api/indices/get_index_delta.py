...
from ...models.get_index_delta_start_cursor import GetIndexDeltaStartCursor
from ...models.render_response_with_metadata_array_advisory_delta_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDeltaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDeltaAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDeltaAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDeltaAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"delta\"
    ...
    **Index Description:** Delta Controls Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/delta?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDeltaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Delta Controls Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDeltaAdvisoryPaginatePagination, str]
     """
