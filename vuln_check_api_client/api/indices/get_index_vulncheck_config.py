...
from ...models.get_index_vulncheck_config_start_cursor import GetIndexVulncheckConfigStartCursor
from ...models.render_response_with_metadata_array_advisory_vuln_check_config_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVulncheckConfigStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vulncheck-config\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the vulncheck-config
    index. \
    ...
    **Index Description:** VulnCheck Configurations
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vulncheck-config?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVulncheckConfigStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck Configurations
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckConfigPaginatePagination, str]
     """
