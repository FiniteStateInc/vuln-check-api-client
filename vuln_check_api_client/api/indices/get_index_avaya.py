...
from ...models.get_index_avaya_start_cursor import GetIndexAvayaStartCursor
from ...models.render_response_with_metadata_array_advisory_avaya_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAvayaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAvayaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAvayaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAvayaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"avaya\"
    ...
    **Index Description:** Avaya Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/avaya?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAvayaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Avaya Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAvayaPaginatePagination, str]
     """
