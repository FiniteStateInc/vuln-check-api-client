...
from ...models.get_index_zebra_start_cursor import GetIndexZebraStartCursor
from ...models.render_response_with_metadata_array_advisory_zebra_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexZebraStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"zebra\"
    ...
    **Index Description:** Zebra Security Alerts
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/zebra?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexZebraStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Zebra Security Alerts
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryZebraPaginatePagination, str]
     """
