...
from ...models.get_index_grafana_start_cursor import GetIndexGrafanaStartCursor
from ...models.render_response_with_metadata_array_advisory_grafana_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGrafanaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"grafana\"
    ...
    **Index Description:** Grafana Labs Security Fixes
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/grafana?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGrafanaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Grafana Labs Security Fixes
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGrafanaPaginatePagination, str]
     """
