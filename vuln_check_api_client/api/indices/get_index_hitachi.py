...
from ...models.get_index_hitachi_start_cursor import GetIndexHitachiStartCursor
from ...models.render_response_with_metadata_array_advisory_hitachi_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHitachiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHitachiPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHitachiPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHitachiPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hitachi\"
    ...
    **Index Description:** Hitachi Software Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/hitachi?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHitachiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Hitachi Software Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHitachiPaginatePagination, str]
     """
