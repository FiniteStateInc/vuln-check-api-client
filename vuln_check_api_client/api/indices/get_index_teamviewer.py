...
from ...models.get_index_teamviewer_start_cursor import GetIndexTeamviewerStartCursor
from ...models.render_response_with_metadata_array_advisory_team_viewer_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTeamviewerStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"teamviewer\"
    ...
    **Index Description:** TeamViewer Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/teamviewer?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTeamviewerStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** TeamViewer Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTeamViewerPaginatePagination, str]
     """
