...
from ...models.get_index_conan_start_cursor import GetIndexConanStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexConanStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"conan\"
    ...
    **Index Description:** C/C++ packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/conan?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexConanStartCursor]):
        cve (Union[Unset, str]):
