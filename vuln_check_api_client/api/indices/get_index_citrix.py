...
from ...models.get_index_citrix_start_cursor import GetIndexCitrixStartCursor
from ...models.render_response_with_metadata_array_advisory_citrix_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCitrixStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCitrixAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCitrixAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCitrixAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"citrix\"
    ...
    **Index Description:** Citrix Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/citrix?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCitrixStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Citrix Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCitrixAdvisoryPaginatePagination, str]
     """
