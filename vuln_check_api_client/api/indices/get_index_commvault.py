...
from ...models.get_index_commvault_start_cursor import GetIndexCommvaultStartCursor
from ...models.render_response_with_metadata_array_advisory_comm_vault_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCommvaultStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"commvault\"
    ...
    **Index Description:** Commvault Cloud Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/commvault?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCommvaultStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Commvault Cloud Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCommVaultPaginatePagination, str]
     """
