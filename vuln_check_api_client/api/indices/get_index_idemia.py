...
from ...models.get_index_idemia_start_cursor import GetIndexIdemiaStartCursor
from ...models.render_response_with_metadata_array_advisory_idemia_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIdemiaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryIdemiaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryIdemiaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryIdemiaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"idemia\"
    ...
    **Index Description:** Idemia Product Security Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/idemia?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIdemiaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Idemia Product Security Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryIdemiaPaginatePagination, str]
     """
