...
T = TypeVar("T", bound="AdvisoryApacheNiFi")


@_attrs_define
class AdvisoryApacheNiFi:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_apache_ni_fi.additional_properties = d
        return advisory_apache_ni_fi
