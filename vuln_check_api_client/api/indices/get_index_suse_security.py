...
from ...models.get_index_suse_security_start_cursor import GetIndexSuseSecurityStartCursor
from ...models.render_response_with_metadata_array_advisory_suse_security_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSuseSecurityStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySuseSecurityPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySuseSecurityPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySuseSecurityPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"suse-security\"
    ...
    **Index Description:** Suse Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/suse-security?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSuseSecurityStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Suse Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySuseSecurityPaginatePagination, str]
     """
