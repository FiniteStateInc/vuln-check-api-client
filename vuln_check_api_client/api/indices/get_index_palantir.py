...
from ...models.get_index_palantir_start_cursor import GetIndexPalantirStartCursor
from ...models.render_response_with_metadata_array_advisory_palantir_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPalantirStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"palantir\"
    ...
    **Index Description:** Palantir Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/palantir?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPalantirStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Palantir Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPalantirPaginatePagination, str]
     """
