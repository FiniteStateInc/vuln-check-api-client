...
from ...models.get_index_pypi_start_cursor import GetIndexPypiStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPypiStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"pypi\"
    ...
    **Index Description:** PyPi (Python) packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/pypi?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPypiStartCursor]):
        cve (Union[Unset, str]):
