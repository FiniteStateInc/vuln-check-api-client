...
from ...models.get_index_centos_start_cursor import GetIndexCentosStartCursor
from ...models.render_response_with_metadata_array_advisory_cesa_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCentosStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCESAPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCESAPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCESAPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"centos\"
    ...
    **Index Description:** CentOS Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/centos?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCentosStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CentOS Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCESAPaginatePagination, str]
     """
