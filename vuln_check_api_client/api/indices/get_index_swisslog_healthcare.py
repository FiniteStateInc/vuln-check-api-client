...
from ...models.get_index_swisslog_healthcare_start_cursor import GetIndexSwisslogHealthcareStartCursor
from ...models.render_response_with_metadata_array_advisory_swisslog_healthcare_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSwisslogHealthcareStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"swisslog-healthcare\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the swisslog-healthcare
    index. \
    ...
    **Index Description:** Swisslog Healthcare CVE Disclosures
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/swisslog-healthcare?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSwisslogHealthcareStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Swisslog Healthcare CVE Disclosures
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySwisslogHealthcareAdvisoryPaginatePagination, str]
     """
