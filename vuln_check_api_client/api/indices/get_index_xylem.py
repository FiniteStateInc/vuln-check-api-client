...
from ...models.get_index_xylem_start_cursor import GetIndexXylemStartCursor
from ...models.render_response_with_metadata_array_advisory_xylem_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexXylemStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryXylemPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryXylemPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryXylemPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"xylem\"
    ...
    **Index Description:** Xylem Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/xylem?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexXylemStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Xylem Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryXylemPaginatePagination, str]
     """
