...
from ...models.get_index_a10_start_cursor import GetIndexA10StartCursor
from ...models.render_response_with_metadata_array_advisory_a10_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexA10StartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"a10\"
    ...
    **Index Description:** A10 Networks Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexA10StartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** A10 Networks Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryA10PaginatePagination, str]
     """
