...
from ...models.get_index_ivanti_rss_start_cursor import GetIndexIvantiRssStartCursor
from ...models.render_response_with_metadata_array_advisory_ivanti_rss_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIvantiRssStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryIvantiRSSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryIvantiRSSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryIvantiRSSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ivanti-rss\"
    ...
    **Index Description:** Ivanti Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ivanti-rss?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIvantiRssStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Ivanti Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryIvantiRSSPaginatePagination, str]
     """
