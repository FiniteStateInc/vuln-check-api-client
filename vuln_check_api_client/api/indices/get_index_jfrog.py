...
from ...models.get_index_jfrog_start_cursor import GetIndexJfrogStartCursor
from ...models.render_response_with_metadata_array_advisory_j_frog_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexJfrogStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryJFrogPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryJFrogPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryJFrogPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"jfrog\"
    ...
    **Index Description:** JFrog Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/jfrog?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexJfrogStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** JFrog Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryJFrogPaginatePagination, str]
     """
