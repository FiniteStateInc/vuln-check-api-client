...
from ...models.get_index_bls_start_cursor import GetIndexBlsStartCursor
from ...models.render_response_with_metadata_array_advisory_bls_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBlsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"bls\"
    ...
    **Index Description:** Black Lantern Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBlsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Black Lantern Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBLSPaginatePagination, str]
     """
