...
from ...models.get_index_eol_start_cursor import GetIndexEolStartCursor
from ...models.render_response_with_metadata_array_advisory_eol_release_data_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexEolStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryEOLReleaseDataPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryEOLReleaseDataPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryEOLReleaseDataPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"eol\"
    ...
    **Index Description:** VulnCheck EOL Coverage
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexEolStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck EOL Coverage
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryEOLReleaseDataPaginatePagination, str]
     """
