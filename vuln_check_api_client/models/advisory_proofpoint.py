...
T = TypeVar("T", bound="AdvisoryProofpoint")


@_attrs_define
class AdvisoryProofpoint:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_proofpoint.additional_properties = d
        return advisory_proofpoint
