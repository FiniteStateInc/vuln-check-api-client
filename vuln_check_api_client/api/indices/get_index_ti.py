...
from ...models.get_index_ti_start_cursor import GetIndexTiStartCursor
from ...models.render_response_with_metadata_array_advisory_ti_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTIPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTIPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTIPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ti\"
    ...
    **Index Description:** Texas Instruments Security Bulletins
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Texas Instruments Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTIPaginatePagination, str]
     """
