...
from ...models.get_index_beckman_coulter_start_cursor import GetIndexBeckmanCoulterStartCursor
from ...models.render_response_with_metadata_array_advisory_beckman_coulter_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBeckmanCoulterStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBeckmanCoulterPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBeckmanCoulterPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBeckmanCoulterPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"beckman-coulter\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the beckman-coulter
    index. \
    ...
    **Index Description:** Beckman Coulter Product Security Updates
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/beckman-coulter?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBeckmanCoulterStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Beckman Coulter Product Security Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBeckmanCoulterPaginatePagination, str]
     """
