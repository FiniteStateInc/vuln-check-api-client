...
from ...models.get_index_nokia_start_cursor import GetIndexNokiaStartCursor
from ...models.render_response_with_metadata_array_advisory_nokia_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNokiaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNokiaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNokiaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNokiaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nokia\"
    ...
    **Index Description:** Nokia Product Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nokia?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNokiaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Nokia Product Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNokiaPaginatePagination, str]
     """
