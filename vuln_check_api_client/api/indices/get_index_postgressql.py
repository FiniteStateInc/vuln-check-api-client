...
from ...models.get_index_postgressql_start_cursor import GetIndexPostgressqlStartCursor
from ...models.render_response_with_metadata_array_advisory_postgres_sql_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPostgressqlStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"postgressql\"
    ...
    **Index Description:** PostgresSQL Security Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/postgressql?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPostgressqlStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** PostgresSQL Security Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPostgresSQLPaginatePagination, str]
     """
