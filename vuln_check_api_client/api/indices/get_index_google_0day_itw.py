...
from ...models.get_index_google_0_day_itw_start_cursor import GetIndexGoogle0DayItwStartCursor
from ...models.render_response_with_metadata_array_advisory_itw_exploit_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGoogle0DayItwStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryITWExploitPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryITWExploitPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryITWExploitPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"google-0day-itw\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the google-0day-itw
    index. \
    ...
    **Index Description:** Project Zero In the Wild Exploits
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/google-0day-itw?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGoogle0DayItwStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Project Zero In the Wild Exploits
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryITWExploitPaginatePagination, str]
     """
