...
from ...models.get_index_nz_advisories_start_cursor import GetIndexNzAdvisoriesStartCursor
from ...models.render_response_with_metadata_array_advisory_nz_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNzAdvisoriesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nz-advisories\"
    ...
    **Index Description:** CERT NZ Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nz-advisories?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNzAdvisoriesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CERT NZ Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNZAdvisoryPaginatePagination, str]
     """
