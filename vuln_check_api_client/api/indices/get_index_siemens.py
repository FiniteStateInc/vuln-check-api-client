...
from ...models.get_index_siemens_start_cursor import GetIndexSiemensStartCursor
from ...models.render_response_with_metadata_array_advisory_siemens_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSiemensStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"siemens\"
    ...
    **Index Description:** Siemens Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/siemens?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSiemensStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Siemens Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySiemensAdvisoryPaginatePagination, str]
     """
