...
if TYPE_CHECKING:
    from ..models.advisory_adp_container import AdvisoryADPContainer
    from ..models.advisory_m_cna import AdvisoryMCna


T = TypeVar("T", bound="AdvisoryMContainers")


@_attrs_define
class AdvisoryMContainers:
    """
    Attributes:
        adp (Union[Unset, list['AdvisoryADPContainer']]):
        cna (Union[Unset, AdvisoryMCna]):
    """

    adp: Union[Unset, list["AdvisoryADPContainer"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for adp_item_data in _adp or []:
            adp_item = AdvisoryADPContainer.from_dict(adp_item_data)
        ...
        advisory_m_containers = cls(
            adp=adp,
            cna=cna,
        )

        advisory_m_containers.additional_properties = d
        return advisory_m_containers
