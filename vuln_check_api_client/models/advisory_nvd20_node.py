...
T = TypeVar("T", bound="AdvisoryNVD20Node")


@_attrs_define
class AdvisoryNVD20Node:
    """
    Attributes:
        cpe_match (Union[Unset, list['AdvisoryNVD20CVECPEMatch']]):
        negate (Union[Unset, bool]):
        operator (Union[Unset, str]):
    """

    cpe_match: Union[Unset, list["AdvisoryNVD20CVECPEMatch"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for cpe_match_item_data in _cpe_match or []:
            cpe_match_item = AdvisoryNVD20CVECPEMatch.from_dict(cpe_match_item_data)
        ...
        advisory_nvd20_node = cls(
            cpe_match=cpe_match,
            negate=negate,
            operator=operator,
        )

        advisory_nvd20_node.additional_properties = d
        return advisory_nvd20_node
