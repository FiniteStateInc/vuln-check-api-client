...
from ...models.get_index_asus_start_cursor import GetIndexAsusStartCursor
from ...models.render_response_with_metadata_array_advisory_asus_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAsusStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"asus\"
    ...
    **Index Description:** ASUSTek Computer Inc.
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/asus?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAsusStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** ASUSTek Computer Inc.
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAsusPaginatePagination, str]
     """
