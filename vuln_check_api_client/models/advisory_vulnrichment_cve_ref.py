...
if TYPE_CHECKING:
    ...
    from ..models.advisory_vulnrichment_containers import AdvisoryVulnrichmentContainers


T = TypeVar("T", bound="AdvisoryVulnrichmentCVERef")


@_attrs_define
class AdvisoryVulnrichmentCVERef:
    """
    Attributes:
        containers (Union[Unset, AdvisoryVulnrichmentContainers]):
        cve_metadata (Union[Unset, AdvisoryMCveMetadata]):
        data_type (Union[Unset, str]):
        data_version (Union[Unset, str]):
    """

    containers: Union[Unset, "AdvisoryVulnrichmentContainers"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_containers, Unset):
            ...
            containers = AdvisoryVulnrichmentContainers.from_dict(_containers)
        ...
        advisory_vulnrichment_cve_ref = cls(
        ...
        advisory_vulnrichment_cve_ref.additional_properties = d
        return advisory_vulnrichment_cve_ref
