...
from ...models.get_index_bbraun_start_cursor import GetIndexBbraunStartCursor
from ...models.render_response_with_metadata_array_advisory_b_braun_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBbraunStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"bbraun\"
    ...
    **Index Description:** B. Braun Medical Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/bbraun?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBbraunStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** B. Braun Medical Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBBraunAdvisoryPaginatePagination, str]
     """
