...
from ...models.get_index_cert_ir_security_alerts_start_cursor import GetIndexCertIrSecurityAlertsStartCursor
from ...models.render_response_with_metadata_array_advisory_cert_ir_security_alert_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCertIrSecurityAlertsStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/cert-ir-security-alerts",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cert-ir-security-alerts\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the cert-ir-security-
    alerts index. \
    ...
    **Index Description:** Cert IR Security Warnings
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cert-ir-security-
    alerts?start_cursor`, the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCertIrSecurityAlertsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Cert IR Security Warnings
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCertIRSecurityAlertPaginatePagination, str]
     """
