...
from ...models.get_index_gen_start_cursor import GetIndexGenStartCursor
from ...models.render_response_with_metadata_array_advisory_gen_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGenStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGenPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGenPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGenPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"gen\"
    ...
    **Index Description:** Gen Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGenStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Gen Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGenPaginatePagination, str]
     """
