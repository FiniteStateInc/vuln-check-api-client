...
from ...models.get_index_dotcms_start_cursor import GetIndexDotcmsStartCursor
from ...models.render_response_with_metadata_array_advisory_dot_cms_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDotcmsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"dotcms\"
    ...
    **Index Description:** DotCMS Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/dotcms?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDotcmsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** DotCMS Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDotCMSPaginatePagination, str]
     """
