...
from ...models.get_index_emerging_threats_snort_start_cursor import GetIndexEmergingThreatsSnortStartCursor
from ...models.render_response_with_metadata_array_advisory_emerging_threats_snort_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexEmergingThreatsSnortStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/emerging-threats-snort",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryEmergingThreatsSnortPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryEmergingThreatsSnortPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryEmergingThreatsSnortPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"emerging-threats-snort\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the emerging-threats-
    snort index. \
    ...
    **Index Description:** Emerging Threats Snort
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/emerging-threats-
    snort?start_cursor`, the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexEmergingThreatsSnortStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Emerging Threats Snort
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryEmergingThreatsSnortPaginatePagination, str]
     """
