...
from ...models.get_index_apple_start_cursor import GetIndexAppleStartCursor
from ...models.render_response_with_metadata_array_advisory_apple_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAppleStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apple\"
    ...
    **Index Description:** Apple Security Updates
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apple?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAppleStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apple Security Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAppleAdvisoryPaginatePagination, str]
     """
