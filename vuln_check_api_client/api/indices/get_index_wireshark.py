...
from ...models.get_index_wireshark_start_cursor import GetIndexWiresharkStartCursor
from ...models.render_response_with_metadata_array_advisory_wireshark_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexWiresharkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryWiresharkPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryWiresharkPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryWiresharkPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"wireshark\"
    ...
    **Index Description:** Wireshark Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/wireshark?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexWiresharkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Wireshark Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryWiresharkPaginatePagination, str]
     """
