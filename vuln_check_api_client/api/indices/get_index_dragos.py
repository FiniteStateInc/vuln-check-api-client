...
from ...models.get_index_dragos_start_cursor import GetIndexDragosStartCursor
from ...models.render_response_with_metadata_array_advisory_dragos_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDragosStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"dragos\"
    ...
    **Index Description:** Dragos Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/dragos?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDragosStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Dragos Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDragosAdvisoryPaginatePagination, str]
     """
