...
from ...models.get_index_misp_threat_actors_start_cursor import GetIndexMispThreatActorsStartCursor
from ...models.render_response_with_metadata_array_advisory_misp_value_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMispThreatActorsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMispValuePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMispValuePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMispValuePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"misp-threat-actors\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the misp-threat-actors
    index. \
    ...
    **Index Description:** MISP Threat Actors
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/misp-threat-actors?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMispThreatActorsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** MISP Threat Actors
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMispValuePaginatePagination, str]
     """
