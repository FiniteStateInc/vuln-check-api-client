...
from ...models.get_index_gitlab_advisories_community_start_cursor import GetIndexGitlabAdvisoriesCommunityStartCursor
from ...models.render_response_with_metadata_array_advisory_gitlab_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGitlabAdvisoriesCommunityStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/gitlab-advisories-community",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGitlabAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGitlabAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGitlabAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"gitlab-advisories-community\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the gitlab-advisories-
    community index. \
    ...
    **Index Description:** GitLab Advisory Database
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/gitlab-advisories-
    community?start_cursor`, the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGitlabAdvisoriesCommunityStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** GitLab Advisory Database
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGitlabAdvisoryPaginatePagination, str]
     """
