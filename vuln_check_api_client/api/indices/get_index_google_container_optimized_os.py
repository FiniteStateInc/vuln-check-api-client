...
from ...models.get_index_google_container_optimized_os_start_cursor import GetIndexGoogleContainerOptimizedOsStartCursor
from ...models.render_response_with_metadata_array_advisory_container_os_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGoogleContainerOptimizedOsStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/google-container-optimized-os",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryContainerOSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryContainerOSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryContainerOSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"google-container-optimized-os\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the google-container-
    optimized-os index. \
    ...
    **Index Description:** Container OS Release Notes
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/google-container-optimized-
    os?start_cursor`, the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGoogleContainerOptimizedOsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Container OS Release Notes
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryContainerOSPaginatePagination, str]
     """
