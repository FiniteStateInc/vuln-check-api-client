...
from ...models.get_index_cert_se_start_cursor import GetIndexCertSeStartCursor
from ...models.render_response_with_metadata_array_advisory_cert_se_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCertSeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cert-se\"
    ...
    **Index Description:** Cert SE Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cert-se?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCertSeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Cert SE Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCertSEPaginatePagination, str]
     """
