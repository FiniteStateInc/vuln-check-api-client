...
from ...models.get_index_sick_start_cursor import GetIndexSickStartCursor
from ...models.render_response_with_metadata_array_advisory_sick_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSickStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySickPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySickPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySickPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sick\"
    ...
    **Index Description:** SICK Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sick?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSickStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SICK Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySickPaginatePagination, str]
     """
