...
from ...models.get_index_apache_superset_start_cursor import GetIndexApacheSupersetStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_superset_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheSupersetStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheSupersetPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheSupersetPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheSupersetPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-superset\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-superset
    index. \
    ...
    **Index Description:** Apache Superset CVEs
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-superset?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheSupersetStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Superset CVEs
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheSupersetPaginatePagination, str]
     """
