...
from ...models.get_index_anchore_nvd_override_start_cursor import GetIndexAnchoreNvdOverrideStartCursor
from ...models.render_response_with_metadata_array_advisory_anchore_nvd_override_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAnchoreNvdOverrideStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/anchore-nvd-override",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAnchoreNVDOverridePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAnchoreNVDOverridePaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAnchoreNVDOverridePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"anchore-nvd-override\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the anchore-nvd-override
    index. \
    ...
    **Index Description:** Anchore NVD Data Overrides
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/anchore-nvd-override?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAnchoreNvdOverrideStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Anchore NVD Data Overrides
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAnchoreNVDOverridePaginatePagination, str]
     """
