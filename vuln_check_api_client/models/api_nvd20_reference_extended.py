...
T = TypeVar("T", bound="ApiNVD20ReferenceExtended")


@_attrs_define
class ApiNVD20ReferenceExtended:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_nvd20_reference_extended = cls(
        ...
        api_nvd20_reference_extended.additional_properties = d
        return api_nvd20_reference_extended
