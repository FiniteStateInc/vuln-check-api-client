...
from ...models.get_index_nessus_start_cursor import GetIndexNessusStartCursor
from ...models.render_response_with_metadata_array_advisory_nessus_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNessusStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNessusPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNessusPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNessusPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nessus\"
    ...
    **Index Description:** Nessus Plugins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nessus?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNessusStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Nessus Plugins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNessusPaginatePagination, str]
     """
