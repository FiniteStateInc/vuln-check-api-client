...
from ...models.get_index_blackberry_start_cursor import GetIndexBlackberryStartCursor
from ...models.render_response_with_metadata_array_advisory_black_berry_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBlackberryStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"blackberry\"
    ...
    **Index Description:** BlackBerry Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/blackberry?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBlackberryStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** BlackBerry Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBlackBerryPaginatePagination, str]
     """
