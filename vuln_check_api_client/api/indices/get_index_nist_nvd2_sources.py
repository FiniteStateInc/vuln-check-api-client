...
from ...models.get_index_nist_nvd_2_sources_start_cursor import GetIndexNistNvd2SourcesStartCursor
from ...models.render_response_with_metadata_array_advisory_nvd20_source_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNistNvd2SourcesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNVD20SourcePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNVD20SourcePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNVD20SourcePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nist-nvd2-sources\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the nist-nvd2-sources
    index. \
    ...
    **Index Description:** NIST NVD 2.0 Source Data
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nist-nvd2-sources?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNistNvd2SourcesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NIST NVD 2.0 Source Data
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNVD20SourcePaginatePagination, str]
     """
