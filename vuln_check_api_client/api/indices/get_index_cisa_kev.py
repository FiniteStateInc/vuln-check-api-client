...
from ...models.get_index_cisa_kev_start_cursor import GetIndexCisaKevStartCursor
from ...models.render_response_with_metadata_array_advisory_kev_catalog_vulnerability_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCisaKevStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryKEVCatalogVulnerabilityPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryKEVCatalogVulnerabilityPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryKEVCatalogVulnerabilityPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cisa-kev\"
    ...
    **Index Description:** CISA KEV (Known Exploited Vulnerabilities)
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cisa-kev?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCisaKevStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CISA KEV (Known Exploited Vulnerabilities)
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryKEVCatalogVulnerabilityPaginatePagination, str]
     """
