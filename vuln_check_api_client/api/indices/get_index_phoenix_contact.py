...
from ...models.get_index_phoenix_contact_start_cursor import GetIndexPhoenixContactStartCursor
from ...models.render_response_with_metadata_array_advisory_phoenix_contact_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPhoenixContactStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"phoenix-contact\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the phoenix-contact
    index. \
    ...
    **Index Description:** Phoenix Contact Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/phoenix-contact?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPhoenixContactStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Phoenix Contact Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPhoenixContactAdvisoryPaginatePagination, str]
     """
