...
from ...models.get_index_rocky_purls_start_cursor import GetIndexRockyPurlsStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRockyPurlsStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"rocky-purls\"
    ...
    **Index Description:** Rocky Purls
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/rocky-purls?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRockyPurlsStartCursor]):
        cve (Union[Unset, str]):
