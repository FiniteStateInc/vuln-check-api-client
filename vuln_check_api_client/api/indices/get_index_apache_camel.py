...
from ...models.get_index_apache_camel_start_cursor import GetIndexApacheCamelStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_camel_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheCamelStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheCamelPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheCamelPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheCamelPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-camel\"
    ...
    **Index Description:** Apache Camel Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-camel?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheCamelStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Camel Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheCamelPaginatePagination, str]
     """
