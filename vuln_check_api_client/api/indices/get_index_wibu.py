...
from ...models.get_index_wibu_start_cursor import GetIndexWibuStartCursor
from ...models.render_response_with_metadata_array_advisory_wibu_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexWibuStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"wibu\"
    ...
    **Index Description:** Wibu Systems Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/wibu?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexWibuStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Wibu Systems Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryWibuPaginatePagination, str]
     """
