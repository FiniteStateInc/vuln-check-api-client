...
from ...models.get_index_django_start_cursor import GetIndexDjangoStartCursor
from ...models.render_response_with_metadata_array_advisory_django_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDjangoStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDjangoPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDjangoPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDjangoPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"django\"
    ...
    **Index Description:** Django Security Issues
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/django?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDjangoStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Django Security Issues
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDjangoPaginatePagination, str]
     """
