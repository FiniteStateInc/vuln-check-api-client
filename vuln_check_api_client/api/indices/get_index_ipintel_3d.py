...
from ...models.get_index_ipintel_3d_start_cursor import GetIndexIpintel3DStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIpintel3DStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ipintel-3d\"
    ...
    **Index Description:** 3-Day IP Intelligence Index of Initial Access Targets and Command and Control
    Infrastructure
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ipintel-3d?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIpintel3DStartCursor]):
        cve (Union[Unset, str]):
