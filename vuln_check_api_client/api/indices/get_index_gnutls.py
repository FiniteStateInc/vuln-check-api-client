...
from ...models.get_index_gnutls_start_cursor import GetIndexGnutlsStartCursor
from ...models.render_response_with_metadata_array_advisory_gnu_tls_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGnutlsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"gnutls\"
    ...
    **Index Description:** GnuTLS Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/gnutls?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGnutlsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** GnuTLS Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGnuTLSPaginatePagination, str]
     """
