...
from ...models.get_index_synacktiv_start_cursor import GetIndexSynacktivStartCursor
from ...models.render_response_with_metadata_array_advisory_synacktiv_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSynacktivStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySynacktivPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySynacktivPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySynacktivPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"synacktiv\"
    ...
    **Index Description:** Synacktiv Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/synacktiv?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSynacktivStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Synacktiv Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySynacktivPaginatePagination, str]
     """
