...
from ...models.get_index_rocky_start_cursor import GetIndexRockyStartCursor
from ...models.render_response_with_metadata_array_api_update_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRockyStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiUpdatePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiUpdatePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiUpdatePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"rocky\"
    ...
    **Index Description:** Rocky Linux Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/rocky?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRockyStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Rocky Linux Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiUpdatePaginatePagination, str]
     """
