...
from ...models.get_index_beckhoff_start_cursor import GetIndexBeckhoffStartCursor
from ...models.render_response_with_metadata_array_advisory_beckhoff_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBeckhoffStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"beckhoff\"
    ...
    **Index Description:** Beckhoff Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/beckhoff?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBeckhoffStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Beckhoff Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBeckhoffAdvisoryPaginatePagination, str]
     """
