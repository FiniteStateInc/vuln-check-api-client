...
from ...models.get_index_carrier_start_cursor import GetIndexCarrierStartCursor
from ...models.render_response_with_metadata_array_advisory_carrier_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCarrierStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"carrier\"
    ...
    **Index Description:** Carrier Product Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/carrier?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCarrierStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Carrier Product Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCarrierPaginatePagination, str]
     """
