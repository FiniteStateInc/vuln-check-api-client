...
from ...models.get_index_apache_hadoop_start_cursor import GetIndexApacheHadoopStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_hadoop_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheHadoopStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-hadoop\"
    ...
    **Index Description:** Apache Hadoop CVEs
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-hadoop?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheHadoopStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Hadoop CVEs
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheHadoopPaginatePagination, str]
     """
