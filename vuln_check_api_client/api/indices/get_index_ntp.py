...
from ...models.get_index_ntp_start_cursor import GetIndexNtpStartCursor
from ...models.render_response_with_metadata_array_advisory_ntp_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNtpStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNTPPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNTPPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNTPPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ntp\"
    ...
    **Index Description:** NTP Security Issues
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNtpStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NTP Security Issues
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNTPPaginatePagination, str]
     """
