...
from ...models.get_index_cnvd_flaws_start_cursor import GetIndexCnvdFlawsStartCursor
from ...models.render_response_with_metadata_array_advisory_cnvd_flaw_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCnvdFlawsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCNVDFlawPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCNVDFlawPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCNVDFlawPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cnvd-flaws\"
    ...
    **Index Description:** CNVD Flaws
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cnvd-flaws?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCnvdFlawsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CNVD Flaws
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCNVDFlawPaginatePagination, str]
     """
