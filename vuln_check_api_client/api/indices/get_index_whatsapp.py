...
from ...models.get_index_whatsapp_start_cursor import GetIndexWhatsappStartCursor
from ...models.render_response_with_metadata_array_advisory_whats_app_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexWhatsappStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"whatsapp\"
    ...
    **Index Description:** WhatsApp Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/whatsapp?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexWhatsappStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** WhatsApp Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryWhatsAppPaginatePagination, str]
     """
