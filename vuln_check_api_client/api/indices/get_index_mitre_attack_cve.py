...
from ...models.get_index_mitre_attack_cve_start_cursor import GetIndexMitreAttackCveStartCursor
from ...models.render_response_with_metadata_array_api_mitre_attack_to_cve_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMitreAttackCveStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mitre-attack-cve\"
    ...
    **Index Description:** MITRE ATT&CK Technique ID to CVE List
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mitre-attack-cve?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMitreAttackCveStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** MITRE ATT&CK Technique ID to CVE List
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiMitreAttackToCVEPaginatePagination, str]
     """
