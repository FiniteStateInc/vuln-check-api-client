...
T = TypeVar("T", bound="AdvisoryOracleCPUCSAF")


@_attrs_define
class AdvisoryOracleCPUCSAF:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_oracle_cpucsaf.additional_properties = d
        return advisory_oracle_cpucsaf
