...
from ...models.get_index_rocky_errata_start_cursor import GetIndexRockyErrataStartCursor
from ...models.render_response_with_metadata_array_advisory_rocky_errata_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRockyErrataStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"rocky-errata\"
    ...
    **Index Description:** Rocky Errata
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/rocky-errata?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRockyErrataStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Rocky Errata
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRockyErrataPaginatePagination, str]
     """
