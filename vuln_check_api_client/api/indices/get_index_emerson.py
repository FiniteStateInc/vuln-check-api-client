...
from ...models.get_index_emerson_start_cursor import GetIndexEmersonStartCursor
from ...models.render_response_with_metadata_array_advisory_emerson_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexEmersonStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"emerson\"
    ...
    **Index Description:** Emerson Cyber Security Notifications
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/emerson?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexEmersonStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Emerson Cyber Security Notifications
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryEmersonAdvisoryPaginatePagination, str]
     """
