...
from ...models.get_index_palo_alto_start_cursor import GetIndexPaloAltoStartCursor
from ...models.render_response_with_metadata_array_advisory_palo_alto_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPaloAltoStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"palo-alto\"
    ...
    **Index Description:** Palo Alto Networks Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/palo-alto?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPaloAltoStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Palo Alto Networks Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPaloAltoAdvisoryPaginatePagination, str]
     """
