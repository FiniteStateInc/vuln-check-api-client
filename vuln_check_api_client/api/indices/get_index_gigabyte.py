...
from ...models.get_index_gigabyte_start_cursor import GetIndexGigabyteStartCursor
from ...models.render_response_with_metadata_array_advisory_gigabyte_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGigabyteStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGigabytePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGigabytePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGigabytePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"gigabyte\"
    ...
    **Index Description:** GIGABYTE Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/gigabyte?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGigabyteStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** GIGABYTE Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGigabytePaginatePagination, str]
     """
