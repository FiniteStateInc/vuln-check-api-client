...
from ...models.get_index_spring_start_cursor import GetIndexSpringStartCursor
from ...models.render_response_with_metadata_array_advisory_spring_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSpringStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySpringPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySpringPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySpringPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"spring\"
    ...
    **Index Description:** Spring Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/spring?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSpringStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Spring Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySpringPaginatePagination, str]
     """
