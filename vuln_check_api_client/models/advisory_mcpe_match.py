...
T = TypeVar("T", bound="AdvisoryMCPEMatch")


@_attrs_define
class AdvisoryMCPEMatch:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_mcpe_match.additional_properties = d
        return advisory_mcpe_match
