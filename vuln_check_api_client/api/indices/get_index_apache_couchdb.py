...
from ...models.get_index_apache_couchdb_start_cursor import GetIndexApacheCouchdbStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_couch_db_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheCouchdbStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-couchdb\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-couchdb
    index. \
    ...
    **Index Description:** Apache CouchDB Security Issues
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-couchdb?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheCouchdbStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache CouchDB Security Issues
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheCouchDBPaginatePagination, str]
     """
