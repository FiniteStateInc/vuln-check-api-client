...
from ...models.get_index_apache_shiro_start_cursor import GetIndexApacheShiroStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_shiro_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheShiroStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheShiroPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheShiroPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheShiroPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-shiro\"
    ...
    **Index Description:** Apache Shiro Vulnerability Reports
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-shiro?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheShiroStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Shiro Vulnerability Reports
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheShiroPaginatePagination, str]
     """
