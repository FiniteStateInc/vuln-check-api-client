...
from ...models.get_index_roche_start_cursor import GetIndexRocheStartCursor
from ...models.render_response_with_metadata_array_advisory_roche_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRocheStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRochePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRochePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRochePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"roche\"
    ...
    **Index Description:** Roche Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/roche?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRocheStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Roche Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRochePaginatePagination, str]
     """
