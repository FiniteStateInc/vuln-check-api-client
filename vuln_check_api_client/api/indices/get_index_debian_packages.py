...
from ...models.get_index_debian_packages_start_cursor import GetIndexDebianPackagesStartCursor
from ...models.render_response_with_metadata_array_advisory_distro_package_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDebianPackagesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDistroPackagePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDistroPackagePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDistroPackagePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"debian-packages\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the debian-packages
    index. \
    ...
    **Index Description:** Debian Packages
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/debian-packages?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDebianPackagesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Debian Packages
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDistroPackagePaginatePagination, str]
     """
