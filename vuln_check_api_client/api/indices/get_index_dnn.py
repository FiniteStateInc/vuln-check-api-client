...
from ...models.get_index_dnn_start_cursor import GetIndexDnnStartCursor
from ...models.render_response_with_metadata_array_advisory_dnn_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDnnStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"dnn\"
    ...
    **Index Description:** DNN Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDnnStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** DNN Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDNNPaginatePagination, str]
     """
