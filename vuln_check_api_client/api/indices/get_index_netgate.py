...
from ...models.get_index_netgate_start_cursor import GetIndexNetgateStartCursor
from ...models.render_response_with_metadata_array_advisory_netgate_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNetgateStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNetgatePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNetgatePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNetgatePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"netgate\"
    ...
    **Index Description:** Netgate Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/netgate?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNetgateStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Netgate Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNetgatePaginatePagination, str]
     """
