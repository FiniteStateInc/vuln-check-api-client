...
from ...models.get_index_assetnote_start_cursor import GetIndexAssetnoteStartCursor
from ...models.render_response_with_metadata_array_advisory_asset_note_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAssetnoteStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAssetNotePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAssetNotePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAssetNotePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"assetnote\"
    ...
    **Index Description:** AssetNote Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/assetnote?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAssetnoteStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** AssetNote Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAssetNotePaginatePagination, str]
     """
