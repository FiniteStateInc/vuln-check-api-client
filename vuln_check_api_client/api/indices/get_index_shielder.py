...
from ...models.get_index_shielder_start_cursor import GetIndexShielderStartCursor
from ...models.render_response_with_metadata_array_advisory_shielder_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexShielderStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"shielder\"
    ...
    **Index Description:** Shielder Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/shielder?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexShielderStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Shielder Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryShielderPaginatePagination, str]
     """
