...
from ...models.get_index_mindray_start_cursor import GetIndexMindrayStartCursor
from ...models.render_response_with_metadata_array_advisory_mindray_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMindrayStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMindrayPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMindrayPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMindrayPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mindray\"
    ...
    **Index Description:** Mindray Cybersecurity Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mindray?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMindrayStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Mindray Cybersecurity Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMindrayPaginatePagination, str]
     """
