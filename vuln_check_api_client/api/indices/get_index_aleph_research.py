...
from ...models.get_index_aleph_research_start_cursor import GetIndexAlephResearchStartCursor
from ...models.render_response_with_metadata_array_advisory_aleph_research_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAlephResearchStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAlephResearchPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAlephResearchPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAlephResearchPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"aleph-research\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the aleph-research
    index. \
    ...
    **Index Description:** Aleph Research Vulnerability Reports
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/aleph-research?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAlephResearchStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Aleph Research Vulnerability Reports
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAlephResearchPaginatePagination, str]
     """
