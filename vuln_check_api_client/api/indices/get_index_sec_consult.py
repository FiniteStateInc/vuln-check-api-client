...
from ...models.get_index_sec_consult_start_cursor import GetIndexSecConsultStartCursor
from ...models.render_response_with_metadata_array_advisory_sec_consult_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSecConsultStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sec-consult\"
    ...
    **Index Description:** SEC Consult Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sec-consult?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSecConsultStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SEC Consult Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySECConsultPaginatePagination, str]
     """
