...
from ...models.get_index_arista_start_cursor import GetIndexAristaStartCursor
from ...models.render_response_with_metadata_array_advisory_arista_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAristaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAristaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAristaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAristaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"arista\"
    ...
    **Index Description:** Arista Networks Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/arista?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAristaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Arista Networks Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAristaPaginatePagination, str]
     """
