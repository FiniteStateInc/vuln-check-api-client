...
from ...models.get_index_pypa_advisories_start_cursor import GetIndexPypaAdvisoriesStartCursor
from ...models.render_response_with_metadata_array_advisory_py_pa_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPypaAdvisoriesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"pypa-advisories\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the pypa-advisories
    index. \
    ...
    **Index Description:** PyPA Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/pypa-advisories?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPypaAdvisoriesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** PyPA Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPyPAAdvisoryPaginatePagination, str]
     """
