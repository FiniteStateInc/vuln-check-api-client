...
from ...models.get_index_hex_start_cursor import GetIndexHexStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHexStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hex\"
    ...
    **Index Description:** Hex (Erlang) packages with package versions
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHexStartCursor]):
        cve (Union[Unset, str]):
