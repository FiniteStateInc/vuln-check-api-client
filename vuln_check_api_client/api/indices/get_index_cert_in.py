...
from ...models.get_index_cert_in_start_cursor import GetIndexCertInStartCursor
from ...models.render_response_with_metadata_array_advisory_cert_in_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCertInStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCertINPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCertINPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCertINPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cert-in\"
    ...
    **Index Description:** CERT IN Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cert-in?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCertInStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CERT IN Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCertINPaginatePagination, str]
     """
