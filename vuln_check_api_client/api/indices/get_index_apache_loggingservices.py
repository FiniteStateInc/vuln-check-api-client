...
from ...models.get_index_apache_loggingservices_start_cursor import GetIndexApacheLoggingservicesStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_logging_services_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheLoggingservicesStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/apache-loggingservices",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-loggingservices\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-
    ...
    **Index Description:** Apache Logging Services Known Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-
    loggingservices?start_cursor`, the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheLoggingservicesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Logging Services Known Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheLoggingServicesPaginatePagination, str]
     """
