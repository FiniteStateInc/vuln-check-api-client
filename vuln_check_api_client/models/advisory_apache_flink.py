...
T = TypeVar("T", bound="AdvisoryApacheFlink")


@_attrs_define
class AdvisoryApacheFlink:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_apache_flink.additional_properties = d
        return advisory_apache_flink
