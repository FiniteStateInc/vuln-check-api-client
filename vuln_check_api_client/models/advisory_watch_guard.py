...
T = TypeVar("T", bound="AdvisoryWatchGuard")


@_attrs_define
class AdvisoryWatchGuard:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_watch_guard.additional_properties = d
        return advisory_watch_guard
