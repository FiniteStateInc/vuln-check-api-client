...
from ...models.get_index_ubuntu_start_cursor import GetIndexUbuntuStartCursor
from ...models.render_response_with_metadata_array_advisory_ubuntu_cve_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexUbuntuStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ubuntu\"
    ...
    **Index Description:** Ubuntu Security Notices
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ubuntu?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexUbuntuStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Ubuntu Security Notices
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryUbuntuCVEPaginatePagination, str]
     """
