...
from ...models.get_index_zimbra_start_cursor import GetIndexZimbraStartCursor
from ...models.render_response_with_metadata_array_advisory_zimbra_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexZimbraStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryZimbraPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryZimbraPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryZimbraPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"zimbra\"
    ...
    **Index Description:** Zimbra Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/zimbra?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexZimbraStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Zimbra Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryZimbraPaginatePagination, str]
     """
