...
from ...models.get_index_codesys_start_cursor import GetIndexCodesysStartCursor
from ...models.render_response_with_metadata_array_advisory_codesys_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCodesysStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCodesysAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCodesysAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCodesysAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"codesys\"
    ...
    **Index Description:** Codesys Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/codesys?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCodesysStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Codesys Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCodesysAdvisoryPaginatePagination, str]
     """
