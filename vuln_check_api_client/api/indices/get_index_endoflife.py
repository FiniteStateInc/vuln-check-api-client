...
from ...models.get_index_endoflife_start_cursor import GetIndexEndoflifeStartCursor
from ...models.render_response_with_metadata_array_advisory_end_of_life_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexEndoflifeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"endoflife\"
    ...
    **Index Description:** End Of Life
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/endoflife?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexEndoflifeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** End Of Life
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryEndOfLifePaginatePagination, str]
     """
