...
from ...models.get_index_dfn_cert_start_cursor import GetIndexDfnCertStartCursor
from ...models.render_response_with_metadata_array_advisory_dfn_cert_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDfnCertStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDFNCertPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDFNCertPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDFNCertPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"dfn-cert\"
    ...
    **Index Description:** DFN-CERT Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/dfn-cert?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDfnCertStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** DFN-CERT Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDFNCertPaginatePagination, str]
     """
