...
from ...models.get_index_aws_start_cursor import GetIndexAwsStartCursor
from ...models.render_response_with_metadata_array_advisory_aws_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAwsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAWSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAWSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAWSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"aws\"
    ...
    **Index Description:** AWS Security Bulletins
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAwsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** AWS Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAWSPaginatePagination, str]
     """
