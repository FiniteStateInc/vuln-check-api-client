...
from ...models.get_index_checkpoint_start_cursor import GetIndexCheckpointStartCursor
from ...models.render_response_with_metadata_array_advisory_check_point_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCheckpointStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCheckPointPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCheckPointPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCheckPointPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"checkpoint\"
    ...
    **Index Description:** CheckPoint Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/checkpoint?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCheckpointStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CheckPoint Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCheckPointPaginatePagination, str]
     """
