...
from ...models.get_index_mitre_cvelist_v5_start_cursor import GetIndexMitreCvelistV5StartCursor
from ...models.render_response_with_metadata_array_advisory_mitre_cve_list_v5_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMitreCvelistV5StartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMitreCVEListV5PaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMitreCVEListV5PaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMitreCVEListV5PaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mitre-cvelist-v5\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the mitre-cvelist-v5
    index. \
    ...
    **Index Description:** MITRE CVEList V5
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mitre-cvelist-v5?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMitreCvelistV5StartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** MITRE CVEList V5
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMitreCVEListV5PaginatePagination, str]
     """
