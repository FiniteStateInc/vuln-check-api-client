...
from ...models.get_index_rockwell_start_cursor import GetIndexRockwellStartCursor
from ...models.render_response_with_metadata_array_advisory_rockwell_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRockwellStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"rockwell\"
    ...
    **Index Description:** Rockwell Automation Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/rockwell?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRockwellStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Rockwell Automation Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRockwellPaginatePagination, str]
     """
