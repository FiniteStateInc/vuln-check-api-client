...
from ...models.get_index_ipintel_90d_start_cursor import GetIndexIpintel90DStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIpintel90DStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ipintel-90d\"
    ...
    **Index Description:** 90-Day IP Intelligence Index of Initial Access Targets and Command and
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ipintel-90d?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIpintel90DStartCursor]):
        cve (Union[Unset, str]):
