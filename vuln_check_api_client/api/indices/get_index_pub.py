...
from ...models.get_index_pub_start_cursor import GetIndexPubStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPubStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"pub\"
    ...
    **Index Description:** Pub (Dart/Flutter) packages with package versions
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPubStartCursor]):
        cve (Union[Unset, str]):
