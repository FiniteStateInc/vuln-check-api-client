...
from ...models.get_index_ciena_start_cursor import GetIndexCienaStartCursor
from ...models.render_response_with_metadata_array_advisory_ciena_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCienaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCienaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCienaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCienaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ciena\"
    ...
    **Index Description:** Ciena
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ciena?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCienaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Ciena
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCienaPaginatePagination, str]
     """
