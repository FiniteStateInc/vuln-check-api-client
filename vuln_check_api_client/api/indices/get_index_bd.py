...
from ...models.get_index_bd_start_cursor import GetIndexBdStartCursor
from ...models.render_response_with_metadata_array_advisory_becton_dickinson_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBdStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBectonDickinsonAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBectonDickinsonAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBectonDickinsonAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"bd\"
    ...
    **Index Description:** Becton Dickinson Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBdStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Becton Dickinson Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBectonDickinsonAdvisoryPaginatePagination, str]
     """
