...
from ...models.get_index_debian_start_cursor import GetIndexDebianStartCursor
from ...models.render_response_with_metadata_array_advisory_vulnerable_debian_package_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDebianStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVulnerableDebianPackagePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVulnerableDebianPackagePaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVulnerableDebianPackagePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"debian\"
    ...
    **Index Description:** Debian Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/debian?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDebianStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Debian Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVulnerableDebianPackagePaginatePagination, str]
     """
