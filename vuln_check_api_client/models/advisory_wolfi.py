...
if TYPE_CHECKING:
    from ..models.advisory_wolfi_package import AdvisoryWolfiPackage


T = TypeVar("T", bound="AdvisoryWolfi")
...
class AdvisoryWolfi:
    ...
    Attributes:
        ...
        packages (Union[Unset, list['AdvisoryWolfiPackage']]):
    ...
    packages: Union[Unset, list["AdvisoryWolfiPackage"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for packages_item_data in _packages or []:
            packages_item = AdvisoryWolfiPackage.from_dict(packages_item_data)
        ...
        advisory_wolfi.additional_properties = d
        return advisory_wolfi
