...
from ...models.get_index_exodus_intel_start_cursor import GetIndexExodusIntelStartCursor
from ...models.render_response_with_metadata_array_advisory_exodus_intel_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexExodusIntelStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryExodusIntelPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryExodusIntelPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryExodusIntelPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"exodus-intel\"
    ...
    **Index Description:** Exodus Intelligence Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/exodus-intel?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexExodusIntelStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Exodus Intelligence Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryExodusIntelPaginatePagination, str]
     """
