...
from ...models.get_index_yubico_start_cursor import GetIndexYubicoStartCursor
from ...models.render_response_with_metadata_array_advisory_yubico_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexYubicoStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryYubicoPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryYubicoPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryYubicoPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"yubico\"
    ...
    **Index Description:** Yubico Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/yubico?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexYubicoStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Yubico Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryYubicoPaginatePagination, str]
     """
