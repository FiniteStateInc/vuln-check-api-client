...
from ...models.get_index_hkcert_start_cursor import GetIndexHkcertStartCursor
from ...models.render_response_with_metadata_array_advisory_hk_cert_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHkcertStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHKCertPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHKCertPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHKCertPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hkcert\"
    ...
    **Index Description:** Hong Kong CERT Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/hkcert?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHkcertStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Hong Kong CERT Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHKCertPaginatePagination, str]
     """
