...
from ...models.get_index_mitsubishi_electric_start_cursor import GetIndexMitsubishiElectricStartCursor
from ...models.render_response_with_metadata_array_advisory_mitsubishi_electric_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMitsubishiElectricStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMitsubishiElectricAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMitsubishiElectricAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMitsubishiElectricAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mitsubishi-electric\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the mitsubishi-electric
    index. \
    ...
    **Index Description:** Mitsubishi Electric Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mitsubishi-electric?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMitsubishiElectricStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Mitsubishi Electric Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMitsubishiElectricAdvisoryPaginatePagination, str]
     """
