...
from ...models.get_index_redhat_start_cursor import GetIndexRedhatStartCursor
from ...models.render_response_with_metadata_array_advisory_redhat_cve_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRedhatStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"redhat\"
    ...
    **Index Description:** Red Hat Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/redhat?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRedhatStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Red Hat Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRedhatCVEPaginatePagination, str]
     """
