...
from ...models.get_index_sonatype_start_cursor import GetIndexSonatypeStartCursor
from ...models.render_response_with_metadata_array_advisory_sonatype_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSonatypeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sonatype\"
    ...
    **Index Description:** Sonatype Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sonatype?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSonatypeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Sonatype Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySonatypePaginatePagination, str]
     """
