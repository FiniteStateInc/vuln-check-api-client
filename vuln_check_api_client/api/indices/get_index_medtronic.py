...
from ...models.get_index_medtronic_start_cursor import GetIndexMedtronicStartCursor
from ...models.render_response_with_metadata_array_advisory_medtronic_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMedtronicStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"medtronic\"
    ...
    **Index Description:** Medtronic Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/medtronic?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMedtronicStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Medtronic Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMedtronicAdvisoryPaginatePagination, str]
     """
