...
from ...models.get_index_cocoapods_start_cursor import GetIndexCocoapodsStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCocoapodsStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cocoapods\"
    ...
    **Index Description:** CocoaPods packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cocoapods?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCocoapodsStartCursor]):
        cve (Union[Unset, str]):
