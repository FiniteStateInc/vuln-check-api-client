...
from ...models.get_index_apache_kafka_start_cursor import GetIndexApacheKafkaStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_kafka_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheKafkaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-kafka\"
    ...
    **Index Description:** Apache Kafka Security Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-kafka?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheKafkaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Kafka Security Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheKafkaPaginatePagination, str]
     """
