...
from ...models.get_index_trendmicro_start_cursor import GetIndexTrendmicroStartCursor
from ...models.render_response_with_metadata_array_advisory_trend_micro_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTrendmicroStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"trendmicro\"
    ...
    **Index Description:** Trend Micro Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/trendmicro?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTrendmicroStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Trend Micro Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTrendMicroPaginatePagination, str]
     """
