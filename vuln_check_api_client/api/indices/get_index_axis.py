...
from ...models.get_index_axis_start_cursor import GetIndexAxisStartCursor
from ...models.render_response_with_metadata_array_advisory_axis_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAxisStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAxisPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAxisPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAxisPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"axis\"
    ...
    **Index Description:** Axis OS Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/axis?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAxisStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Axis OS Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAxisPaginatePagination, str]
     """
