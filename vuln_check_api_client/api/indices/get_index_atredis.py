...
from ...models.get_index_atredis_start_cursor import GetIndexAtredisStartCursor
from ...models.render_response_with_metadata_array_advisory_atredis_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAtredisStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAtredisPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAtredisPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAtredisPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"atredis\"
    ...
    **Index Description:** Atredis Partners Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/atredis?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAtredisStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Atredis Partners Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAtredisPaginatePagination, str]
     """
