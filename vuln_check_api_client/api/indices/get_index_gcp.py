...
from ...models.get_index_gcp_start_cursor import GetIndexGcpStartCursor
from ...models.render_response_with_metadata_array_advisory_gcp_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGcpStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"gcp\"
    ...
    **Index Description:** GCP Security Bulletins
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGcpStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** GCP Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGCPPaginatePagination, str]
     """
