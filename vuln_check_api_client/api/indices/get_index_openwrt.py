...
from ...models.get_index_openwrt_start_cursor import GetIndexOpenwrtStartCursor
from ...models.render_response_with_metadata_array_advisory_wrt_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOpenwrtStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"openwrt\"
    ...
    **Index Description:** OpenWrt Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/openwrt?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOpenwrtStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** OpenWrt Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryWRTPaginatePagination, str]
     """
