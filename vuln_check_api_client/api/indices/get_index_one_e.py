...
from ...models.get_index_one_e_start_cursor import GetIndexOneEStartCursor
from ...models.render_response_with_metadata_array_advisory_one_e_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOneEStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOneEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOneEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOneEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"one-e\"
    ...
    **Index Description:** 1E Published Product Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/one-e?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOneEStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** 1E Published Product Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOneEPaginatePagination, str]
     """
