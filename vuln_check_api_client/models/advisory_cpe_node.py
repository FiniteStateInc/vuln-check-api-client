...
if TYPE_CHECKING:
    from ..models.advisory_cpe_match import AdvisoryCPEMatch


T = TypeVar("T", bound="AdvisoryCPENode")


@_attrs_define
class AdvisoryCPENode:
    """
    Attributes:
        cpe_match (Union[Unset, list['AdvisoryCPEMatch']]):
        negate (Union[Unset, bool]):
        operator (Union[Unset, str]):
    """

    cpe_match: Union[Unset, list["AdvisoryCPEMatch"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for cpe_match_item_data in _cpe_match or []:
            cpe_match_item = AdvisoryCPEMatch.from_dict(cpe_match_item_data)
        ...
        advisory_cpe_node = cls(
            cpe_match=cpe_match,
            negate=negate,
            operator=operator,
        )

        advisory_cpe_node.additional_properties = d
        return advisory_cpe_node
