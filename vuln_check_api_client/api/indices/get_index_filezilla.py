...
from ...models.get_index_filezilla_start_cursor import GetIndexFilezillaStartCursor
from ...models.render_response_with_metadata_array_advisory_file_zilla_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFilezillaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryFileZillaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryFileZillaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryFileZillaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"filezilla\"
    ...
    **Index Description:** FileZilla Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/filezilla?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFilezillaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** FileZilla Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryFileZillaPaginatePagination, str]
     """
