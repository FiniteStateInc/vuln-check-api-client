...
from ...models.get_index_wolfssl_start_cursor import GetIndexWolfsslStartCursor
from ...models.render_response_with_metadata_array_advisory_wolf_ssl_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexWolfsslStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"wolfssl\"
    ...
    **Index Description:** WolfSSL Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/wolfssl?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexWolfsslStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** WolfSSL Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryWolfSSLPaginatePagination, str]
     """
