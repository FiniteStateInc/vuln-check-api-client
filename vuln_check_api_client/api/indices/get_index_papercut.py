...
from ...models.get_index_papercut_start_cursor import GetIndexPapercutStartCursor
from ...models.render_response_with_metadata_array_advisory_paper_cut_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPapercutStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPaperCutPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPaperCutPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPaperCutPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"papercut\"
    ...
    **Index Description:** PaperCut Security Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/papercut?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPapercutStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** PaperCut Security Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPaperCutPaginatePagination, str]
     """
