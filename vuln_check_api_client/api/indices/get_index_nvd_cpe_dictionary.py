...
from ...models.get_index_nvd_cpe_dictionary_start_cursor import GetIndexNvdCpeDictionaryStartCursor
from ...models.render_response_with_metadata_array_advisory_nvdcpe_dictionary_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNvdCpeDictionaryStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nvd-cpe-dictionary\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the nvd-cpe-dictionary
    index. \
    ...
    **Index Description:** NVD's CPE Dictionary
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nvd-cpe-dictionary?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNvdCpeDictionaryStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NVD's CPE Dictionary
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNVDCPEDictionaryPaginatePagination, str]
     """
