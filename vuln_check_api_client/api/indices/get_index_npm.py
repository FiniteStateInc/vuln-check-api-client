...
from ...models.get_index_npm_start_cursor import GetIndexNpmStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNpmStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"npm\"
    ...
    **Index Description:** NPM (JS/TS) packages with package versions
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNpmStartCursor]):
        cve (Union[Unset, str]):
