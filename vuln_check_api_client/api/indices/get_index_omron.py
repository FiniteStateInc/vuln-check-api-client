...
from ...models.get_index_omron_start_cursor import GetIndexOmronStartCursor
from ...models.render_response_with_metadata_array_advisory_omron_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOmronStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"omron\"
    ...
    **Index Description:** Omron Vulnerability Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/omron?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOmronStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Omron Vulnerability Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOmronPaginatePagination, str]
     """
