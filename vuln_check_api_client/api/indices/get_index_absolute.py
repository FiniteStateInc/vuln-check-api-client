...
from ...models.get_index_absolute_start_cursor import GetIndexAbsoluteStartCursor
from ...models.render_response_with_metadata_array_advisory_absolute_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAbsoluteStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAbsolutePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAbsolutePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAbsolutePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"absolute\"
    ...
    **Index Description:** Absolute Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/absolute?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAbsoluteStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Absolute Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAbsolutePaginatePagination, str]
     """
