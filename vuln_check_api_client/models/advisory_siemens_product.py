...
if TYPE_CHECKING:
    from ..models.advisory_siemens_product_identification_helper import AdvisorySiemensProductIdentificationHelper


T = TypeVar("T", bound="AdvisorySiemensProduct")


@_attrs_define
class AdvisorySiemensProduct:
    """
    Attributes:
        name (Union[Unset, str]):
        product_id (Union[Unset, str]):
        product_identification_helper (Union[Unset, AdvisorySiemensProductIdentificationHelper]):
    """

    name: Union[Unset, str] = UNSET
    product_id: Union[Unset, str] = UNSET
    product_identification_helper: Union[Unset, "AdvisorySiemensProductIdentificationHelper"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_product_identification_helper, Unset):
            ...
            product_identification_helper = AdvisorySiemensProductIdentificationHelper.from_dict(
                _product_identification_helper
            )

        advisory_siemens_product = cls(
            name=name,
            product_id=product_id,
            product_identification_helper=product_identification_helper,
        )

        advisory_siemens_product.additional_properties = d
        return advisory_siemens_product
