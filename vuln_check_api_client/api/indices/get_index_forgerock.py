...
from ...models.get_index_forgerock_start_cursor import GetIndexForgerockStartCursor
from ...models.render_response_with_metadata_array_advisory_forge_rock_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexForgerockStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryForgeRockPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryForgeRockPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryForgeRockPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"forgerock\"
    ...
    **Index Description:** ForgeRock Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/forgerock?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexForgerockStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** ForgeRock Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryForgeRockPaginatePagination, str]
     """
