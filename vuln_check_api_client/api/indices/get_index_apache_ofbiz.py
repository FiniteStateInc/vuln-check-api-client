...
from ...models.get_index_apache_ofbiz_start_cursor import GetIndexApacheOfbizStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_of_biz_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheOfbizStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheOFBizPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheOFBizPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheOFBizPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-ofbiz\"
    ...
    **Index Description:** Apache OFBiz Security Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-ofbiz?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheOfbizStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache OFBiz Security Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheOFBizPaginatePagination, str]
     """
