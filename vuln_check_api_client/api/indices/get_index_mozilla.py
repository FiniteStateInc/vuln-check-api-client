...
from ...models.get_index_mozilla_start_cursor import GetIndexMozillaStartCursor
from ...models.render_response_with_metadata_array_advisory_mozilla_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMozillaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMozillaAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMozillaAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMozillaAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mozilla\"
    ...
    **Index Description:** Mozilla Foundation Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mozilla?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMozillaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Mozilla Foundation Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMozillaAdvisoryPaginatePagination, str]
     """
