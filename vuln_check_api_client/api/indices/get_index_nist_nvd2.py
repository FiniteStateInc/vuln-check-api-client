...
from ...models.get_index_nist_nvd_2_start_cursor import GetIndexNistNvd2StartCursor
from ...models.render_response_with_metadata_array_api_nvd20cve_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNistNvd2StartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiNVD20CVEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiNVD20CVEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiNVD20CVEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nist-nvd2\"
    ...
    **Index Description:** NIST NVD 2.0
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nist-nvd2?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNistNvd2StartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NIST NVD 2.0
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiNVD20CVEPaginatePagination, str]
     """
