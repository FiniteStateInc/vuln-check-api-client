...
from ...models.get_index_philips_start_cursor import GetIndexPhilipsStartCursor
from ...models.render_response_with_metadata_array_advisory_philips_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPhilipsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPhilipsAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPhilipsAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPhilipsAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"philips\"
    ...
    **Index Description:** Philips Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/philips?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPhilipsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Philips Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPhilipsAdvisoryPaginatePagination, str]
     """
