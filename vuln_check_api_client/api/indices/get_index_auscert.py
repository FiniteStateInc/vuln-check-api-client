...
from ...models.get_index_auscert_start_cursor import GetIndexAuscertStartCursor
from ...models.render_response_with_metadata_array_advisory_aus_cert_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAuscertStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAusCertPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAusCertPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAusCertPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"auscert\"
    ...
    **Index Description:** AusCERT Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/auscert?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAuscertStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** AusCERT Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAusCertPaginatePagination, str]
     """
