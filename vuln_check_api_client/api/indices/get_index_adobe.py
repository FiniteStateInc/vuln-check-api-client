...
from ...models.get_index_adobe_start_cursor import GetIndexAdobeStartCursor
from ...models.render_response_with_metadata_array_advisory_adobe_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAdobeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAdobeAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAdobeAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAdobeAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"adobe\"
    ...
    **Index Description:** Adobe Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/adobe?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAdobeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Adobe Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAdobeAdvisoryPaginatePagination, str]
     """
