...
from ...models.get_index_github_security_advisories_start_cursor import GetIndexGithubSecurityAdvisoriesStartCursor
from ...models.render_response_with_metadata_array_advisory_gh_advisory_json_lean_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGithubSecurityAdvisoriesStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/github-security-advisories",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"github-security-advisories\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the github-security-
    advisories index. \
    ...
    **Index Description:** Github Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/github-security-
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGithubSecurityAdvisoriesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Github Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGHAdvisoryJSONLeanPaginatePagination, str]
     """
