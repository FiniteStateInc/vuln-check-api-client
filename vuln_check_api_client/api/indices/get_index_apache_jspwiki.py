...
from ...models.get_index_apache_jspwiki_start_cursor import GetIndexApacheJspwikiStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_jsp_wiki_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheJspwikiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-jspwiki\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-jspwiki
    index. \
    ...
    **Index Description:** Apache JSPWiki CVEs
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-jspwiki?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheJspwikiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache JSPWiki CVEs
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheJSPWikiPaginatePagination, str]
     """
