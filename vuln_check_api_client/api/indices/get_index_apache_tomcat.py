...
from ...models.get_index_apache_tomcat_start_cursor import GetIndexApacheTomcatStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_tomcat_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheTomcatStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheTomcatPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheTomcatPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheTomcatPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-tomcat\"
    ...
    **Index Description:** Apache Tomcat Security Vunlnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-tomcat?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheTomcatStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Tomcat Security Vunlnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheTomcatPaginatePagination, str]
     """
