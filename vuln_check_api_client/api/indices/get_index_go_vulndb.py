...
from ...models.get_index_go_vulndb_start_cursor import GetIndexGoVulndbStartCursor
from ...models.render_response_with_metadata_array_advisory_go_vuln_json_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGoVulndbStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGoVulnJSONPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGoVulnJSONPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGoVulnJSONPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"go-vulndb\"
    ...
    **Index Description:** Go Vulnerability Database
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/go-vulndb?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGoVulndbStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Go Vulnerability Database
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGoVulnJSONPaginatePagination, str]
     """
