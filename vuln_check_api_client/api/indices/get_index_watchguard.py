...
from ...models.get_index_watchguard_start_cursor import GetIndexWatchguardStartCursor
from ...models.render_response_with_metadata_array_advisory_watch_guard_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexWatchguardStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryWatchGuardPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryWatchGuardPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryWatchGuardPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"watchguard\"
    ...
    **Index Description:** Watchguard Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/watchguard?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexWatchguardStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Watchguard Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryWatchGuardPaginatePagination, str]
     """
