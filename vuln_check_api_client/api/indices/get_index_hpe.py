...
from ...models.get_index_hpe_start_cursor import GetIndexHpeStartCursor
from ...models.render_response_with_metadata_array_advisory_hpe_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHpeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHPEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHPEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHPEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hpe\"
    ...
    **Index Description:** HPE Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHpeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** HPE Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHPEPaginatePagination, str]
     """
