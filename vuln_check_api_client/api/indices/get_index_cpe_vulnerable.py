...
from ...models.get_index_cpe_vulnerable_start_cursor import GetIndexCpeVulnerableStartCursor
from ...models.render_response_with_metadata_array_advisory_vc_vulnerable_cp_es_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCpeVulnerableStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cpe-vulnerable\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the cpe-vulnerable
    index. \
    ...
    **Index Description:** Unrolled VulnCheck CPEs
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cpe-vulnerable?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCpeVulnerableStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Unrolled VulnCheck CPEs
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVCVulnerableCPEsPaginatePagination, str]
     """
