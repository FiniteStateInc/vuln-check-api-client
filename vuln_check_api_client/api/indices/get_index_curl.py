...
from ...models.get_index_curl_start_cursor import GetIndexCurlStartCursor
from ...models.render_response_with_metadata_array_advisory_curl_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCurlStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"curl\"
    ...
    **Index Description:** Curl CVEs
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/curl?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCurlStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Curl CVEs
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCurlPaginatePagination, str]
     """
