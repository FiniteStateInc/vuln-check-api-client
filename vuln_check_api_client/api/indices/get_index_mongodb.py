...
from ...models.get_index_mongodb_start_cursor import GetIndexMongodbStartCursor
from ...models.render_response_with_metadata_array_advisory_mongo_db_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMongodbStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mongodb\"
    ...
    **Index Description:** MongoDB Security Alerts
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mongodb?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMongodbStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** MongoDB Security Alerts
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMongoDBPaginatePagination, str]
     """
