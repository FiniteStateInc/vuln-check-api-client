...
from ...models.get_index_hikvision_start_cursor import GetIndexHikvisionStartCursor
from ...models.render_response_with_metadata_array_advisory_hik_vision_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHikvisionStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hikvision\"
    ...
    **Index Description:** Hikvision Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/hikvision?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHikvisionStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Hikvision Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHIKVisionPaginatePagination, str]
     """
