...
from ...models.get_index_virtuozzo_start_cursor import GetIndexVirtuozzoStartCursor
from ...models.render_response_with_metadata_array_advisory_virtuozzo_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVirtuozzoStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVirtuozzoPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVirtuozzoPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVirtuozzoPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"virtuozzo\"
    ...
    **Index Description:** Virtuozzo Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/virtuozzo?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVirtuozzoStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Virtuozzo Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVirtuozzoPaginatePagination, str]
     """
