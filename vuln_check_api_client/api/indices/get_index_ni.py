...
from ...models.get_index_ni_start_cursor import GetIndexNiStartCursor
from ...models.render_response_with_metadata_array_advisory_ni_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNIPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNIPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNIPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ni\"
    ...
    **Index Description:** National Instruments Security Updates
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** National Instruments Security Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNIPaginatePagination, str]
     """
