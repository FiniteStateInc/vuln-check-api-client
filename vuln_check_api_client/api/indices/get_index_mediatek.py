...
from ...models.get_index_mediatek_start_cursor import GetIndexMediatekStartCursor
from ...models.render_response_with_metadata_array_advisory_mediatek_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMediatekStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMediatekPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMediatekPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMediatekPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mediatek\"
    ...
    **Index Description:** MediaTek Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mediatek?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMediatekStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** MediaTek Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMediatekPaginatePagination, str]
     """
