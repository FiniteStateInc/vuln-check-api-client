...
from ...models.get_index_stormshield_start_cursor import GetIndexStormshieldStartCursor
from ...models.render_response_with_metadata_array_advisory_stormshield_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexStormshieldStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryStormshieldPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryStormshieldPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryStormshieldPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"stormshield\"
    ...
    **Index Description:** Stormshield Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/stormshield?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexStormshieldStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Stormshield Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryStormshieldPaginatePagination, str]
     """
