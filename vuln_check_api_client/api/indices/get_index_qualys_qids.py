...
from ...models.get_index_qualys_qids_start_cursor import GetIndexQualysQidsStartCursor
from ...models.render_response_with_metadata_array_advisory_qualys_qid_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexQualysQidsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"qualys-qids\"
    ...
    **Index Description:** Qualys QID
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/qualys-qids?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexQualysQidsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Qualys QID
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryQualysQIDPaginatePagination, str]
     """
