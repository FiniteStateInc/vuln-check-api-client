...
from ...models.get_index_schutzwerk_start_cursor import GetIndexSchutzwerkStartCursor
from ...models.render_response_with_metadata_array_advisory_schutzwerk_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSchutzwerkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySchutzwerkPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySchutzwerkPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySchutzwerkPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"schutzwerk\"
    ...
    **Index Description:** Schutzwerk Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/schutzwerk?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSchutzwerkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Schutzwerk Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySchutzwerkPaginatePagination, str]
     """
