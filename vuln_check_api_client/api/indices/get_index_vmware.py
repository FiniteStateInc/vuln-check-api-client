...
from ...models.get_index_vmware_start_cursor import GetIndexVmwareStartCursor
from ...models.render_response_with_metadata_array_advisory_vm_ware_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVmwareStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVMWareAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVMWareAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVMWareAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vmware\"
    ...
    **Index Description:** VMWare Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vmware?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVmwareStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VMWare Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVMWareAdvisoryPaginatePagination, str]
     """
