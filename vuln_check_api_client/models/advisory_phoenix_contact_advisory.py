...
T = TypeVar("T", bound="AdvisoryPhoenixContactAdvisory")


@_attrs_define
class AdvisoryPhoenixContactAdvisory:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_phoenix_contact_advisory = cls(
            cve=cve,
            cwe=cwe,
        ...
        advisory_phoenix_contact_advisory.additional_properties = d
        return advisory_phoenix_contact_advisory
