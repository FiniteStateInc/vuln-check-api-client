...
from ...models.get_index_suse_start_cursor import GetIndexSuseStartCursor
from ...models.render_response_with_metadata_array_advisory_cvrf_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSuseStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCvrfPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCvrfPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCvrfPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"suse\"
    ...
    **Index Description:** SUSE Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/suse?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSuseStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SUSE Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCvrfPaginatePagination, str]
     """
