...
from ...models.get_index_acronis_start_cursor import GetIndexAcronisStartCursor
from ...models.render_response_with_metadata_array_advisory_acronis_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAcronisStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAcronisPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAcronisPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAcronisPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"acronis\"
    ...
    **Index Description:** Acronis Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/acronis?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAcronisStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Acronis Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAcronisPaginatePagination, str]
     """
