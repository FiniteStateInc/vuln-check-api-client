...
from ...models.get_index_ssd_start_cursor import GetIndexSsdStartCursor
from ...models.render_response_with_metadata_array_advisory_ssd_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSsdStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySSDAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySSDAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySSDAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ssd\"
    ...
    **Index Description:** SSD Secure Disclosure Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSsdStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SSD Secure Disclosure Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySSDAdvisoryPaginatePagination, str]
     """
