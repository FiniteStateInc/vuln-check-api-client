...
from ...models.get_index_android_start_cursor import GetIndexAndroidStartCursor
from ...models.render_response_with_metadata_array_advisory_android_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAndroidStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"android\"
    ...
    **Index Description:** Android Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/android?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAndroidStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Android Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAndroidAdvisoryPaginatePagination, str]
     """
