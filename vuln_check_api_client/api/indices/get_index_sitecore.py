...
from ...models.get_index_sitecore_start_cursor import GetIndexSitecoreStartCursor
from ...models.render_response_with_metadata_array_advisory_sitecore_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSitecoreStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySitecorePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySitecorePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySitecorePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sitecore\"
    ...
    **Index Description:** Sitecore Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sitecore?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSitecoreStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Sitecore Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySitecorePaginatePagination, str]
     """
