...
from ...models.get_index_cert_be_start_cursor import GetIndexCertBeStartCursor
from ...models.render_response_with_metadata_array_advisory_cert_be_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCertBeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCertBEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCertBEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCertBEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cert-be\"
    ...
    **Index Description:** Cert BE Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cert-be?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCertBeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Cert BE Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCertBEPaginatePagination, str]
     """
