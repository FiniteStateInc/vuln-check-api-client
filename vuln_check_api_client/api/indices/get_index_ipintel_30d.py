...
from ...models.get_index_ipintel_30d_start_cursor import GetIndexIpintel30DStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIpintel30DStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ipintel-30d\"
    ...
    **Index Description:** 30-Day IP Intelligence Index of Initial Access Targets and Command and
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ipintel-30d?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIpintel30DStartCursor]):
        cve (Union[Unset, str]):
