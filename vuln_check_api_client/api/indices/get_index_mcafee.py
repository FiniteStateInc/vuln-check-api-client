...
from ...models.get_index_mcafee_start_cursor import GetIndexMcafeeStartCursor
from ...models.render_response_with_metadata_array_advisory_mc_afee_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMcafeeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mcafee\"
    ...
    **Index Description:** McAfee Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mcafee?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMcafeeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** McAfee Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMcAfeePaginatePagination, str]
     """
