...
from ...models.get_index_vlc_start_cursor import GetIndexVlcStartCursor
from ...models.render_response_with_metadata_array_advisory_vlc_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVlcStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vlc\"
    ...
    **Index Description:** VLC Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVlcStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VLC Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVLCPaginatePagination, str]
     """
