...
from ...models.get_index_wordfence_start_cursor import GetIndexWordfenceStartCursor
from ...models.render_response_with_metadata_array_advisory_wordfence_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexWordfenceStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryWordfencePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryWordfencePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryWordfencePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"wordfence\"
    ...
    **Index Description:** Wordfence Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/wordfence?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexWordfenceStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Wordfence Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryWordfencePaginatePagination, str]
     """
