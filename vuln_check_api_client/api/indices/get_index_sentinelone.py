...
from ...models.get_index_sentinelone_start_cursor import GetIndexSentineloneStartCursor
from ...models.render_response_with_metadata_array_advisory_sentinel_one_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSentineloneStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sentinelone\"
    ...
    **Index Description:** SentinelOne Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sentinelone?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSentineloneStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SentinelOne Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySentinelOnePaginatePagination, str]
     """
