...
from ...models.get_index_euvd_start_cursor import GetIndexEuvdStartCursor
from ...models.render_response_with_metadata_array_advisory_euvd_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexEuvdStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryEUVDPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryEUVDPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryEUVDPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"euvd\"
    ...
    **Index Description:** European Union Vulnerability Database
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/euvd?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexEuvdStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** European Union Vulnerability Database
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryEUVDPaginatePagination, str]
     """
