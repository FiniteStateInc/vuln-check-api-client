...
from ...models.get_index_kubernetes_start_cursor import GetIndexKubernetesStartCursor
from ...models.render_response_with_metadata_array_advisory_k8s_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexKubernetesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryK8SPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryK8SPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryK8SPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"kubernetes\"
    ...
    **Index Description:** Kubernetes Security Issues
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/kubernetes?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexKubernetesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Kubernetes Security Issues
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryK8SPaginatePagination, str]
     """
