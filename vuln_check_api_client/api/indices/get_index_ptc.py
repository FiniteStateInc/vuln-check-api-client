...
from ...models.get_index_ptc_start_cursor import GetIndexPtcStartCursor
from ...models.render_response_with_metadata_array_advisory_ptc_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPtcStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPTCPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPTCPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPTCPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ptc\"
    ...
    **Index Description:** PTC Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPtcStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** PTC Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPTCPaginatePagination, str]
     """
