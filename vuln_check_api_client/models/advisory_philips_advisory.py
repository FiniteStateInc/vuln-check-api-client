...
T = TypeVar("T", bound="AdvisoryPhilipsAdvisory")


@_attrs_define
class AdvisoryPhilipsAdvisory:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_philips_advisory.additional_properties = d
        return advisory_philips_advisory
