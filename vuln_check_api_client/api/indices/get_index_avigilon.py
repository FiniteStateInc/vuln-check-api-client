...
from ...models.get_index_avigilon_start_cursor import GetIndexAvigilonStartCursor
from ...models.render_response_with_metadata_array_advisory_avigilon_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAvigilonStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"avigilon\"
    ...
    **Index Description:** Avigilon Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/avigilon?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAvigilonStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Avigilon Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAvigilonPaginatePagination, str]
     """
