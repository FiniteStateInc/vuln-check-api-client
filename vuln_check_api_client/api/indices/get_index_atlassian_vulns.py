...
from ...models.get_index_atlassian_vulns_start_cursor import GetIndexAtlassianVulnsStartCursor
from ...models.render_response_with_metadata_array_advisory_atlassian_vuln_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAtlassianVulnsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAtlassianVulnPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAtlassianVulnPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAtlassianVulnPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"atlassian-vulns\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the atlassian-vulns
    index. \
    ...
    **Index Description:** Atlassian Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/atlassian-vulns?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAtlassianVulnsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Atlassian Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAtlassianVulnPaginatePagination, str]
     """
