...
from ...models.get_index_boston_scientific_start_cursor import GetIndexBostonScientificStartCursor
from ...models.render_response_with_metadata_array_advisory_boston_scientific_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBostonScientificStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBostonScientificAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBostonScientificAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBostonScientificAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"boston-scientific\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the boston-scientific
    index. \
    ...
    **Index Description:** Boston Scientific Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/boston-scientific?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBostonScientificStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Boston Scientific Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBostonScientificAdvisoryPaginatePagination, str]
     """
