...
from ...models.get_index_safran_start_cursor import GetIndexSafranStartCursor
from ...models.render_response_with_metadata_array_advisory_safran_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSafranStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySafranPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySafranPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySafranPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"safran\"
    ...
    **Index Description:** Safran Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/safran?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSafranStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Safran Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySafranPaginatePagination, str]
     """
