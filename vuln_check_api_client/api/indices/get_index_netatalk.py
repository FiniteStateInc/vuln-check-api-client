...
from ...models.get_index_netatalk_start_cursor import GetIndexNetatalkStartCursor
from ...models.render_response_with_metadata_array_advisory_netatalk_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNetatalkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNetatalkPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNetatalkPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNetatalkPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"netatalk\"
    ...
    **Index Description:** Netatalk Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/netatalk?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNetatalkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Netatalk Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNetatalkPaginatePagination, str]
     """
