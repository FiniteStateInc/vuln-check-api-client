...
from ...models.get_index_revive_start_cursor import GetIndexReviveStartCursor
from ...models.render_response_with_metadata_array_advisory_revive_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexReviveStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"revive\"
    ...
    **Index Description:** Revive Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/revive?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexReviveStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Revive Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRevivePaginatePagination, str]
     """
