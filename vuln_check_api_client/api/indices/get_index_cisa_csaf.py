...
from ...models.get_index_cisa_csaf_start_cursor import GetIndexCisaCsafStartCursor
from ...models.render_response_with_metadata_array_advisory_cisa_csaf_adv_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCisaCsafStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCisaCsafAdvPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCisaCsafAdvPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCisaCsafAdvPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cisa-csaf\"
    ...
    **Index Description:** CISA Security Advisories - CSAF
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cisa-csaf?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCisaCsafStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CISA Security Advisories - CSAF
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCisaCsafAdvPaginatePagination, str]
     """
