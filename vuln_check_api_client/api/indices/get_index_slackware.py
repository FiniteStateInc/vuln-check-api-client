...
from ...models.get_index_slackware_start_cursor import GetIndexSlackwareStartCursor
from ...models.render_response_with_metadata_array_advisory_slackware_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSlackwareStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySlackwarePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySlackwarePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySlackwarePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"slackware\"
    ...
    **Index Description:** Slackware Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/slackware?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSlackwareStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Slackware Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySlackwarePaginatePagination, str]
     """
