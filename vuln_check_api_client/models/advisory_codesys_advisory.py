...
T = TypeVar("T", bound="AdvisoryCodesysAdvisory")


@_attrs_define
class AdvisoryCodesysAdvisory:
    """
    Attributes:
        codesys_id (Union[Unset, str]):
    ...
    codesys_id: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({})
        if codesys_id is not UNSET:
            field_dict["codesys_id"] = codesys_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        codesys_id = d.pop("codesys_id", UNSET)
        ...
        advisory_codesys_advisory = cls(
            codesys_id=codesys_id,
            csaf_url=csaf_url,
            cve=cve,
            cwe=cwe,
        ...
        advisory_codesys_advisory.additional_properties = d
        return advisory_codesys_advisory
