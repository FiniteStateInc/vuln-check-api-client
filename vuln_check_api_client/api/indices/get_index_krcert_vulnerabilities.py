...
from ...models.get_index_krcert_vulnerabilities_start_cursor import GetIndexKrcertVulnerabilitiesStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexKrcertVulnerabilitiesStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/krcert-vulnerabilities",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"krcert-vulnerabilities\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the krcert-
    ...
    **Index Description:** KR-CERT Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/krcert-
    vulnerabilities?start_cursor`, the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexKrcertVulnerabilitiesStartCursor]):
        cve (Union[Unset, str]):
