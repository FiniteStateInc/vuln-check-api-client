...
from ...models.get_index_ge_healthcare_start_cursor import GetIndexGeHealthcareStartCursor
from ...models.render_response_with_metadata_array_advisory_ge_healthcare_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGeHealthcareStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ge-healthcare\"
    ...
    **Index Description:** GE Healthcare Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ge-healthcare?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGeHealthcareStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** GE Healthcare Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGEHealthcareAdvisoryPaginatePagination, str]
     """
