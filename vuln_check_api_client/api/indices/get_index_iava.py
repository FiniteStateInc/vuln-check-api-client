...
from ...models.get_index_iava_start_cursor import GetIndexIavaStartCursor
from ...models.render_response_with_metadata_array_advisory_iava_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIavaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"iava\"
    ...
    **Index Description:** Information Assurance Vulnerability Alerts (IAVA)
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/iava?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIavaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Information Assurance Vulnerability Alerts (IAVA)
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryIAVAPaginatePagination, str]
     """
