...
from ...models.get_index_cisa_alerts_start_cursor import GetIndexCisaAlertsStartCursor
from ...models.render_response_with_metadata_array_advisory_cisa_alert_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCisaAlertsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cisa-alerts\"
    ...
    **Index Description:** CISA Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cisa-alerts?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCisaAlertsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CISA Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCISAAlertPaginatePagination, str]
     """
