...
T = TypeVar("T", bound="AdvisoryApacheHadoop")


@_attrs_define
class AdvisoryApacheHadoop:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_apache_hadoop.additional_properties = d
        return advisory_apache_hadoop
