...
from ...models.get_index_hashicorp_start_cursor import GetIndexHashicorpStartCursor
from ...models.render_response_with_metadata_array_advisory_hashi_corp_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHashicorpStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHashiCorpPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHashiCorpPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHashiCorpPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hashicorp\"
    ...
    **Index Description:** HashiCorp Security Updates
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/hashicorp?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHashicorpStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** HashiCorp Security Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHashiCorpPaginatePagination, str]
     """
