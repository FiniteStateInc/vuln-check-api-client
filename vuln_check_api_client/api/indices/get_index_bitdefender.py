...
from ...models.get_index_bitdefender_start_cursor import GetIndexBitdefenderStartCursor
from ...models.render_response_with_metadata_array_advisory_bit_defender_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBitdefenderStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBitDefenderPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBitDefenderPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBitDefenderPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"bitdefender\"
    ...
    **Index Description:** Bitdefender Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/bitdefender?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBitdefenderStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Bitdefender Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBitDefenderPaginatePagination, str]
     """
