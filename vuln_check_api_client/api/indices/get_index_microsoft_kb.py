...
from ...models.get_index_microsoft_kb_start_cursor import GetIndexMicrosoftKbStartCursor
from ...models.render_response_with_metadata_array_advisory_microsoft_kb_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMicrosoftKbStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMicrosoftKbPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMicrosoftKbPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMicrosoftKbPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"microsoft-kb\"
    ...
    **Index Description:** Microsoft KB list by CVE
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/microsoft-kb?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMicrosoftKbStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Microsoft KB list by CVE
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMicrosoftKbPaginatePagination, str]
     """
