...
from ...models.get_index_ibm_start_cursor import GetIndexIbmStartCursor
from ...models.render_response_with_metadata_array_advisory_ibm_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIbmStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryIBMPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryIBMPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryIBMPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ibm\"
    ...
    **Index Description:** IBM Security Bulletins
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIbmStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** IBM Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryIBMPaginatePagination, str]
     """
