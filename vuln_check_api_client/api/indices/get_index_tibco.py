...
from ...models.get_index_tibco_start_cursor import GetIndexTibcoStartCursor
from ...models.render_response_with_metadata_array_advisory_tibco_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTibcoStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"tibco\"
    ...
    **Index Description:** TIBCO Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/tibco?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTibcoStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** TIBCO Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTibcoPaginatePagination, str]
     """
