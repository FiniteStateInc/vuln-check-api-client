...
from ...models.get_index_nginx_start_cursor import GetIndexNginxStartCursor
from ...models.render_response_with_metadata_array_advisory_nginx_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNginxStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nginx\"
    ...
    **Index Description:** Nginx Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nginx?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNginxStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Nginx Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNginxAdvisoryPaginatePagination, str]
     """
