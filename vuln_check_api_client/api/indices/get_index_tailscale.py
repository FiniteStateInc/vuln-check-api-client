...
from ...models.get_index_tailscale_start_cursor import GetIndexTailscaleStartCursor
from ...models.render_response_with_metadata_array_advisory_tailscale_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTailscaleStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"tailscale\"
    ...
    **Index Description:** Tailscale Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/tailscale?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTailscaleStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Tailscale Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTailscalePaginatePagination, str]
     """
