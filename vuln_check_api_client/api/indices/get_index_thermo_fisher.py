...
from ...models.get_index_thermo_fisher_start_cursor import GetIndexThermoFisherStartCursor
from ...models.render_response_with_metadata_array_advisory_thermo_fisher_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexThermoFisherStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryThermoFisherPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryThermoFisherPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryThermoFisherPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"thermo-fisher\"
    ...
    **Index Description:** Thermo Fisher Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/thermo-fisher?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexThermoFisherStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Thermo Fisher Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryThermoFisherPaginatePagination, str]
     """
