...
from ...models.get_index_fedora_start_cursor import GetIndexFedoraStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFedoraStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"fedora\"
    ...
    **Index Description:** Fedora Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/fedora?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFedoraStartCursor]):
        cve (Union[Unset, str]):
