...
from ...models.get_index_bosch_start_cursor import GetIndexBoschStartCursor
from ...models.render_response_with_metadata_array_advisory_bosch_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBoschStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBoschAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBoschAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBoschAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"bosch\"
    ...
    **Index Description:** Bosch Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/bosch?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBoschStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Bosch Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBoschAdvisoryPaginatePagination, str]
     """
