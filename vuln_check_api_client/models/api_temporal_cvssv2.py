...
T = TypeVar("T", bound="ApiTemporalCVSSV2")


@_attrs_define
class ApiTemporalCVSSV2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_temporal_cvssv2.additional_properties = d
        return api_temporal_cvssv2
