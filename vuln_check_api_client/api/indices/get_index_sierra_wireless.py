...
from ...models.get_index_sierra_wireless_start_cursor import GetIndexSierraWirelessStartCursor
from ...models.render_response_with_metadata_array_advisory_sierra_wireless_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSierraWirelessStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sierra-wireless\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the sierra-wireless
    index. \
    ...
    **Index Description:** Sierra Wireless Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sierra-wireless?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSierraWirelessStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Sierra Wireless Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySierraWirelessPaginatePagination, str]
     """
