...
from ...models.get_index_octopus_deploy_start_cursor import GetIndexOctopusDeployStartCursor
from ...models.render_response_with_metadata_array_advisory_octopus_deploy_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOctopusDeployStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOctopusDeployPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOctopusDeployPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOctopusDeployPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"octopus-deploy\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the octopus-deploy
    index. \
    ...
    **Index Description:** Octopus Deploy Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/octopus-deploy?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOctopusDeployStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Octopus Deploy Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOctopusDeployPaginatePagination, str]
     """
