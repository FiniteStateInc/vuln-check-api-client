...
from ...models.get_index_synology_start_cursor import GetIndexSynologyStartCursor
from ...models.render_response_with_metadata_array_advisory_synology_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSynologyStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySynologyPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySynologyPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySynologyPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"synology\"
    ...
    **Index Description:** Synology Product Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/synology?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSynologyStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Synology Product Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySynologyPaginatePagination, str]
     """
