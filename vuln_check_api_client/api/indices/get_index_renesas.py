...
from ...models.get_index_renesas_start_cursor import GetIndexRenesasStartCursor
from ...models.render_response_with_metadata_array_advisory_renesas_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRenesasStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRenesasPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRenesasPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRenesasPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"renesas\"
    ...
    **Index Description:** Renesas Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/renesas?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRenesasStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Renesas Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRenesasPaginatePagination, str]
     """
