...
from ...models.get_index_mitel_start_cursor import GetIndexMitelStartCursor
from ...models.render_response_with_metadata_array_advisory_mitel_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMitelStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mitel\"
    ...
    **Index Description:** Mitel Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mitel?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMitelStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Mitel Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMitelPaginatePagination, str]
     """
