...
from ...models.get_index_sonicwall_start_cursor import GetIndexSonicwallStartCursor
from ...models.render_response_with_metadata_array_advisory_sonic_wall_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSonicwallStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySonicWallAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySonicWallAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySonicWallAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sonicwall\"
    ...
    **Index Description:** SonicWall Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sonicwall?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSonicwallStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SonicWall Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySonicWallAdvisoryPaginatePagination, str]
     """
