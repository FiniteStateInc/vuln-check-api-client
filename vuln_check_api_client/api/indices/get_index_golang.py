...
from ...models.get_index_golang_start_cursor import GetIndexGolangStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGolangStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"golang\"
    ...
    **Index Description:** Golang packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/golang?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGolangStartCursor]):
        cve (Union[Unset, str]):
