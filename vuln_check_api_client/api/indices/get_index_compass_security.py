...
from ...models.get_index_compass_security_start_cursor import GetIndexCompassSecurityStartCursor
from ...models.render_response_with_metadata_array_advisory_compass_security_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCompassSecurityStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCompassSecurityPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCompassSecurityPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCompassSecurityPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"compass-security\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the compass-security
    index. \
    ...
    **Index Description:** Compass Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/compass-security?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCompassSecurityStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Compass Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCompassSecurityPaginatePagination, str]
     """
