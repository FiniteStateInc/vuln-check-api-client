...
from ...models.get_index_appcheck_start_cursor import GetIndexAppcheckStartCursor
from ...models.render_response_with_metadata_array_advisory_app_check_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAppcheckStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAppCheckPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAppCheckPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAppCheckPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"appcheck\"
    ...
    **Index Description:** AppCheck Security Alerts
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/appcheck?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAppcheckStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** AppCheck Security Alerts
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAppCheckPaginatePagination, str]
     """
