...
from ...models.get_index_filecloud_start_cursor import GetIndexFilecloudStartCursor
from ...models.render_response_with_metadata_array_advisory_file_cloud_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFilecloudStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"filecloud\"
    ...
    **Index Description:** FileCloud Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/filecloud?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFilecloudStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** FileCloud Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryFileCloudPaginatePagination, str]
     """
