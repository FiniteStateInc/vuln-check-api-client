...
from ...models.get_index_flatt_security_start_cursor import GetIndexFlattSecurityStartCursor
from ...models.render_response_with_metadata_array_advisory_flatt_security_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFlattSecurityStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryFlattSecurityPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryFlattSecurityPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryFlattSecurityPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"flatt-security\"
    ...
    **Index Description:** Flatt Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/flatt-security?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFlattSecurityStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Flatt Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryFlattSecurityPaginatePagination, str]
     """
