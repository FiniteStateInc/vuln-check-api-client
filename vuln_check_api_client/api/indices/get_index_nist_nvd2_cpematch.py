...
from ...models.get_index_nist_nvd_2_cpematch_start_cursor import GetIndexNistNvd2CpematchStartCursor
from ...models.render_response_with_metadata_array_api_nvd20cpe_match_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNistNvd2CpematchStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiNVD20CPEMatchPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiNVD20CPEMatchPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiNVD20CPEMatchPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nist-nvd2-cpematch\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the nist-nvd2-cpematch
    index. \
    ...
    **Index Description:** NIST NVD 2.0 CPE Match
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nist-nvd2-cpematch?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNistNvd2CpematchStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NIST NVD 2.0 CPE Match
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiNVD20CPEMatchPaginatePagination, str]
     """
