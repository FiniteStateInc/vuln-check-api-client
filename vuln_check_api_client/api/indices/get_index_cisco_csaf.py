...
from ...models.get_index_cisco_csaf_start_cursor import GetIndexCiscoCsafStartCursor
from ...models.render_response_with_metadata_array_advisory_cisco_csaf_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCiscoCsafStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cisco-csaf\"
    ...
    **Index Description:** Cisco CSAF
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cisco-csaf?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCiscoCsafStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Cisco CSAF
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCiscoCSAFPaginatePagination, str]
     """
