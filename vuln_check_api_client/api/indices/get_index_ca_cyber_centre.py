...
from ...models.get_index_ca_cyber_centre_start_cursor import GetIndexCaCyberCentreStartCursor
from ...models.render_response_with_metadata_array_advisory_ca_cyber_centre_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCaCyberCentreStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCACyberCentreAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCACyberCentreAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCACyberCentreAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ca-cyber-centre\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the ca-cyber-centre
    index. \
    ...
    **Index Description:** Canadian Centre for Cyber Security Alerts and Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ca-cyber-centre?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCaCyberCentreStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Canadian Centre for Cyber Security Alerts and Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCACyberCentreAdvisoryPaginatePagination, str]
     """
