...
from ...models.get_index_packetstorm_start_cursor import GetIndexPacketstormStartCursor
from ...models.render_response_with_metadata_array_advisory_packetstorm_exploit_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPacketstormStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPacketstormExploitPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPacketstormExploitPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPacketstormExploitPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"packetstorm\"
    ...
    **Index Description:** PacketStorm
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/packetstorm?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPacketstormStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** PacketStorm
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPacketstormExploitPaginatePagination, str]
     """
