...
from ...models.get_index_netapp_start_cursor import GetIndexNetappStartCursor
from ...models.render_response_with_metadata_array_advisory_net_app_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNetappStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNetAppPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNetAppPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNetAppPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"netapp\"
    ...
    **Index Description:** NetApp Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/netapp?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNetappStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NetApp Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNetAppPaginatePagination, str]
     """
