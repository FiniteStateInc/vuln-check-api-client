...
T = TypeVar("T", bound="AdvisoryHIKVision")


@_attrs_define
class AdvisoryHIKVision:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_hik_vision.additional_properties = d
        return advisory_hik_vision
