...
from ...models.get_index_vulncheck_start_cursor import GetIndexVulncheckStartCursor
from ...models.render_response_with_metadata_array_advisory_vuln_check_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVulncheckStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVulnCheckPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vulncheck\"
    ...
    **Index Description:** VulnCheck Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vulncheck?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVulncheckStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckPaginatePagination, str]
     """
