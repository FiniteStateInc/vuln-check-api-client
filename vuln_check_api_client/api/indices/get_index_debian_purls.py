...
from ...models.get_index_debian_purls_start_cursor import GetIndexDebianPurlsStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDebianPurlsStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"debian-purls\"
    ...
    **Index Description:** Debian PURLs
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/debian-purls?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDebianPurlsStartCursor]):
        cve (Union[Unset, str]):
