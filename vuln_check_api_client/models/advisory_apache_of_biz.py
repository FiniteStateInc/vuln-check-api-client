...
T = TypeVar("T", bound="AdvisoryApacheOFBiz")


@_attrs_define
class AdvisoryApacheOFBiz:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_apache_of_biz.additional_properties = d
        return advisory_apache_of_biz
