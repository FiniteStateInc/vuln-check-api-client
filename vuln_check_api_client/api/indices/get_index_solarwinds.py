...
from ...models.get_index_solarwinds_start_cursor import GetIndexSolarwindsStartCursor
from ...models.render_response_with_metadata_array_advisory_solar_winds_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSolarwindsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySolarWindsAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySolarWindsAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySolarWindsAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"solarwinds\"
    ...
    **Index Description:** SolarWinds Security Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/solarwinds?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSolarwindsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SolarWinds Security Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySolarWindsAdvisoryPaginatePagination, str]
     """
