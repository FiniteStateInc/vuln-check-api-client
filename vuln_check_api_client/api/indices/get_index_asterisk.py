...
from ...models.get_index_asterisk_start_cursor import GetIndexAsteriskStartCursor
from ...models.render_response_with_metadata_array_advisory_asterisk_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAsteriskStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"asterisk\"
    ...
    **Index Description:** Asterisk Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/asterisk?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAsteriskStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Asterisk Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAsteriskPaginatePagination, str]
     """
