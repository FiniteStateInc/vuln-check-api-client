...
from ...models.get_index_apache_pulsar_start_cursor import GetIndexApachePulsarStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_pulsar_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApachePulsarStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApachePulsarPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApachePulsarPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApachePulsarPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-pulsar\"
    ...
    **Index Description:** Apache Pulsar Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-pulsar?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApachePulsarStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Pulsar Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApachePulsarPaginatePagination, str]
     """
