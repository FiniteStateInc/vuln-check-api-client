...
from ...models.get_index_oracle_cpu_start_cursor import GetIndexOracleCpuStartCursor
from ...models.render_response_with_metadata_array_advisory_oracle_cpu_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOracleCpuStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOracleCPUPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOracleCPUPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOracleCPUPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"oracle-cpu\"
    ...
    **Index Description:** Oracle Critical Patch Update Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/oracle-cpu?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOracleCpuStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Oracle Critical Patch Update Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOracleCPUPaginatePagination, str]
     """
