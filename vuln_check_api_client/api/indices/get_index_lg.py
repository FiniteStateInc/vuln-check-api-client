...
from ...models.get_index_lg_start_cursor import GetIndexLgStartCursor
from ...models.render_response_with_metadata_array_advisory_lg_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexLgStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryLGPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryLGPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryLGPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"lg\"
    ...
    **Index Description:** LG Security Bulletins
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexLgStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** LG Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryLGPaginatePagination, str]
     """
