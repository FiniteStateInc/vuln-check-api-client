...
from ...models.get_index_progress_start_cursor import GetIndexProgressStartCursor
from ...models.render_response_with_metadata_array_advisory_progress_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexProgressStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryProgressPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryProgressPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryProgressPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"progress\"
    ...
    **Index Description:** Progress Product Alert Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/progress?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexProgressStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Progress Product Alert Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryProgressPaginatePagination, str]
     """
