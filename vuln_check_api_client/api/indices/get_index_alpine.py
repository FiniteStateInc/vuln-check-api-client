...
from ...models.get_index_alpine_start_cursor import GetIndexAlpineStartCursor
from ...models.render_response_with_metadata_array_advisory_alpine_linux_sec_db_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAlpineStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"alpine\"
    ...
    **Index Description:** Alpine Linux Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/alpine?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAlpineStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Alpine Linux Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAlpineLinuxSecDBPaginatePagination, str]
     """
