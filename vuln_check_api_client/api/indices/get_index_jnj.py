...
from ...models.get_index_jnj_start_cursor import GetIndexJnjStartCursor
from ...models.render_response_with_metadata_array_advisory_jnj_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexJnjStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryJNJAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryJNJAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryJNJAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"jnj\"
    ...
    **Index Description:** Johnson & Johnson Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexJnjStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Johnson & Johnson Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryJNJAdvisoryPaginatePagination, str]
     """
