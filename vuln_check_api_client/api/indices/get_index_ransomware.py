...
from ...models.get_index_ransomware_start_cursor import GetIndexRansomwareStartCursor
from ...models.render_response_with_metadata_array_advisory_ransomware_exploit_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRansomwareStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRansomwareExploitPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRansomwareExploitPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRansomwareExploitPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ransomware\"
    ...
    **Index Description:** VulnCheck Ransomware
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ransomware?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRansomwareStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck Ransomware
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRansomwareExploitPaginatePagination, str]
     """
