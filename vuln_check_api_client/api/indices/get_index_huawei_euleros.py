...
from ...models.get_index_huawei_euleros_start_cursor import GetIndexHuaweiEulerosStartCursor
from ...models.render_response_with_metadata_array_advisory_huawei_euler_os_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHuaweiEulerosStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHuaweiEulerOSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHuaweiEulerOSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHuaweiEulerOSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"huawei-euleros\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the huawei-euleros
    index. \
    ...
    **Index Description:** OpenEuler Operating System Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/huawei-euleros?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHuaweiEulerosStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** OpenEuler Operating System Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHuaweiEulerOSPaginatePagination, str]
     """
