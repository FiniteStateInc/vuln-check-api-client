...
from ...models.get_index_sacert_start_cursor import GetIndexSacertStartCursor
from ...models.render_response_with_metadata_array_advisory_sa_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSacertStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySAAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySAAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySAAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sacert\"
    ...
    **Index Description:** Saudi CERT
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sacert?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSacertStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Saudi CERT
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySAAdvisoryPaginatePagination, str]
     """
