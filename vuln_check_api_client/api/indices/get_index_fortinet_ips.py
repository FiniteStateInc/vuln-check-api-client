...
from ...models.get_index_fortinet_ips_start_cursor import GetIndexFortinetIpsStartCursor
from ...models.render_response_with_metadata_array_advisory_fortinet_ips_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFortinetIpsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryFortinetIPSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryFortinetIPSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryFortinetIPSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"fortinet-ips\"
    ...
    **Index Description:** Fortinet Labs Threat Encyclopedia
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/fortinet-ips?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFortinetIpsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Fortinet Labs Threat Encyclopedia
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryFortinetIPSPaginatePagination, str]
     """
