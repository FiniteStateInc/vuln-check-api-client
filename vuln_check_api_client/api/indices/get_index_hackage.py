...
from ...models.get_index_hackage_start_cursor import GetIndexHackageStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHackageStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hackage\"
    ...
    **Index Description:** Hackage (Haskell) packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/hackage?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHackageStartCursor]):
        cve (Union[Unset, str]):
