...
from ...models.get_index_amd_start_cursor import GetIndexAmdStartCursor
from ...models.render_response_with_metadata_array_advisory_amd_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAmdStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAMDPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAMDPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAMDPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"amd\"
    ...
    **Index Description:** AMD Security Bulletins
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAmdStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** AMD Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAMDPaginatePagination, str]
     """
