...
from ...models.get_index_eaton_start_cursor import GetIndexEatonStartCursor
from ...models.render_response_with_metadata_array_advisory_eaton_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexEatonStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryEatonAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryEatonAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryEatonAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"eaton\"
    ...
    **Index Description:** Eaton Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/eaton?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexEatonStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Eaton Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryEatonAdvisoryPaginatePagination, str]
     """
