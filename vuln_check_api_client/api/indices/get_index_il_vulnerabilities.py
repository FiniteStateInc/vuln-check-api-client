...
from ...models.get_index_il_vulnerabilities_start_cursor import GetIndexIlVulnerabilitiesStartCursor
from ...models.render_response_with_metadata_array_advisory_israeli_vulnerability_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIlVulnerabilitiesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryIsraeliVulnerabilityPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryIsraeliVulnerabilityPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryIsraeliVulnerabilityPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"il-vulnerabilities\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the il-vulnerabilities
    index. \
    ...
    **Index Description:** Gov.il CVE Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/il-vulnerabilities?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIlVulnerabilitiesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Gov.il CVE Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryIsraeliVulnerabilityPaginatePagination, str]
     """
