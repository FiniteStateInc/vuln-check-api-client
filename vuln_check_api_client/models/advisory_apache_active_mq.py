...
T = TypeVar("T", bound="AdvisoryApacheActiveMQ")


@_attrs_define
class AdvisoryApacheActiveMQ:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_apache_active_mq.additional_properties = d
        return advisory_apache_active_mq
