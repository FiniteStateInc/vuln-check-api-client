...
from ...models.get_index_openssl_secadv_start_cursor import GetIndexOpensslSecadvStartCursor
from ...models.render_response_with_metadata_array_advisory_open_ssl_sec_adv_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOpensslSecadvStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOpenSSLSecAdvPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOpenSSLSecAdvPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOpenSSLSecAdvPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"openssl-secadv\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the openssl-secadv
    index. \
    ...
    **Index Description:** OpenSSL Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/openssl-secadv?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOpensslSecadvStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** OpenSSL Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOpenSSLSecAdvPaginatePagination, str]
     """
