...
from ...models.get_index_open_cvdb_start_cursor import GetIndexOpenCvdbStartCursor
from ...models.render_response_with_metadata_array_advisory_open_cvdb_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOpenCvdbStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOpenCVDBPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOpenCVDBPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOpenCVDBPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"open-cvdb\"
    ...
    **Index Description:** The Open Cloud Vulnerability & Security Issue Database
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/open-cvdb?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOpenCvdbStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** The Open Cloud Vulnerability & Security Issue Database
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOpenCVDBPaginatePagination, str]
     """
