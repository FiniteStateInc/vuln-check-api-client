...
from ...models.get_index_cbl_mariner_start_cursor import GetIndexCblMarinerStartCursor
from ...models.render_response_with_metadata_array_advisory_cbl_mariner_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCblMarinerStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cbl-mariner\"
    ...
    **Index Description:** CBL-Mariner Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cbl-mariner?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCblMarinerStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CBL-Mariner Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCBLMarinerPaginatePagination, str]
     """
