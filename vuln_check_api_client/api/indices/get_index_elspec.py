...
from ...models.get_index_elspec_start_cursor import GetIndexElspecStartCursor
from ...models.render_response_with_metadata_array_advisory_elspec_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexElspecStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryElspecPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryElspecPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryElspecPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"elspec\"
    ...
    **Index Description:** Elspec Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/elspec?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexElspecStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Elspec Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryElspecPaginatePagination, str]
     """
