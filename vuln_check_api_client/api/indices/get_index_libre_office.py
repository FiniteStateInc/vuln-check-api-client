...
from ...models.get_index_libre_office_start_cursor import GetIndexLibreOfficeStartCursor
from ...models.render_response_with_metadata_array_advisory_libre_office_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexLibreOfficeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryLibreOfficePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryLibreOfficePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryLibreOfficePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"libre-office\"
    ...
    **Index Description:** Libre Office Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/libre-office?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexLibreOfficeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Libre Office Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryLibreOfficePaginatePagination, str]
     """
