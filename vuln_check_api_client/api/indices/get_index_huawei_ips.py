...
from ...models.get_index_huawei_ips_start_cursor import GetIndexHuaweiIpsStartCursor
from ...models.render_response_with_metadata_array_advisory_huawei_ips_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHuaweiIpsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHuaweiIPSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHuaweiIPSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHuaweiIPSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"huawei-ips\"
    ...
    **Index Description:** Huawei IPS Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/huawei-ips?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHuaweiIpsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Huawei IPS Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHuaweiIPSPaginatePagination, str]
     """
