...
from ...models.get_index_redhat_cves_start_cursor import GetIndexRedhatCvesStartCursor
from ...models.render_response_with_metadata_array_advisory_rhel_cve_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRedhatCvesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRhelCVEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRhelCVEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRhelCVEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"redhat-cves\"
    ...
    **Index Description:** CSAF data for redhat
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/redhat-cves?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRedhatCvesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CSAF data for redhat
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRhelCVEPaginatePagination, str]
     """
