...
from ...models.get_index_syss_start_cursor import GetIndexSyssStartCursor
from ...models.render_response_with_metadata_array_advisory_syss_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSyssStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySyssPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySyssPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySyssPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"syss\"
    ...
    **Index Description:** Syss Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/syss?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSyssStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Syss Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySyssPaginatePagination, str]
     """
