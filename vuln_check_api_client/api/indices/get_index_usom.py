...
from ...models.get_index_usom_start_cursor import GetIndexUsomStartCursor
from ...models.render_response_with_metadata_array_advisory_usom_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexUsomStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryUSOMAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryUSOMAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryUSOMAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"usom\"
    ...
    **Index Description:** USOM Security Notices
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/usom?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexUsomStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** USOM Security Notices
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryUSOMAdvisoryPaginatePagination, str]
     """
