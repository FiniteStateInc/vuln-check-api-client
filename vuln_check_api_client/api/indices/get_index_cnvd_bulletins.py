...
from ...models.get_index_cnvd_bulletins_start_cursor import GetIndexCnvdBulletinsStartCursor
from ...models.render_response_with_metadata_array_advisory_cnvd_bulletin_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCnvdBulletinsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCNVDBulletinPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCNVDBulletinPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCNVDBulletinPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cnvd-bulletins\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the cnvd-bulletins
    index. \
    ...
    **Index Description:** CNVD Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cnvd-bulletins?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCnvdBulletinsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CNVD Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCNVDBulletinPaginatePagination, str]
     """
