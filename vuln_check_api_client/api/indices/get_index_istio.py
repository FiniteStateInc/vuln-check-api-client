...
from ...models.get_index_istio_start_cursor import GetIndexIstioStartCursor
from ...models.render_response_with_metadata_array_advisory_istio_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIstioStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryIstioPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryIstioPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryIstioPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"istio\"
    ...
    **Index Description:** Istio Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/istio?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIstioStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Istio Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryIstioPaginatePagination, str]
     """
