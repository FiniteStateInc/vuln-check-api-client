...
from ...models.get_index_cargo_start_cursor import GetIndexCargoStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCargoStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cargo\"
    ...
    **Index Description:** Cargo (Rust) packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cargo?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCargoStartCursor]):
        cve (Union[Unset, str]):
