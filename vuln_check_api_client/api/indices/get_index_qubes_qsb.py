...
from ...models.get_index_qubes_qsb_start_cursor import GetIndexQubesQsbStartCursor
from ...models.render_response_with_metadata_array_advisory_qsb_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexQubesQsbStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"qubes-qsb\"
    ...
    **Index Description:** Qubes Security Bulletin
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/qubes-qsb?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexQubesQsbStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Qubes Security Bulletin
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryQSBPaginatePagination, str]
     """
