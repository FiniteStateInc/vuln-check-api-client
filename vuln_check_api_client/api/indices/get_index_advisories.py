...
from ...models.get_index_advisories_start_cursor import GetIndexAdvisoriesStartCursor
from ...models.render_response_with_metadata_array_advisory_advisory_record_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAdvisoriesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAdvisoryRecordPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAdvisoryRecordPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAdvisoryRecordPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"advisories\"
    ...
    **Index Description:** VulnCheck Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/advisories?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAdvisoriesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAdvisoryRecordPaginatePagination, str]
     """
