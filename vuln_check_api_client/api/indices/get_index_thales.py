...
from ...models.get_index_thales_start_cursor import GetIndexThalesStartCursor
from ...models.render_response_with_metadata_array_advisory_thales_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexThalesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryThalesPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryThalesPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryThalesPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"thales\"
    ...
    **Index Description:** Thales Security Updates
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/thales?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexThalesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Thales Security Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryThalesPaginatePagination, str]
     """
