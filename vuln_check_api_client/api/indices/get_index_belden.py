...
from ...models.get_index_belden_start_cursor import GetIndexBeldenStartCursor
from ...models.render_response_with_metadata_array_advisory_belden_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBeldenStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"belden\"
    ...
    **Index Description:** Belden Security Bulletins Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/belden?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBeldenStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Belden Security Bulletins Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBeldenAdvisoryPaginatePagination, str]
     """
