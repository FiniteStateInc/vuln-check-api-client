...
from ...models.get_index_apache_flink_start_cursor import GetIndexApacheFlinkStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_flink_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheFlinkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheFlinkPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheFlinkPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheFlinkPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-flink\"
    ...
    **Index Description:** Apache Flink Security Updates
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-flink?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheFlinkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Flink Security Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheFlinkPaginatePagination, str]
     """
