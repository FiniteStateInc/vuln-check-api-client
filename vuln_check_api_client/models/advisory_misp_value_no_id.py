...
T = TypeVar("T", bound="AdvisoryMISPValueNoID")


@_attrs_define
class AdvisoryMISPValueNoID:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_misp_value_no_id.additional_properties = d
        return advisory_misp_value_no_id
