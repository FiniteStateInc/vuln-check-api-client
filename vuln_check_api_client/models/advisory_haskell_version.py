...
T = TypeVar("T", bound="AdvisoryHaskellVersion")


@_attrs_define
class AdvisoryHaskellVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_haskell_version = cls(
            fixed=fixed,
            introduced=introduced,
        )

        advisory_haskell_version.additional_properties = d
        return advisory_haskell_version
