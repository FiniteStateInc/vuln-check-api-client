...
from ...models.get_index_apache_spark_start_cursor import GetIndexApacheSparkStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_spark_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheSparkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-spark\"
    ...
    **Index Description:** Apache Spark Known Security Issues
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-spark?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheSparkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Spark Known Security Issues
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheSparkPaginatePagination, str]
     """
