...
from ...models.get_index_xerox_start_cursor import GetIndexXeroxStartCursor
from ...models.render_response_with_metadata_array_advisory_xerox_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexXeroxStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"xerox\"
    ...
    **Index Description:** Xerox Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/xerox?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexXeroxStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Xerox Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryXeroxPaginatePagination, str]
     """
