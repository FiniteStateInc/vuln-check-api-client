...
from ...models.get_index_audiocodes_start_cursor import GetIndexAudiocodesStartCursor
from ...models.render_response_with_metadata_array_advisory_audiocodes_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAudiocodesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAudiocodesPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAudiocodesPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAudiocodesPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"audiocodes\"
    ...
    **Index Description:** AudioCodes Product Notices
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/audiocodes?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAudiocodesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** AudioCodes Product Notices
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAudiocodesPaginatePagination, str]
     """
