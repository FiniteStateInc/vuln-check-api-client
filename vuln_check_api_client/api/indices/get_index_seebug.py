...
from ...models.get_index_seebug_start_cursor import GetIndexSeebugStartCursor
from ...models.render_response_with_metadata_array_advisory_seebug_exploit_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSeebugStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySeebugExploitPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySeebugExploitPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySeebugExploitPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"seebug\"
    ...
    **Index Description:** Seebug Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/seebug?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSeebugStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Seebug Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySeebugExploitPaginatePagination, str]
     """
