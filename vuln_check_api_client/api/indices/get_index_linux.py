...
from ...models.get_index_linux_start_cursor import GetIndexLinuxStartCursor
from ...models.render_response_with_metadata_array_advisory_linux_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexLinuxStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryLinuxPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryLinuxPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryLinuxPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"linux\"
    ...
    **Index Description:** Linux Kernel Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/linux?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexLinuxStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Linux Kernel Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryLinuxPaginatePagination, str]
     """
