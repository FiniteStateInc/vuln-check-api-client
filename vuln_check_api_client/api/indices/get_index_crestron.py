...
from ...models.get_index_crestron_start_cursor import GetIndexCrestronStartCursor
from ...models.render_response_with_metadata_array_advisory_crestron_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCrestronStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCrestronPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCrestronPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCrestronPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"crestron\"
    ...
    **Index Description:** Crestron Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/crestron?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCrestronStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Crestron Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCrestronPaginatePagination, str]
     """
