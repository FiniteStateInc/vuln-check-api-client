...
from ...models.get_index_oracle_cpu_csaf_start_cursor import GetIndexOracleCpuCsafStartCursor
from ...models.render_response_with_metadata_array_advisory_oracle_cpucsaf_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOracleCpuCsafStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOracleCPUCSAFPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOracleCPUCSAFPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOracleCPUCSAFPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"oracle-cpu-csaf\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the oracle-cpu-csaf
    index. \
    ...
    **Index Description:** Oracle Critical Patch Updates CSAF
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/oracle-cpu-csaf?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOracleCpuCsafStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Oracle Critical Patch Updates CSAF
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOracleCPUCSAFPaginatePagination, str]
     """
