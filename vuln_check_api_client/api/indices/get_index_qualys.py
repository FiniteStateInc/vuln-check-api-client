...
from ...models.get_index_qualys_start_cursor import GetIndexQualysStartCursor
from ...models.render_response_with_metadata_array_advisory_qualys_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexQualysStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"qualys\"
    ...
    **Index Description:** Qualys Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/qualys?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexQualysStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Qualys Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryQualysPaginatePagination, str]
     """
