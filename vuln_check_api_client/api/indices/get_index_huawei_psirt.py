...
from ...models.get_index_huawei_psirt_start_cursor import GetIndexHuaweiPsirtStartCursor
from ...models.render_response_with_metadata_array_advisory_huawei_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHuaweiPsirtStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHuaweiPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHuaweiPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHuaweiPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"huawei-psirt\"
    ...
    **Index Description:** Huawei Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/huawei-psirt?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHuaweiPsirtStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Huawei Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHuaweiPaginatePagination, str]
     """
