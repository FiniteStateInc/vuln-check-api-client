...
from ...models.get_index_gmo_cybersecurity_start_cursor import GetIndexGmoCybersecurityStartCursor
from ...models.render_response_with_metadata_array_advisory_gmo_cyber_security_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGmoCybersecurityStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGMOCyberSecurityPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGMOCyberSecurityPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGMOCyberSecurityPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"gmo-cybersecurity\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the gmo-cybersecurity
    index. \
    ...
    **Index Description:** GMO Cybersecurity Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/gmo-cybersecurity?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGmoCybersecurityStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** GMO Cybersecurity Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGMOCyberSecurityPaginatePagination, str]
     """
