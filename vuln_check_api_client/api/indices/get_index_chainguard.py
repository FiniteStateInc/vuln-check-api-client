...
from ...models.get_index_chainguard_start_cursor import GetIndexChainguardStartCursor
from ...models.render_response_with_metadata_array_advisory_chain_guard_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexChainguardStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryChainGuardPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryChainGuardPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryChainGuardPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"chainguard\"
    ...
    **Index Description:** ChainGuard Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/chainguard?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexChainguardStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** ChainGuard Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryChainGuardPaginatePagination, str]
     """
