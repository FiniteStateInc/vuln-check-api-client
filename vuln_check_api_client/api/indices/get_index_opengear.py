...
from ...models.get_index_opengear_start_cursor import GetIndexOpengearStartCursor
from ...models.render_response_with_metadata_array_advisory_opengear_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOpengearStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOpengearPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOpengearPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOpengearPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"opengear\"
    ...
    **Index Description:** Opengear Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/opengear?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOpengearStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Opengear Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOpengearPaginatePagination, str]
     """
