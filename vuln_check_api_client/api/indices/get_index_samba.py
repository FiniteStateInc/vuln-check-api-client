...
from ...models.get_index_samba_start_cursor import GetIndexSambaStartCursor
from ...models.render_response_with_metadata_array_advisory_samba_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSambaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"samba\"
    ...
    **Index Description:** Samba Security Releases
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/samba?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSambaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Samba Security Releases
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySambaPaginatePagination, str]
     """
