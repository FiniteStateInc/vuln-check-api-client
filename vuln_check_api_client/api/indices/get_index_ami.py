...
from ...models.get_index_ami_start_cursor import GetIndexAmiStartCursor
from ...models.render_response_with_metadata_array_advisory_ami_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAmiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAMIPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAMIPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAMIPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ami\"
    ...
    **Index Description:** AMI Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAmiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** AMI Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAMIPaginatePagination, str]
     """
