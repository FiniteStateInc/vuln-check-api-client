...
from ...models.get_index_maven_start_cursor import GetIndexMavenStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMavenStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"maven\"
    ...
    **Index Description:** Maven (Java) packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/maven?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMavenStartCursor]):
        cve (Union[Unset, str]):
