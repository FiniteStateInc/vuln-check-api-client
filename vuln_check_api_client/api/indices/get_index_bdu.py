...
from ...models.get_index_bdu_start_cursor import GetIndexBduStartCursor
from ...models.render_response_with_metadata_array_advisory_bdu_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBduStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"bdu\"
    ...
    **Index Description:** BDU Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBduStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** BDU Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBDUAdvisoryPaginatePagination, str]
     """
