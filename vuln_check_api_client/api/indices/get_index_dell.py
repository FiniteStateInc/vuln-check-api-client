...
from ...models.get_index_dell_start_cursor import GetIndexDellStartCursor
from ...models.render_response_with_metadata_array_advisory_dell_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDellStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDellPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDellPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDellPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"dell\"
    ...
    **Index Description:** Dell Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/dell?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDellStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Dell Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDellPaginatePagination, str]
     """
