...
from ...models.get_index_symfony_start_cursor import GetIndexSymfonyStartCursor
from ...models.render_response_with_metadata_array_advisory_symfony_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSymfonyStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"symfony\"
    ...
    **Index Description:** Symfony Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/symfony?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSymfonyStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Symfony Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySymfonyPaginatePagination, str]
     """
