...
from ...models.get_index_bandr_start_cursor import GetIndexBandrStartCursor
from ...models.render_response_with_metadata_array_advisory_bandr_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBandrStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"bandr\"
    ...
    **Index Description:** B&R Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/bandr?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBandrStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** B&R Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBandrPaginatePagination, str]
     """
