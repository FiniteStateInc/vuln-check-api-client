...
from ...models.get_index_vde_start_cursor import GetIndexVdeStartCursor
from ...models.render_response_with_metadata_array_advisory_vde_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVdeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vde\"
    ...
    **Index Description:** VDE CERT Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVdeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VDE CERT Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVDEAdvisoryPaginatePagination, str]
     """
