...
from ...models.get_index_drupal_start_cursor import GetIndexDrupalStartCursor
from ...models.render_response_with_metadata_array_advisory_drupal_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDrupalStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"drupal\"
    ...
    **Index Description:** Drupal Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/drupal?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDrupalStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Drupal Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDrupalPaginatePagination, str]
     """
