...
from ...models.get_index_notepadplusplus_start_cursor import GetIndexNotepadplusplusStartCursor
from ...models.render_response_with_metadata_array_advisory_note_pad_plus_plus_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNotepadplusplusStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNotePadPlusPlusPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNotePadPlusPlusPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNotePadPlusPlusPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"notepadplusplus\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the notepadplusplus
    index. \
    ...
    **Index Description:** Notepad++ Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/notepadplusplus?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNotepadplusplusStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Notepad++ Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNotePadPlusPlusPaginatePagination, str]
     """
