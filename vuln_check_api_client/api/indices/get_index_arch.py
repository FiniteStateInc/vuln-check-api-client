...
from ...models.get_index_arch_start_cursor import GetIndexArchStartCursor
from ...models.render_response_with_metadata_array_advisory_arch_issue_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexArchStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"arch\"
    ...
    **Index Description:** Arch Linux
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/arch?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexArchStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Arch Linux
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryArchIssuePaginatePagination, str]
     """
