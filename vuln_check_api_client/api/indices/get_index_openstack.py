...
from ...models.get_index_openstack_start_cursor import GetIndexOpenstackStartCursor
from ...models.render_response_with_metadata_array_advisory_open_stack_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOpenstackStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOpenStackPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOpenStackPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOpenStackPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"openstack\"
    ...
    **Index Description:** OpenStack Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/openstack?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOpenstackStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** OpenStack Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOpenStackPaginatePagination, str]
     """
