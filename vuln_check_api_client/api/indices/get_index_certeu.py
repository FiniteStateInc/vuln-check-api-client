...
from ...models.get_index_certeu_start_cursor import GetIndexCerteuStartCursor
from ...models.render_response_with_metadata_array_advisory_certeu_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCerteuStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCERTEUAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCERTEUAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCERTEUAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"certeu\"
    ...
    **Index Description:** CERT-EU The Computer Emergency Response Team for the EU Institutions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/certeu?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCerteuStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CERT-EU The Computer Emergency Response Team for the EU Institutions
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCERTEUAdvisoryPaginatePagination, str]
     """
