...
from ...models.get_index_zscaler_start_cursor import GetIndexZscalerStartCursor
from ...models.render_response_with_metadata_array_advisory_zscaler_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexZscalerStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"zscaler\"
    ...
    **Index Description:** Zscaler Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/zscaler?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexZscalerStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Zscaler Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryZscalerPaginatePagination, str]
     """
