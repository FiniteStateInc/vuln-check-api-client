...
from ...models.get_index_node_security_start_cursor import GetIndexNodeSecurityStartCursor
from ...models.render_response_with_metadata_array_advisory_node_security_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNodeSecurityStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"node-security\"
    ...
    **Index Description:** Node.js Security Working Group Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/node-security?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNodeSecurityStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Node.js Security Working Group Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNodeSecurityPaginatePagination, str]
     """
