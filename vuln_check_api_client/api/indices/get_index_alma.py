...
from ...models.get_index_alma_start_cursor import GetIndexAlmaStartCursor
from ...models.render_response_with_metadata_array_advisory_alma_linux_update_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAlmaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAlmaLinuxUpdatePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAlmaLinuxUpdatePaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAlmaLinuxUpdatePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"alma\"
    ...
    **Index Description:** Alma Linux Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/alma?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAlmaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Alma Linux Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAlmaLinuxUpdatePaginatePagination, str]
     """
