...
if TYPE_CHECKING:
    from ..models.advisory_alpine_linux_sec_db_package import AdvisoryAlpineLinuxSecDBPackage


T = TypeVar("T", bound="AdvisoryAlpineLinuxSecDB")


@_attrs_define
class AdvisoryAlpineLinuxSecDB:
    """
    Attributes:
        ...
        distroversion (Union[Unset, str]):
        packages (Union[Unset, list['AdvisoryAlpineLinuxSecDBPackage']]):
    ...
    distroversion: Union[Unset, str] = UNSET
    packages: Union[Unset, list["AdvisoryAlpineLinuxSecDBPackage"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if distroversion is not UNSET:
            field_dict["distroversion"] = distroversion
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        distroversion = d.pop("distroversion", UNSET)

        packages = []
        _packages = d.pop("packages", UNSET)
        for packages_item_data in _packages or []:
            packages_item = AdvisoryAlpineLinuxSecDBPackage.from_dict(packages_item_data)
        ...
        advisory_alpine_linux_sec_db = cls(
            apkurl=apkurl,
            archs=archs,
            cve=cve,
        ...
        advisory_alpine_linux_sec_db.additional_properties = d
        return advisory_alpine_linux_sec_db
