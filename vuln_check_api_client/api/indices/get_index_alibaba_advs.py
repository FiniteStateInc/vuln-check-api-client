...
from ...models.get_index_alibaba_advs_start_cursor import GetIndexAlibabaAdvsStartCursor
from ...models.render_response_with_metadata_array_advisory_alibaba_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAlibabaAdvsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAlibabaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAlibabaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAlibabaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"alibaba-advs\"
    ...
    **Index Description:** Alibaba Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/alibaba-advs?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAlibabaAdvsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Alibaba Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAlibabaPaginatePagination, str]
     """
