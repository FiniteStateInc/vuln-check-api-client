...
from ...models.get_index_vulncheck_cvelist_v5_start_cursor import GetIndexVulncheckCvelistV5StartCursor
from ...models.render_response_with_metadata_array_advisory_vuln_check_cve_list_v5_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVulncheckCvelistV5StartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/vulncheck-cvelist-v5",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckCVEListV5PaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVulnCheckCVEListV5PaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckCVEListV5PaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vulncheck-cvelist-v5\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the vulncheck-cvelist-v5
    index. \
    ...
    **Index Description:** VulnCheck CVEList V5
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vulncheck-cvelist-v5?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVulncheckCvelistV5StartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck CVEList V5
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckCVEListV5PaginatePagination, str]
     """
