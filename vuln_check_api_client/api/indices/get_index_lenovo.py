...
from ...models.get_index_lenovo_start_cursor import GetIndexLenovoStartCursor
from ...models.render_response_with_metadata_array_advisory_lenovo_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexLenovoStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"lenovo\"
    ...
    **Index Description:** Lenovo Product Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/lenovo?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexLenovoStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Lenovo Product Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryLenovoPaginatePagination, str]
     """
