...
from ...models.get_index_mikrotik_start_cursor import GetIndexMikrotikStartCursor
from ...models.render_response_with_metadata_array_advisory_mikrotik_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMikrotikStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMikrotikPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMikrotikPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMikrotikPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mikrotik\"
    ...
    **Index Description:** MikroTik Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mikrotik?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMikrotikStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** MikroTik Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMikrotikPaginatePagination, str]
     """
