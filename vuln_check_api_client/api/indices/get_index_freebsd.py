...
from ...models.get_index_freebsd_start_cursor import GetIndexFreebsdStartCursor
from ...models.render_response_with_metadata_array_advisory_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFreebsdStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"freebsd\"
    ...
    **Index Description:** FreeBSD Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/freebsd?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFreebsdStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** FreeBSD Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAdvisoryPaginatePagination, str]
     """
