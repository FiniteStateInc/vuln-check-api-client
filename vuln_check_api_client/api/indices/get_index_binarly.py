...
from ...models.get_index_binarly_start_cursor import GetIndexBinarlyStartCursor
from ...models.render_response_with_metadata_array_advisory_binarly_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBinarlyStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"binarly\"
    ...
    **Index Description:** Binarly Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/binarly?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBinarlyStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Binarly Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBinarlyPaginatePagination, str]
     """
