...
from ...models.get_index_nozomi_start_cursor import GetIndexNozomiStartCursor
from ...models.render_response_with_metadata_array_advisory_nozomi_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNozomiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nozomi\"
    ...
    **Index Description:** Nozomi Networks Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nozomi?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNozomiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Nozomi Networks Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNozomiPaginatePagination, str]
     """
