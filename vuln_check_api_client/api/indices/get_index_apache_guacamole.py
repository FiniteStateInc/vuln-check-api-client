...
from ...models.get_index_apache_guacamole_start_cursor import GetIndexApacheGuacamoleStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_guacamole_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheGuacamoleStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-guacamole\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-guacamole
    index. \
    ...
    **Index Description:** Apache Guacamole Security Reports
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-guacamole?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheGuacamoleStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Guacamole Security Reports
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheGuacamolePaginatePagination, str]
     """
