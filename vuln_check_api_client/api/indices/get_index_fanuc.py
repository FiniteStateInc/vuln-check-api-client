...
from ...models.get_index_fanuc_start_cursor import GetIndexFanucStartCursor
from ...models.render_response_with_metadata_array_advisory_fanuc_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFanucStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryFanucPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryFanucPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryFanucPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"fanuc\"
    ...
    **Index Description:** Fanuc Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/fanuc?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFanucStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Fanuc Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryFanucPaginatePagination, str]
     """
