...
from ...models.get_index_intel_start_cursor import GetIndexIntelStartCursor
from ...models.render_response_with_metadata_array_advisory_intel_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIntelStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryIntelPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryIntelPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryIntelPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"intel\"
    ...
    **Index Description:** Intel® Product Security Center Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/intel?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIntelStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Intel® Product Security Center Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryIntelPaginatePagination, str]
     """
