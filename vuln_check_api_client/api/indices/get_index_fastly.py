...
from ...models.get_index_fastly_start_cursor import GetIndexFastlyStartCursor
from ...models.render_response_with_metadata_array_advisory_fastly_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFastlyStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"fastly\"
    ...
    **Index Description:** Fastly Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/fastly?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFastlyStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Fastly Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryFastlyPaginatePagination, str]
     """
