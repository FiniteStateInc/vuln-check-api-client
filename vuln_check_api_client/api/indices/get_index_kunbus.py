...
from ...models.get_index_kunbus_start_cursor import GetIndexKunbusStartCursor
from ...models.render_response_with_metadata_array_advisory_kunbus_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexKunbusStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryKunbusPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryKunbusPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryKunbusPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"kunbus\"
    ...
    **Index Description:** KunBus Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/kunbus?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexKunbusStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** KunBus Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryKunbusPaginatePagination, str]
     """
