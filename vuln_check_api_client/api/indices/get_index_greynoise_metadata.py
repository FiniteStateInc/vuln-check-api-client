...
from ...models.get_index_greynoise_metadata_start_cursor import GetIndexGreynoiseMetadataStartCursor
from ...models.render_response_with_metadata_array_advisory_grey_noise_detection_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGreynoiseMetadataStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGreyNoiseDetectionPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGreyNoiseDetectionPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGreyNoiseDetectionPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"greynoise-metadata\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the greynoise-metadata
    index. \
    ...
    **Index Description:** GreyNoise Metadata
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/greynoise-metadata?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGreynoiseMetadataStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** GreyNoise Metadata
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGreyNoiseDetectionPaginatePagination, str]
     """
