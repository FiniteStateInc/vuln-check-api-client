...
from ...models.get_index_qualcomm_start_cursor import GetIndexQualcommStartCursor
from ...models.render_response_with_metadata_array_advisory_qualcomm_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexQualcommStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"qualcomm\"
    ...
    **Index Description:** Qualcomm Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/qualcomm?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexQualcommStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Qualcomm Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryQualcommPaginatePagination, str]
     """
