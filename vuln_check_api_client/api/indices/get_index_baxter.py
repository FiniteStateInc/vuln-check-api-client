...
from ...models.get_index_baxter_start_cursor import GetIndexBaxterStartCursor
from ...models.render_response_with_metadata_array_advisory_baxter_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBaxterStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBaxterAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBaxterAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBaxterAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"baxter\"
    ...
    **Index Description:** Baxter Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/baxter?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBaxterStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Baxter Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBaxterAdvisoryPaginatePagination, str]
     """
