...
from ...models.get_index_incibe_start_cursor import GetIndexIncibeStartCursor
from ...models.render_response_with_metadata_array_advisory_incibe_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIncibeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryIncibeAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryIncibeAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryIncibeAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"incibe\"
    ...
    **Index Description:** Incibe CERT Early Warnings
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/incibe?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIncibeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Incibe CERT Early Warnings
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryIncibeAdvisoryPaginatePagination, str]
     """
