...
T = TypeVar("T", bound="AdvisoryApacheLoggingServices")


@_attrs_define
class AdvisoryApacheLoggingServices:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_apache_logging_services = cls(
            affected=affected,
            cve=cve,
        ...
        advisory_apache_logging_services.additional_properties = d
        return advisory_apache_logging_services
