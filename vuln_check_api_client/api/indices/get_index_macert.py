...
from ...models.get_index_macert_start_cursor import GetIndexMacertStartCursor
from ...models.render_response_with_metadata_array_advisory_ma_cert_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMacertStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"macert\"
    ...
    **Index Description:** Moroccan CERT Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/macert?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMacertStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Moroccan CERT Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMACertPaginatePagination, str]
     """
