...
from ...models.get_index_zyxel_start_cursor import GetIndexZyxelStartCursor
from ...models.render_response_with_metadata_array_advisory_zyxel_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexZyxelStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"zyxel\"
    ...
    **Index Description:** Zyxel Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/zyxel?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexZyxelStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Zyxel Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryZyxelPaginatePagination, str]
     """
