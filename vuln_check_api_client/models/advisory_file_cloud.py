...
T = TypeVar("T", bound="AdvisoryFileCloud")


@_attrs_define
class AdvisoryFileCloud:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_file_cloud.additional_properties = d
        return advisory_file_cloud
