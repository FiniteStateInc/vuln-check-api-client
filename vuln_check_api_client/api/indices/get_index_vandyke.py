...
from ...models.get_index_vandyke_start_cursor import GetIndexVandykeStartCursor
from ...models.render_response_with_metadata_array_advisory_van_dyke_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVandykeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVanDykePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVanDykePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVanDykePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vandyke\"
    ...
    **Index Description:** VanDyke Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vandyke?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVandykeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VanDyke Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVanDykePaginatePagination, str]
     """
