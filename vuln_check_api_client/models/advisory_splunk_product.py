...
T = TypeVar("T", bound="AdvisorySplunkProduct")


@_attrs_define
class AdvisorySplunkProduct:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_splunk_product.additional_properties = d
        return advisory_splunk_product
