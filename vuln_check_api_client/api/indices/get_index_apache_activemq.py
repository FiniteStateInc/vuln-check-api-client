...
from ...models.get_index_apache_activemq_start_cursor import GetIndexApacheActivemqStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_active_mq_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheActivemqStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheActiveMQPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheActiveMQPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheActiveMQPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-activemq\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-activemq
    index. \
    ...
    **Index Description:** Apache ActiveMQ Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-activemq?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheActivemqStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache ActiveMQ Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheActiveMQPaginatePagination, str]
     """
