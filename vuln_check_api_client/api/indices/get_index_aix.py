...
from ...models.get_index_aix_start_cursor import GetIndexAixStartCursor
from ...models.render_response_with_metadata_array_advisory_aix_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAixStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"aix\"
    ...
    **Index Description:** AIX Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAixStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** AIX Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAIXPaginatePagination, str]
     """
