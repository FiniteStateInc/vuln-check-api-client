...
from ...models.get_index_apache_zookeeper_start_cursor import GetIndexApacheZookeeperStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_zoo_keeper_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheZookeeperStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheZooKeeperPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheZooKeeperPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheZooKeeperPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-zookeeper\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-zookeeper
    index. \
    ...
    **Index Description:** Apache ZooKeeper Vulnerability Reports
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-zookeeper?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheZookeeperStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache ZooKeeper Vulnerability Reports
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheZooKeeperPaginatePagination, str]
     """
