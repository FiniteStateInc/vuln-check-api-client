...
from ...models.get_index_cisco_start_cursor import GetIndexCiscoStartCursor
from ...models.render_response_with_metadata_array_advisory_cisco_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCiscoStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cisco\"
    ...
    **Index Description:** Cisco Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cisco?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCiscoStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Cisco Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCiscoAdvisoryPaginatePagination, str]
     """
