...
from ...models.get_index_tenable_research_advisories_start_cursor import GetIndexTenableResearchAdvisoriesStartCursor
from ...models.render_response_with_metadata_array_advisory_tenable_research_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTenableResearchAdvisoriesStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/tenable-research-advisories",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTenableResearchAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTenableResearchAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTenableResearchAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"tenable-research-advisories\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the tenable-research-
    advisories index. \
    ...
    **Index Description:** Tenable Research Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/tenable-research-
    advisories?start_cursor`, the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTenableResearchAdvisoriesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Tenable Research Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTenableResearchAdvisoryPaginatePagination, str]
     """
