...
from ...models.get_index_zoom_start_cursor import GetIndexZoomStartCursor
from ...models.render_response_with_metadata_array_advisory_zoom_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexZoomStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"zoom\"
    ...
    **Index Description:** Zoom Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/zoom?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexZoomStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Zoom Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryZoomPaginatePagination, str]
     """
