...
from ...models.get_index_cwe_start_cursor import GetIndexCweStartCursor
from ...models.render_response_with_metadata_array_api_cwe_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCweStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiCWEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiCWEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiCWEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cwe\"
    ...
    **Index Description:** Common Weakness Enumeration Database
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCweStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Common Weakness Enumeration Database
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiCWEPaginatePagination, str]
     """
