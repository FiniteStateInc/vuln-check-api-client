...
from ...models.get_index_php_my_admin_start_cursor import GetIndexPhpMyAdminStartCursor
from ...models.render_response_with_metadata_array_advisory_php_my_admin_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPhpMyAdminStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"php-my-admin\"
    ...
    **Index Description:** phpMyAdmin Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/php-my-admin?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPhpMyAdminStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** phpMyAdmin Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPHPMyAdminPaginatePagination, str]
     """
