...
from ...models.get_index_beyond_trust_start_cursor import GetIndexBeyondTrustStartCursor
from ...models.render_response_with_metadata_array_advisory_beyond_trust_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexBeyondTrustStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryBeyondTrustPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryBeyondTrustPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryBeyondTrustPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"beyond-trust\"
    ...
    **Index Description:** Beyond Trust Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/beyond-trust?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexBeyondTrustStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Beyond Trust Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryBeyondTrustPaginatePagination, str]
     """
