...
from ...models.get_index_amazon_start_cursor import GetIndexAmazonStartCursor
from ...models.render_response_with_metadata_array_advisory_update_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAmazonStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryUpdatePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryUpdatePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryUpdatePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"amazon\"
    ...
    **Index Description:** Amazon Linux Security Center
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/amazon?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAmazonStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Amazon Linux Security Center
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryUpdatePaginatePagination, str]
     """
