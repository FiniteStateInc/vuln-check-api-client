...
from ...models.get_index_chrome_start_cursor import GetIndexChromeStartCursor
from ...models.render_response_with_metadata_array_advisory_chrome_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexChromeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"chrome\"
    ...
    **Index Description:** Google Chrome Release Updates
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/chrome?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexChromeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Google Chrome Release Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryChromePaginatePagination, str]
     """
