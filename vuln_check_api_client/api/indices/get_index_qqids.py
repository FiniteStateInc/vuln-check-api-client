...
from ...models.get_index_qqids_start_cursor import GetIndexQqidsStartCursor
from ...models.render_response_with_metadata_array_advisory_qqid_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexQqidsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryQQIDPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryQQIDPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryQQIDPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"qqids\"
    ...
    **Index Description:** Qualys QIDs
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/qqids?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexQqidsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Qualys QIDs
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryQQIDPaginatePagination, str]
     """
