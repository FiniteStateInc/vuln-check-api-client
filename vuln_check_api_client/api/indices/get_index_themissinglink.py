...
from ...models.get_index_themissinglink_start_cursor import GetIndexThemissinglinkStartCursor
from ...models.render_response_with_metadata_array_advisory_the_missing_link_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexThemissinglinkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"themissinglink\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the themissinglink
    index. \
    ...
    **Index Description:** the missing link Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/themissinglink?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexThemissinglinkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** the missing link Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTheMissingLinkPaginatePagination, str]
     """
