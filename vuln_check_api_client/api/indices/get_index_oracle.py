...
from ...models.get_index_oracle_start_cursor import GetIndexOracleStartCursor
from ...models.render_response_with_metadata_array_advisory_meta_data_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOracleStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"oracle\"
    ...
    **Index Description:** Oracle Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/oracle?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOracleStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Oracle Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMetaDataPaginatePagination, str]
     """
