...
from ...models.get_index_il_alerts_start_cursor import GetIndexIlAlertsStartCursor
from ...models.render_response_with_metadata_array_advisory_israeli_alert_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIlAlertsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryIsraeliAlertPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryIsraeliAlertPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryIsraeliAlertPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"il-alerts\"
    ...
    **Index Description:** Gov.il Security Alerts
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/il-alerts?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIlAlertsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Gov.il Security Alerts
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryIsraeliAlertPaginatePagination, str]
     """
