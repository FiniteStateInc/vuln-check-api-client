...
from ...models.get_index_voidsec_start_cursor import GetIndexVoidsecStartCursor
from ...models.render_response_with_metadata_array_advisory_void_sec_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVoidsecStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVoidSecPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVoidSecPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVoidSecPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"voidsec\"
    ...
    **Index Description:** VoidSec Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/voidsec?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVoidsecStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VoidSec Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVoidSecPaginatePagination, str]
     """
