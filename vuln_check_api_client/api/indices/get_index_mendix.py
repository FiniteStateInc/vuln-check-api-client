...
from ...models.get_index_mendix_start_cursor import GetIndexMendixStartCursor
from ...models.render_response_with_metadata_array_advisory_mendix_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMendixStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMendixPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMendixPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMendixPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mendix\"
    ...
    **Index Description:** Mendix Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mendix?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMendixStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Mendix Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMendixPaginatePagination, str]
     """
