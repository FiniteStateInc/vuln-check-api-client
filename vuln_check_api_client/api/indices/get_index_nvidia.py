...
from ...models.get_index_nvidia_start_cursor import GetIndexNvidiaStartCursor
from ...models.render_response_with_metadata_array_advisory_security_bulletin_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNvidiaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nvidia\"
    ...
    **Index Description:** NVIDIA Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nvidia?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNvidiaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NVIDIA Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySecurityBulletinPaginatePagination, str]
     """
