...
from ...models.get_index_korelogic_start_cursor import GetIndexKorelogicStartCursor
from ...models.render_response_with_metadata_array_advisory_kore_logic_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexKorelogicStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"korelogic\"
    ...
    **Index Description:** KoreLogic Vulnerability Research and Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/korelogic?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexKorelogicStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** KoreLogic Vulnerability Research and Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryKoreLogicPaginatePagination, str]
     """
