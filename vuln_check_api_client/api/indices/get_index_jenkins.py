...
from ...models.get_index_jenkins_start_cursor import GetIndexJenkinsStartCursor
from ...models.render_response_with_metadata_array_advisory_jenkins_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexJenkinsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"jenkins\"
    ...
    **Index Description:** Jenkins Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/jenkins?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexJenkinsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Jenkins Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryJenkinsPaginatePagination, str]
     """
