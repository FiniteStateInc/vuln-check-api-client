...
from ...models.get_index_salesforce_start_cursor import GetIndexSalesforceStartCursor
from ...models.render_response_with_metadata_array_advisory_sales_force_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSalesforceStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySalesForcePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySalesForcePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySalesForcePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"salesforce\"
    ...
    **Index Description:** SalesForce Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/salesforce?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSalesforceStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SalesForce Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySalesForcePaginatePagination, str]
     """
