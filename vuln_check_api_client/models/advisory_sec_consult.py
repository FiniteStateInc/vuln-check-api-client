...
T = TypeVar("T", bound="AdvisorySECConsult")


@_attrs_define
class AdvisorySECConsult:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_sec_consult.additional_properties = d
        return advisory_sec_consult
