...
from ...models.get_index_cloudbees_start_cursor import GetIndexCloudbeesStartCursor
from ...models.render_response_with_metadata_array_advisory_cloud_bees_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCloudbeesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCloudBeesPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCloudBeesPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCloudBeesPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cloudbees\"
    ...
    **Index Description:** CloudBees Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cloudbees?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCloudbeesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CloudBees Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCloudBeesPaginatePagination, str]
     """
