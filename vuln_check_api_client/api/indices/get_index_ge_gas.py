...
from ...models.get_index_ge_gas_start_cursor import GetIndexGeGasStartCursor
from ...models.render_response_with_metadata_array_advisory_ge_gas_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGeGasStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGEGasPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGEGasPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGEGasPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ge-gas\"
    ...
    **Index Description:** GE Gas Product Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ge-gas?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGeGasStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** GE Gas Product Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGEGasPaginatePagination, str]
     """
