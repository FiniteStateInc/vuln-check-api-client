...
from ...models.get_index_hcl_start_cursor import GetIndexHclStartCursor
from ...models.render_response_with_metadata_array_advisory_hcl_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHclStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHCLPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHCLPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHCLPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hcl\"
    ...
    **Index Description:** HCLSoftware Security Bulletins
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHclStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** HCLSoftware Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHCLPaginatePagination, str]
     """
