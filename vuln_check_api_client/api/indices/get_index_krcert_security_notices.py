...
from ...models.get_index_krcert_security_notices_start_cursor import GetIndexKrcertSecurityNoticesStartCursor
from ...models.render_response_with_metadata_array_advisory_kr_cert_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexKrcertSecurityNoticesStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/krcert-security-notices",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"krcert-security-notices\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the krcert-security-
    notices index. \
    ...
    **Index Description:** KR-CERT Notices
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/krcert-security-
    notices?start_cursor`, the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexKrcertSecurityNoticesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** KR-CERT Notices
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryKRCertAdvisoryPaginatePagination, str]
     """
