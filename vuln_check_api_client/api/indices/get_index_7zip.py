...
from ...models.get_index_7_zip_start_cursor import GetIndex7ZipStartCursor
from ...models.render_response_with_metadata_array_advisory_seven_zip_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndex7ZipStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySevenZipPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySevenZipPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySevenZipPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"7zip\"
    ...
    **Index Description:** 7Zip Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/7zip?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndex7ZipStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** 7Zip Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySevenZipPaginatePagination, str]
     """
