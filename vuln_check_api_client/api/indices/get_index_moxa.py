...
from ...models.get_index_moxa_start_cursor import GetIndexMoxaStartCursor
from ...models.render_response_with_metadata_array_advisory_moxa_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMoxaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMoxaAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMoxaAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMoxaAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"moxa\"
    ...
    **Index Description:** Moxa Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/moxa?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMoxaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Moxa Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMoxaAdvisoryPaginatePagination, str]
     """
