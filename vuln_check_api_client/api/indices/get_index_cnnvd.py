...
from ...models.get_index_cnnvd_start_cursor import GetIndexCnnvdStartCursor
from ...models.render_response_with_metadata_array_advisory_cnnvd_entry_json_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCnnvdStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cnnvd\"
    ...
    **Index Description:** The Chinese National Vulnerability Database
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cnnvd?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCnnvdStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** The Chinese National Vulnerability Database
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCNNVDEntryJSONPaginatePagination, str]
     """
