...
from ...models.get_index_aveva_start_cursor import GetIndexAvevaStartCursor
from ...models.render_response_with_metadata_array_advisory_aveva_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAvevaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"aveva\"
    ...
    **Index Description:** AVEVA Group Limited
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/aveva?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAvevaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** AVEVA Group Limited
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAVEVAAdvisoryPaginatePagination, str]
     """
