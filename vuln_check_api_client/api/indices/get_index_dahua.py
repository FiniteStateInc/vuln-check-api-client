...
from ...models.get_index_dahua_start_cursor import GetIndexDahuaStartCursor
from ...models.render_response_with_metadata_array_advisory_dahua_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDahuaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDahuaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDahuaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDahuaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"dahua\"
    ...
    **Index Description:** Dahua Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/dahua?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDahuaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Dahua Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDahuaPaginatePagination, str]
     """
