...
from ...models.get_index_apache_commons_start_cursor import GetIndexApacheCommonsStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_commons_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheCommonsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheCommonsPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheCommonsPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheCommonsPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-commons\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-commons
    index. \
    ...
    **Index Description:** Apache Commons Known Security Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-commons?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheCommonsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Commons Known Security Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheCommonsPaginatePagination, str]
     """
