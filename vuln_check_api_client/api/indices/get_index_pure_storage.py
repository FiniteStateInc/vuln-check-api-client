...
from ...models.get_index_pure_storage_start_cursor import GetIndexPureStorageStartCursor
from ...models.render_response_with_metadata_array_advisory_pure_storage_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPureStorageStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"pure-storage\"
    ...
    **Index Description:** Pure Storage Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/pure-storage?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPureStorageStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Pure Storage Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPureStoragePaginatePagination, str]
     """
