...
from ...models.get_index_initial_access_git_start_cursor import GetIndexInitialAccessGitStartCursor
from ...models.render_response_with_metadata_array_api_initial_access_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexInitialAccessGitStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiInitialAccessPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiInitialAccessPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiInitialAccessPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"initial-access-git\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the initial-access-git
    index. \
    ...
    **Index Description:** VulnCheck Initial Access Intelligence Git Backup for Subscribers
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/initial-access-git?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexInitialAccessGitStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck Initial Access Intelligence Git Backup for Subscribers
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiInitialAccessPaginatePagination, str]
     """
