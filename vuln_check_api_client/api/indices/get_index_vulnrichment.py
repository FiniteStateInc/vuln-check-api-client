...
from ...models.get_index_vulnrichment_start_cursor import GetIndexVulnrichmentStartCursor
from ...models.render_response_with_metadata_array_advisory_vulnrichment_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVulnrichmentStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVulnrichmentPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVulnrichmentPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVulnrichmentPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vulnrichment\"
    ...
    **Index Description:** CISA Vulnrichment
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vulnrichment?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVulnrichmentStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CISA Vulnrichment
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVulnrichmentPaginatePagination, str]
     """
