...
from ...models.get_index_wolfi_start_cursor import GetIndexWolfiStartCursor
from ...models.render_response_with_metadata_array_advisory_wolfi_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexWolfiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"wolfi\"
    ...
    **Index Description:** Wolfi Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/wolfi?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexWolfiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Wolfi Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryWolfiPaginatePagination, str]
     """
