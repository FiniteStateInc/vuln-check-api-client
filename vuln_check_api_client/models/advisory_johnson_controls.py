...
T = TypeVar("T", bound="AdvisoryJohnsonControls")


@_attrs_define
class AdvisoryJohnsonControls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_johnson_controls.additional_properties = d
        return advisory_johnson_controls
