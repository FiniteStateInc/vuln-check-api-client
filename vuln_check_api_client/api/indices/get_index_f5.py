...
from ...models.get_index_f5_start_cursor import GetIndexF5StartCursor
from ...models.render_response_with_metadata_array_advisory_f5_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexF5StartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryF5PaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryF5PaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryF5PaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"f5\"
    ...
    **Index Description:** F5 Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexF5StartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** F5 Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryF5PaginatePagination, str]
     """
