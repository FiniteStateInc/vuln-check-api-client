...
from ...models.get_index_yamaha_start_cursor import GetIndexYamahaStartCursor
from ...models.render_response_with_metadata_array_advisory_yamaha_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexYamahaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryYamahaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryYamahaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryYamahaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"yamaha\"
    ...
    **Index Description:** Yamaha Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/yamaha?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexYamahaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Yamaha Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryYamahaPaginatePagination, str]
     """
