...
from ...models.get_index_nist_nvd_start_cursor import GetIndexNistNvdStartCursor
from ...models.render_response_with_metadata_array_api_cve_items_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNistNvdStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiCveItemsPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiCveItemsPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiCveItemsPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nist-nvd\"
    ...
    **Index Description:** NIST NVD 1.0 CVE data built from NIST NVD 2.0 CVE Data
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nist-nvd?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNistNvdStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NIST NVD 1.0 CVE data built from NIST NVD 2.0 CVE Data
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiCveItemsPaginatePagination, str]
     """
