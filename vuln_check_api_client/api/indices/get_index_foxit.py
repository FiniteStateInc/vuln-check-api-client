...
from ...models.get_index_foxit_start_cursor import GetIndexFoxitStartCursor
from ...models.render_response_with_metadata_array_advisory_foxit_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFoxitStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryFoxitPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryFoxitPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryFoxitPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"foxit\"
    ...
    **Index Description:** Foxit Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/foxit?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFoxitStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Foxit Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryFoxitPaginatePagination, str]
     """
