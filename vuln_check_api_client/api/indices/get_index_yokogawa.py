...
from ...models.get_index_yokogawa_start_cursor import GetIndexYokogawaStartCursor
from ...models.render_response_with_metadata_array_advisory_yokogawa_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexYokogawaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryYokogawaAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryYokogawaAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryYokogawaAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"yokogawa\"
    ...
    **Index Description:** Yokogawa Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/yokogawa?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexYokogawaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Yokogawa Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryYokogawaAdvisoryPaginatePagination, str]
     """
