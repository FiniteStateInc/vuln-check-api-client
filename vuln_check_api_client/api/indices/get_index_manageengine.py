...
from ...models.get_index_manageengine_start_cursor import GetIndexManageengineStartCursor
from ...models.render_response_with_metadata_array_advisory_manage_engine_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexManageengineStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"manageengine\"
    ...
    **Index Description:** ManageEngine Security Updates
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/manageengine?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexManageengineStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** ManageEngine Security Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryManageEngineAdvisoryPaginatePagination, str]
     """
