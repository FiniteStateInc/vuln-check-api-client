...
from ...models.get_index_certfr_start_cursor import GetIndexCertfrStartCursor
from ...models.render_response_with_metadata_array_advisory_cert_fr_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCertfrStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCertFRAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCertFRAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCertFRAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"certfr\"
    ...
    **Index Description:** Cert FR Security Alerts
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/certfr?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCertfrStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Cert FR Security Alerts
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCertFRAdvisoryPaginatePagination, str]
     """
