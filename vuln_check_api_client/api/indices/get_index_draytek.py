...
from ...models.get_index_draytek_start_cursor import GetIndexDraytekStartCursor
from ...models.render_response_with_metadata_array_advisory_draytek_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDraytekStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDraytekPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDraytekPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDraytekPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"draytek\"
    ...
    **Index Description:** DrayTek Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/draytek?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDraytekStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** DrayTek Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDraytekPaginatePagination, str]
     """
