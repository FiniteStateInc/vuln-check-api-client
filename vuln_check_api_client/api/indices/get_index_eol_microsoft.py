...
from ...models.get_index_eol_microsoft_start_cursor import GetIndexEolMicrosoftStartCursor
from ...models.render_response_with_metadata_array_advisory_eol_microsoft_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexEolMicrosoftStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryEOLMicrosoftPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryEOLMicrosoftPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryEOLMicrosoftPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"eol-microsoft\"
    ...
    **Index Description:** Microsoft EOL
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/eol-microsoft?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexEolMicrosoftStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Microsoft EOL
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryEOLMicrosoftPaginatePagination, str]
     """
