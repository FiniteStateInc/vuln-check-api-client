...
from ...models.get_index_usd_start_cursor import GetIndexUsdStartCursor
from ...models.render_response_with_metadata_array_advisory_usd_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexUsdStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryUSDPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryUSDPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryUSDPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"usd\"
    ...
    **Index Description:** usd Security Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexUsdStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** usd Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryUSDPaginatePagination, str]
     """
