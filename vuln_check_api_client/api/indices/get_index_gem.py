...
from ...models.get_index_gem_start_cursor import GetIndexGemStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGemStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"gem\"
    ...
    **Index Description:** Ruby (gem) packages with package versions
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGemStartCursor]):
        cve (Union[Unset, str]):
