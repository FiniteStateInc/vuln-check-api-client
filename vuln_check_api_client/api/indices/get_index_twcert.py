...
from ...models.get_index_twcert_start_cursor import GetIndexTwcertStartCursor
from ...models.render_response_with_metadata_array_advisory_tw_cert_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTwcertStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTWCertAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTWCertAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTWCertAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"twcert\"
    ...
    **Index Description:** Taiwan CERT Vulnerability Notes
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/twcert?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTwcertStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Taiwan CERT Vulnerability Notes
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTWCertAdvisoryPaginatePagination, str]
     """
