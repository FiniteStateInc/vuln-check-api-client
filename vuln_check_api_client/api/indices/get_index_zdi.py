...
from ...models.get_index_zdi_start_cursor import GetIndexZdiStartCursor
from ...models.render_response_with_metadata_array_advisory_zero_day_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexZdiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryZeroDayAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryZeroDayAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryZeroDayAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"zdi\"
    ...
    **Index Description:** Zero Day Initiative Advisories
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexZdiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Zero Day Initiative Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryZeroDayAdvisoryPaginatePagination, str]
     """
