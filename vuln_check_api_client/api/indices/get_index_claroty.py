...
from ...models.get_index_claroty_start_cursor import GetIndexClarotyStartCursor
from ...models.render_response_with_metadata_array_advisory_claroty_vulnerability_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexClarotyStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryClarotyVulnerabilityPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryClarotyVulnerabilityPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryClarotyVulnerabilityPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"claroty\"
    ...
    **Index Description:** Team 82: The Claroty Research Team
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/claroty?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexClarotyStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Team 82: The Claroty Research Team
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryClarotyVulnerabilityPaginatePagination, str]
     """
