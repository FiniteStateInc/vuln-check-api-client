...
from ...models.get_index_jvndb_start_cursor import GetIndexJvndbStartCursor
from ...models.render_response_with_metadata_array_advisory_jvn_advisory_item_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexJvndbStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"jvndb\"
    ...
    **Index Description:** Japan Vulnerability Notes
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/jvndb?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexJvndbStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Japan Vulnerability Notes
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryJVNAdvisoryItemPaginatePagination, str]
     """
