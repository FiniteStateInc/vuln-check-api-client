...
T = TypeVar("T", bound="AdvisoryMediatek")


@_attrs_define
class AdvisoryMediatek:
    """
    Attributes:
        affected_chipsets (Union[Unset, list[str]]):
    ...
    affected_chipsets: Union[Unset, list[str]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        affected_chipsets: Union[Unset, list[str]] = UNSET
        if not isinstance(self.affected_chipsets, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        affected_chipsets = cast(list[str], d.pop("affected_chipsets", UNSET))
        ...
        advisory_mediatek.additional_properties = d
        return advisory_mediatek
