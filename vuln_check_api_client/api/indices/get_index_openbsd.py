...
from ...models.get_index_openbsd_start_cursor import GetIndexOpenbsdStartCursor
from ...models.render_response_with_metadata_array_advisory_open_bsd_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOpenbsdStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOpenBSDPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOpenBSDPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOpenBSDPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"openbsd\"
    ...
    **Index Description:** OpenBSD Security Fixes
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/openbsd?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOpenbsdStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** OpenBSD Security Fixes
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOpenBSDPaginatePagination, str]
     """
