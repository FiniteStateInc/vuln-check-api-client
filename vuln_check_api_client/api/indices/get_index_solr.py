...
from ...models.get_index_solr_start_cursor import GetIndexSolrStartCursor
from ...models.render_response_with_metadata_array_advisory_solr_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSolrStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"solr\"
    ...
    **Index Description:** Solr CVE Reports
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/solr?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSolrStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Solr CVE Reports
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySolrPaginatePagination, str]
     """
