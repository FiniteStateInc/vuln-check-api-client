...
from ...models.get_index_nodejs_start_cursor import GetIndexNodejsStartCursor
from ...models.render_response_with_metadata_array_advisory_node_js_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNodejsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nodejs\"
    ...
    **Index Description:** NodeJS Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nodejs?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNodejsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NodeJS Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNodeJSPaginatePagination, str]
     """
