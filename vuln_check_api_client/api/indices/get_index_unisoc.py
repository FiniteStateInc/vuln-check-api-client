...
from ...models.get_index_unisoc_start_cursor import GetIndexUnisocStartCursor
from ...models.render_response_with_metadata_array_advisory_unisoc_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexUnisocStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"unisoc\"
    ...
    **Index Description:** UNISOC Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/unisoc?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexUnisocStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** UNISOC Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryUnisocPaginatePagination, str]
     """
