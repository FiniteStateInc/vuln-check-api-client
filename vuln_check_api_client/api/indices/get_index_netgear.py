...
from ...models.get_index_netgear_start_cursor import GetIndexNetgearStartCursor
from ...models.render_response_with_metadata_array_advisory_netgear_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNetgearStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNetgearPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNetgearPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNetgearPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"netgear\"
    ...
    **Index Description:** NETGEAR Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/netgear?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNetgearStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NETGEAR Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNetgearPaginatePagination, str]
     """
