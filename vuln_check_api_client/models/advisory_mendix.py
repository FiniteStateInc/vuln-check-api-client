...
T = TypeVar("T", bound="AdvisoryMendix")


@_attrs_define
class AdvisoryMendix:
    """
    Attributes:
    ...
    mendix_id: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if id is not UNSET:
            field_dict["id"] = id
        if mendix_id is not UNSET:
            field_dict["mendix_id"] = mendix_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mendix_id = d.pop("mendix_id", UNSET)
        ...
        advisory_mendix.additional_properties = d
        return advisory_mendix
