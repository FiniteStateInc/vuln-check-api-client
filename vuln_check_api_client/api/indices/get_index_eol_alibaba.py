...
from ...models.get_index_eol_alibaba_start_cursor import GetIndexEolAlibabaStartCursor
from ...models.render_response_with_metadata_array_advisory_eol_alibaba_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexEolAlibabaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryEOLAlibabaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryEOLAlibabaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryEOLAlibabaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"eol-alibaba\"
    ...
    **Index Description:** Alibaba EOL
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/eol-alibaba?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexEolAlibabaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Alibaba EOL
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryEOLAlibabaPaginatePagination, str]
     """
