...
from ...models.get_index_naver_start_cursor import GetIndexNaverStartCursor
from ...models.render_response_with_metadata_array_advisory_naver_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNaverStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNaverPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNaverPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNaverPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"naver\"
    ...
    **Index Description:** Naver Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/naver?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNaverStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Naver Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNaverPaginatePagination, str]
     """
