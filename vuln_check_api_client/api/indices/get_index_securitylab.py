...
from ...models.get_index_securitylab_start_cursor import GetIndexSecuritylabStartCursor
from ...models.render_response_with_metadata_array_advisory_security_lab_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSecuritylabStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"securitylab\"
    ...
    **Index Description:** Security Lab Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/securitylab?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSecuritylabStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Security Lab Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySecurityLabPaginatePagination, str]
     """
