...
from ...models.get_index_genetec_start_cursor import GetIndexGenetecStartCursor
from ...models.render_response_with_metadata_array_advisory_genetec_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGenetecStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGenetecPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGenetecPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGenetecPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"genetec\"
    ...
    **Index Description:** Genetec Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/genetec?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGenetecStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Genetec Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGenetecPaginatePagination, str]
     """
