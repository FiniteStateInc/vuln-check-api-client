...
from ...models.get_index_openssh_start_cursor import GetIndexOpensshStartCursor
from ...models.render_response_with_metadata_array_advisory_open_ssh_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOpensshStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOpenSSHPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOpenSSHPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOpenSSHPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"openssh\"
    ...
    **Index Description:** OpenSSH Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/openssh?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOpensshStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** OpenSSH Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOpenSSHPaginatePagination, str]
     """
