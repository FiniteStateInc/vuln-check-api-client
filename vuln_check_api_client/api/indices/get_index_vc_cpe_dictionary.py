...
from ...models.get_index_vc_cpe_dictionary_start_cursor import GetIndexVcCpeDictionaryStartCursor
from ...models.render_response_with_metadata_array_advisory_vccpe_dictionary_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVcCpeDictionaryStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vc-cpe-dictionary\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the vc-cpe-dictionary
    index. \
    ...
    **Index Description:** VulnCheck CPE Dictionary
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vc-cpe-dictionary?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVcCpeDictionaryStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck CPE Dictionary
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVCCPEDictionaryPaginatePagination, str]
     """
