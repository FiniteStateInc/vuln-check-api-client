...
T = TypeVar("T", bound="AdvisoryBaxterAdvisory")


@_attrs_define
class AdvisoryBaxterAdvisory:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_baxter_advisory.additional_properties = d
        return advisory_baxter_advisory
