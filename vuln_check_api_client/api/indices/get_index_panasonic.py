...
from ...models.get_index_panasonic_start_cursor import GetIndexPanasonicStartCursor
from ...models.render_response_with_metadata_array_advisory_panasonic_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPanasonicStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"panasonic\"
    ...
    **Index Description:** Panasonic Vulnerability Advisory List
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/panasonic?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPanasonicStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Panasonic Vulnerability Advisory List
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPanasonicPaginatePagination, str]
     """
