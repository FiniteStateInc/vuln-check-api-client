...
from ...models.get_index_johnson_controls_start_cursor import GetIndexJohnsonControlsStartCursor
from ...models.render_response_with_metadata_array_advisory_johnson_controls_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexJohnsonControlsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryJohnsonControlsPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryJohnsonControlsPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryJohnsonControlsPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"johnson-controls\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the johnson-controls
    index. \
    ...
    **Index Description:** Security Advisories - Johnson Controls
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/johnson-controls?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexJohnsonControlsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Security Advisories - Johnson Controls
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryJohnsonControlsPaginatePagination, str]
     """
