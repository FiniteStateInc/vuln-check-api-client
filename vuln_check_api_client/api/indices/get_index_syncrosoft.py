...
from ...models.get_index_syncrosoft_start_cursor import GetIndexSyncrosoftStartCursor
from ...models.render_response_with_metadata_array_advisory_syncro_soft_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSyncrosoftStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySyncroSoftPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySyncroSoftPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySyncroSoftPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"syncrosoft\"
    ...
    **Index Description:** SyncroSoft Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/syncrosoft?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSyncrosoftStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SyncroSoft Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySyncroSoftPaginatePagination, str]
     """
