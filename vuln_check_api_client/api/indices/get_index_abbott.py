...
from ...models.get_index_abbott_start_cursor import GetIndexAbbottStartCursor
from ...models.render_response_with_metadata_array_advisory_abbott_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAbbottStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"abbott\"
    ...
    **Index Description:** Abbott Product Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/abbott?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAbbottStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Abbott Product Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAbbottPaginatePagination, str]
     """
