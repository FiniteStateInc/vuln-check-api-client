...
from ...models.get_index_otrs_start_cursor import GetIndexOtrsStartCursor
from ...models.render_response_with_metadata_array_advisory_otrs_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOtrsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOTRSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOTRSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOTRSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"otrs\"
    ...
    **Index Description:** OTRS Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/otrs?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOtrsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** OTRS Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOTRSPaginatePagination, str]
     """
