...
from ...models.get_index_abb_start_cursor import GetIndexAbbStartCursor
from ...models.render_response_with_metadata_array_advisory_abb_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAbbStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryABBAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryABBAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryABBAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"abb\"
    ...
    **Index Description:** ABB Vulnerabilities
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAbbStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** ABB Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryABBAdvisoryPaginatePagination, str]
     """
