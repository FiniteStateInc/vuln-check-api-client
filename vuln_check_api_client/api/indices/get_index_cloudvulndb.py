...
from ...models.get_index_cloudvulndb_start_cursor import GetIndexCloudvulndbStartCursor
from ...models.render_response_with_metadata_array_advisory_cloud_vuln_db_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCloudvulndbStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCloudVulnDBAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCloudVulnDBAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCloudVulnDBAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cloudvulndb\"
    ...
    **Index Description:** CloudVulnDB
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cloudvulndb?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCloudvulndbStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** CloudVulnDB
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCloudVulnDBAdvisoryPaginatePagination, str]
     """
