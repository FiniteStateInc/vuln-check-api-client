...
from ...models.get_index_juniper_start_cursor import GetIndexJuniperStartCursor
from ...models.render_response_with_metadata_array_advisory_juniper_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexJuniperStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryJuniperPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryJuniperPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryJuniperPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"juniper\"
    ...
    **Index Description:** Juniper Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/juniper?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexJuniperStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Juniper Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryJuniperPaginatePagination, str]
     """
