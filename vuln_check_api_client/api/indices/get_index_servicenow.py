...
from ...models.get_index_servicenow_start_cursor import GetIndexServicenowStartCursor
from ...models.render_response_with_metadata_array_advisory_service_now_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexServicenowStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryServiceNowPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryServiceNowPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryServiceNowPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"servicenow\"
    ...
    **Index Description:** ServiceNow CVE Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/servicenow?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexServicenowStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** ServiceNow CVE Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryServiceNowPaginatePagination, str]
     """
