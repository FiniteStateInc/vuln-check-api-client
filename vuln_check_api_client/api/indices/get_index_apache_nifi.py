...
from ...models.get_index_apache_nifi_start_cursor import GetIndexApacheNifiStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_ni_fi_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheNifiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-nifi\"
    ...
    **Index Description:** Apache NiFi Security Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-nifi?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheNifiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache NiFi Security Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheNiFiPaginatePagination, str]
     """
