...
from ...models.get_index_composer_start_cursor import GetIndexComposerStartCursor
from ...models.render_response_with_metadata_array_api_oss_package_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexComposerStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiOSSPackagePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiOSSPackagePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiOSSPackagePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"composer\"
    ...
    **Index Description:** PHP Composer packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/composer?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexComposerStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** PHP Composer packages with package versions
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiOSSPackagePaginatePagination, str]
     """
