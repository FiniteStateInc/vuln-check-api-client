...
from ...models.get_index_ubiquiti_start_cursor import GetIndexUbiquitiStartCursor
from ...models.render_response_with_metadata_array_advisory_ubiquiti_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexUbiquitiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ubiquiti\"
    ...
    **Index Description:** Ubiquiti Security Advisory Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ubiquiti?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexUbiquitiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Ubiquiti Security Advisory Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryUbiquitiPaginatePagination, str]
     """
