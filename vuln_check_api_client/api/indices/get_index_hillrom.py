...
from ...models.get_index_hillrom_start_cursor import GetIndexHillromStartCursor
from ...models.render_response_with_metadata_array_advisory_hillrom_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHillromStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHillromAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHillromAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHillromAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hillrom\"
    ...
    **Index Description:** Hillrom Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/hillrom?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHillromStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Hillrom Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHillromAdvisoryPaginatePagination, str]
     """
