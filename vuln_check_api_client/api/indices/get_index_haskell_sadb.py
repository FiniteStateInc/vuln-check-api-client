...
from ...models.get_index_haskell_sadb_start_cursor import GetIndexHaskellSadbStartCursor
from ...models.render_response_with_metadata_array_advisory_haskell_sadb_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHaskellSadbStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHaskellSADBAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHaskellSADBAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHaskellSADBAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"haskell-sadb\"
    ...
    **Index Description:** Haskell Security Advisory DB
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/haskell-sadb?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHaskellSadbStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Haskell Security Advisory DB
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHaskellSADBAdvisoryPaginatePagination, str]
     """
