...
from ...models.get_index_lexmark_start_cursor import GetIndexLexmarkStartCursor
from ...models.render_response_with_metadata_array_advisory_lexmark_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexLexmarkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryLexmarkAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryLexmarkAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryLexmarkAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"lexmark\"
    ...
    **Index Description:** Lexmark Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/lexmark?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexLexmarkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Lexmark Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryLexmarkAdvisoryPaginatePagination, str]
     """
