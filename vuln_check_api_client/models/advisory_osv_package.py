...
T = TypeVar("T", bound="AdvisoryOSVPackage")


@_attrs_define
class AdvisoryOSVPackage:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_osv_package = cls(
            ecosystem=ecosystem,
            name=name,
            purl=purl,
        )

        advisory_osv_package.additional_properties = d
        return advisory_osv_package
