...
from ...models.get_index_apache_arrow_start_cursor import GetIndexApacheArrowStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_arrow_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheArrowStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheArrowPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheArrowPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheArrowPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-arrow\"
    ...
    **Index Description:** Apache Arrow Security Issues
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-arrow?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheArrowStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Arrow Security Issues
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheArrowPaginatePagination, str]
     """
