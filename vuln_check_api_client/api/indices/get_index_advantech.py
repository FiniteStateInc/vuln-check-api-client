...
from ...models.get_index_advantech_start_cursor import GetIndexAdvantechStartCursor
from ...models.render_response_with_metadata_array_advisory_advantech_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAdvantechStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAdvantechPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAdvantechPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAdvantechPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"advantech\"
    ...
    **Index Description:** Advantech Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/advantech?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAdvantechStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Advantech Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAdvantechPaginatePagination, str]
     """
