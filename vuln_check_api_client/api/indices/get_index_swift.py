...
from ...models.get_index_swift_start_cursor import GetIndexSwiftStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSwiftStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"swift\"
    ...
    **Index Description:** Swift packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/swift?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSwiftStartCursor]):
        cve (Union[Unset, str]):
