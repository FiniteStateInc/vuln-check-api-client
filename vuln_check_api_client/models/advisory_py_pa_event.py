...
T = TypeVar("T", bound="AdvisoryPyPAEvent")


@_attrs_define
class AdvisoryPyPAEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_py_pa_event = cls(
            fixed=fixed,
            introduced=introduced,
        )

        advisory_py_pa_event.additional_properties = d
        return advisory_py_pa_event
