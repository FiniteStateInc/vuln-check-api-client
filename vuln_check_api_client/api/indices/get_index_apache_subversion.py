...
from ...models.get_index_apache_subversion_start_cursor import GetIndexApacheSubversionStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_subversion_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheSubversionStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheSubversionPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheSubversionPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheSubversionPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-subversion\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-subversion
    index. \
    ...
    **Index Description:** Apache Subversion Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-subversion?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheSubversionStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache Subversion Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheSubversionPaginatePagination, str]
     """
