...
from ...models.get_index_ncsc_cves_start_cursor import GetIndexNcscCvesStartCursor
from ...models.render_response_with_metadata_array_advisory_ncsccve_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNcscCvesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ncsc-cves\"
    ...
    **Index Description:** NCSC CVEs
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ncsc-cves?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNcscCvesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NCSC CVEs
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNCSCCVEPaginatePagination, str]
     """
