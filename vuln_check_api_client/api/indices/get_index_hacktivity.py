...
from ...models.get_index_hacktivity_start_cursor import GetIndexHacktivityStartCursor
from ...models.render_response_with_metadata_array_advisory_hacktivity_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHacktivityStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHacktivityPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHacktivityPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHacktivityPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hacktivity\"
    ...
    **Index Description:** Hackerone Hacktivity
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/hacktivity?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHacktivityStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Hackerone Hacktivity
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHacktivityPaginatePagination, str]
     """
