...
from ...models.get_index_m_files_start_cursor import GetIndexMFilesStartCursor
from ...models.render_response_with_metadata_array_advisory_m_files_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMFilesStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMFilesPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMFilesPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMFilesPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"m-files\"
    ...
    **Index Description:** M-Files Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/m-files?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMFilesStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** M-Files Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMFilesPaginatePagination, str]
     """
