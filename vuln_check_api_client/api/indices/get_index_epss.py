...
from ...models.get_index_epss_start_cursor import GetIndexEpssStartCursor
from ...models.render_response_with_metadata_array_api_epss_data_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexEpssStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"epss\"
    ...
    **Index Description:** EPSS Data
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/epss?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexEpssStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** EPSS Data
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiEPSSDataPaginatePagination, str]
     """
