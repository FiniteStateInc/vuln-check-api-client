...
from ...models.get_index_proofpoint_start_cursor import GetIndexProofpointStartCursor
from ...models.render_response_with_metadata_array_advisory_proofpoint_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexProofpointStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"proofpoint\"
    ...
    **Index Description:** Proofpoint Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/proofpoint?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexProofpointStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Proofpoint Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryProofpointPaginatePagination, str]
     """
