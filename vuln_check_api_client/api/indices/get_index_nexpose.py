...
from ...models.get_index_nexpose_start_cursor import GetIndexNexposeStartCursor
from ...models.render_response_with_metadata_array_advisory_nexpose_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNexposeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNexposePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNexposePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNexposePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nexpose\"
    ...
    **Index Description:** Nexpose Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/nexpose?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNexposeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Nexpose Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNexposePaginatePagination, str]
     """
