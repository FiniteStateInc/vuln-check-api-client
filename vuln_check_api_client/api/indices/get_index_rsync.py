...
from ...models.get_index_rsync_start_cursor import GetIndexRsyncStartCursor
from ...models.render_response_with_metadata_array_advisory_rsync_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexRsyncStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryRsyncPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryRsyncPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryRsyncPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"rsync\"
    ...
    **Index Description:** Rsync Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/rsync?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexRsyncStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Rsync Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryRsyncPaginatePagination, str]
     """
