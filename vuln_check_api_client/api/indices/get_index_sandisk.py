...
from ...models.get_index_sandisk_start_cursor import GetIndexSandiskStartCursor
from ...models.render_response_with_metadata_array_advisory_sandisk_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSandiskStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySandiskPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySandiskPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySandiskPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sandisk\"
    ...
    **Index Description:** Sandisk Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sandisk?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSandiskStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Sandisk Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySandiskPaginatePagination, str]
     """
