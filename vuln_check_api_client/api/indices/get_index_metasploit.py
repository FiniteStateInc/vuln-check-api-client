...
from ...models.get_index_metasploit_start_cursor import GetIndexMetasploitStartCursor
from ...models.render_response_with_metadata_array_advisory_metasploit_exploit_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMetasploitStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMetasploitExploitPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMetasploitExploitPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMetasploitExploitPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"metasploit\"
    ...
    **Index Description:** Metasploit Modules
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/metasploit?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMetasploitStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Metasploit Modules
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMetasploitExploitPaginatePagination, str]
     """
