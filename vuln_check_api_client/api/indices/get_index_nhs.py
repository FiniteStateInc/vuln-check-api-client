...
from ...models.get_index_nhs_start_cursor import GetIndexNhsStartCursor
from ...models.render_response_with_metadata_array_advisory_nhs_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNhsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"nhs\"
    ...
    **Index Description:** NHS Cyber Alerts
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNhsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** NHS Cyber Alerts
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNHSPaginatePagination, str]
     """
