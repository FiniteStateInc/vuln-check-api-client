...
from ...models.get_index_tp_link_start_cursor import GetIndexTpLinkStartCursor
from ...models.render_response_with_metadata_array_advisory_tp_link_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTpLinkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"tp-link\"
    ...
    **Index Description:** TP-Link Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/tp-link?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTpLinkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** TP-Link Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTPLinkPaginatePagination, str]
     """
