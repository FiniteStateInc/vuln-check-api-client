...
from ...models.get_index_cisco_talos_start_cursor import GetIndexCiscoTalosStartCursor
from ...models.render_response_with_metadata_array_advisory_talos_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCiscoTalosStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTalosAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTalosAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTalosAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cisco-talos\"
    ...
    **Index Description:** Cisco Talos Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cisco-talos?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCiscoTalosStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Cisco Talos Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTalosAdvisoryPaginatePagination, str]
     """
