...
from ...models.get_index_stryker_start_cursor import GetIndexStrykerStartCursor
from ...models.render_response_with_metadata_array_advisory_stryker_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexStrykerStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"stryker\"
    ...
    **Index Description:** Stryker Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/stryker?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexStrykerStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Stryker Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryStrykerAdvisoryPaginatePagination, str]
     """
