...
from ...models.get_index_hitachi_energy_start_cursor import GetIndexHitachiEnergyStartCursor
from ...models.render_response_with_metadata_array_advisory_hitachi_energy_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHitachiEnergyStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hitachi-energy\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the hitachi-energy
    index. \
    ...
    **Index Description:** Hitachi Energy Cybersecurity Advisories and Notifications
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/hitachi-energy?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHitachiEnergyStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Hitachi Energy Cybersecurity Advisories and Notifications
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHitachiEnergyPaginatePagination, str]
     """
