...
from ...models.get_index_zuso_start_cursor import GetIndexZusoStartCursor
from ...models.render_response_with_metadata_array_advisory_zuso_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexZusoStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"zuso\"
    ...
    **Index Description:** ZUSO Vulnerability Notifications
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/zuso?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexZusoStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** ZUSO Vulnerability Notifications
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryZusoPaginatePagination, str]
     """
