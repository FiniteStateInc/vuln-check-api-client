...
from ...models.get_index_pega_start_cursor import GetIndexPegaStartCursor
from ...models.render_response_with_metadata_array_advisory_pega_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexPegaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryPegaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryPegaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryPegaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"pega\"
    ...
    **Index Description:** Pega Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/pega?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexPegaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Pega Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryPegaPaginatePagination, str]
     """
