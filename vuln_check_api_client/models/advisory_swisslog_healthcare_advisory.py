...
T = TypeVar("T", bound="AdvisorySwisslogHealthcareAdvisory")


@_attrs_define
class AdvisorySwisslogHealthcareAdvisory:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        advisory_swisslog_healthcare_advisory = cls(
        ...
        advisory_swisslog_healthcare_advisory.additional_properties = d
        return advisory_swisslog_healthcare_advisory
