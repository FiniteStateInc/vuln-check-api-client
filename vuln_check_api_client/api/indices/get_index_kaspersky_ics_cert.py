...
from ...models.get_index_kaspersky_ics_cert_start_cursor import GetIndexKasperskyIcsCertStartCursor
from ...models.render_response_with_metadata_array_advisory_kaspersky_icscert_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexKasperskyIcsCertStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryKasperskyICSCERTAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryKasperskyICSCERTAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryKasperskyICSCERTAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"kaspersky-ics-cert\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the kaspersky-ics-cert
    index. \
    ...
    **Index Description:** Kaspersky ICS CERT
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/kaspersky-ics-cert?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexKasperskyIcsCertStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Kaspersky ICS CERT
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryKasperskyICSCERTAdvisoryPaginatePagination, str]
     """
