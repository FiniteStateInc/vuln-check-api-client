...
from ...models.get_index_carestream_start_cursor import GetIndexCarestreamStartCursor
from ...models.render_response_with_metadata_array_advisory_carestream_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCarestreamStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCarestreamAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCarestreamAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCarestreamAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"carestream\"
    ...
    **Index Description:** Carestream Product Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/carestream?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCarestreamStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Carestream Product Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCarestreamAdvisoryPaginatePagination, str]
     """
