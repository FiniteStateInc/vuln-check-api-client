...
from ...models.get_index_vyaire_start_cursor import GetIndexVyaireStartCursor
from ...models.render_response_with_metadata_array_advisory_vyaire_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVyaireStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVYAIREAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVYAIREAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVYAIREAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vyaire\"
    ...
    **Index Description:** Vyaire Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vyaire?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVyaireStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Vyaire Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVYAIREAdvisoryPaginatePagination, str]
     """
