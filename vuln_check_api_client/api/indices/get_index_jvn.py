...
from ...models.get_index_jvn_start_cursor import GetIndexJvnStartCursor
from ...models.render_response_with_metadata_array_advisory_jvn_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexJvnStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryJVNPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryJVNPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryJVNPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"jvn\"
    ...
    **Index Description:** Japan Vulnerability Notes
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexJvnStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Japan Vulnerability Notes
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryJVNPaginatePagination, str]
     """
