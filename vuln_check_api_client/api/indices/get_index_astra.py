...
from ...models.get_index_astra_start_cursor import GetIndexAstraStartCursor
from ...models.render_response_with_metadata_array_advisory_astra_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAstraStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"astra\"
    ...
    **Index Description:** Astra Linux Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/astra?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAstraStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Astra Linux Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAstraPaginatePagination, str]
     """
