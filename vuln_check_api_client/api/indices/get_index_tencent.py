...
from ...models.get_index_tencent_start_cursor import GetIndexTencentStartCursor
from ...models.render_response_with_metadata_array_advisory_tencent_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTencentStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTencentPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTencentPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTencentPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"tencent\"
    ...
    **Index Description:** Tencent Vulnerability Risk Notices
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/tencent?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTencentStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Tencent Vulnerability Risk Notices
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTencentPaginatePagination, str]
     """
