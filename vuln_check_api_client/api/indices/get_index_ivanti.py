...
from ...models.get_index_ivanti_start_cursor import GetIndexIvantiStartCursor
from ...models.render_response_with_metadata_array_advisory_ivanti_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexIvantiStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryIvantiPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryIvantiPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryIvantiPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"ivanti\"
    ...
    **Index Description:** Ivanti Security Updates
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/ivanti?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexIvantiStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Ivanti Security Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryIvantiPaginatePagination, str]
     """
