...
from ...models.get_index_splunk_start_cursor import GetIndexSplunkStartCursor
from ...models.render_response_with_metadata_array_advisory_splunk_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSplunkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySplunkPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySplunkPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySplunkPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"splunk\"
    ...
    **Index Description:** Splunk Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/splunk?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSplunkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Splunk Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySplunkPaginatePagination, str]
     """
