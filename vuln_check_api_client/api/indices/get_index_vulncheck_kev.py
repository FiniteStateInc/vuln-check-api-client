...
from ...models.get_index_vulncheck_kev_start_cursor import GetIndexVulncheckKevStartCursor
from ...models.render_response_with_metadata_array_advisory_vuln_check_kev_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVulncheckKevStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vulncheck-kev\"
    ...
    **Index Description:** VulnCheck KEV
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vulncheck-kev?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVulncheckKevStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck KEV
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVulnCheckKEVPaginatePagination, str]
     """
