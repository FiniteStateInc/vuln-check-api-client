...
from ...models.get_index_netskope_start_cursor import GetIndexNetskopeStartCursor
from ...models.render_response_with_metadata_array_advisory_netskope_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexNetskopeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryNetskopePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryNetskopePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryNetskopePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"netskope\"
    ...
    **Index Description:** Netskope Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/netskope?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexNetskopeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Netskope Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryNetskopePaginatePagination, str]
     """
