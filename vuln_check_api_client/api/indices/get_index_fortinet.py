...
from ...models.get_index_fortinet_start_cursor import GetIndexFortinetStartCursor
from ...models.render_response_with_metadata_array_advisory_fortinet_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFortinetStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"fortinet\"
    ...
    **Index Description:** FortiGuard Fortinet
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/fortinet?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFortinetStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** FortiGuard Fortinet
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryFortinetAdvisoryPaginatePagination, str]
     """
