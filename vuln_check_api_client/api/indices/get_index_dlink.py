...
from ...models.get_index_dlink_start_cursor import GetIndexDlinkStartCursor
from ...models.render_response_with_metadata_array_advisory_d_link_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDlinkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDLinkPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDLinkPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDLinkPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"dlink\"
    ...
    **Index Description:** DLink Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/dlink?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDlinkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** DLink Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDLinkPaginatePagination, str]
     """
