...
if TYPE_CHECKING:
    from ..models.advisory_date_time import AdvisoryDateTime
    from ..models.advisory_package import AdvisoryPackage
    from ..models.advisory_reference import AdvisoryReference


T = TypeVar("T", bound="AdvisoryUpdate")
...
class AdvisoryUpdate:
    ...
    Attributes:
        ...
        issued (Union[Unset, AdvisoryDateTime]):
        os_arch (Union[Unset, str]):
        os_version (Union[Unset, str]):
        packages (Union[Unset, list['AdvisoryPackage']]):
        references (Union[Unset, list['AdvisoryReference']]):
        severity (Union[Unset, str]):
        title (Union[Unset, str]):
        type_ (Union[Unset, str]):
        updated (Union[Unset, AdvisoryDateTime]):
    """
    ...
    issued: Union[Unset, "AdvisoryDateTime"] = UNSET
    os_arch: Union[Unset, str] = UNSET
    os_version: Union[Unset, str] = UNSET
    packages: Union[Unset, list["AdvisoryPackage"]] = UNSET
    references: Union[Unset, list["AdvisoryReference"]] = UNSET
    severity: Union[Unset, str] = UNSET
    title: Union[Unset, str] = UNSET
    type_: Union[Unset, str] = UNSET
    updated: Union[Unset, "AdvisoryDateTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_issued, Unset):
            ...
            issued = AdvisoryDateTime.from_dict(_issued)
        ...
        for packages_item_data in _packages or []:
            packages_item = AdvisoryPackage.from_dict(packages_item_data)
        ...
        for references_item_data in _references or []:
            references_item = AdvisoryReference.from_dict(references_item_data)
        ...
        if isinstance(_updated, Unset):
            ...
            updated = AdvisoryDateTime.from_dict(_updated)
        ...
        advisory_update.additional_properties = d
