...
from ...models.get_index_spacelabs_healthcare_start_cursor import GetIndexSpacelabsHealthcareStartCursor
from ...models.render_response_with_metadata_array_advisory_spacelabs_healthcare_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSpacelabsHealthcareStartCursor] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/index/spacelabs-healthcare",
        "params": params,
    }
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"spacelabs-healthcare\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the spacelabs-healthcare
    index. \
    ...
    **Index Description:** Spacelabs Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/spacelabs-healthcare?start_cursor`,
    the response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSpacelabsHealthcareStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Spacelabs Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySpacelabsHealthcareAdvisoryPaginatePagination, str]
     """
