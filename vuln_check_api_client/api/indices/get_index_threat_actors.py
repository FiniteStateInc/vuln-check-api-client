...
from ...models.get_index_threat_actors_start_cursor import GetIndexThreatActorsStartCursor
from ...models.render_response_with_metadata_array_advisory_threat_actor_with_external_objects_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexThreatActorsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryThreatActorWithExternalObjectsPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = (
            RenderResponseWithMetadataArrayAdvisoryThreatActorWithExternalObjectsPaginatePagination.from_dict(
                response.json()
            )
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryThreatActorWithExternalObjectsPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"threat-actors\"
    ...
    **Index Description:** VulnCheck Threat Actors Data
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/threat-actors?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexThreatActorsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck Threat Actors Data
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryThreatActorWithExternalObjectsPaginatePagination, str]
     """
