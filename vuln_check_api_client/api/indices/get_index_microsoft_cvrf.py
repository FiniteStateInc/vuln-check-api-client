...
from ...models.get_index_microsoft_cvrf_start_cursor import GetIndexMicrosoftCvrfStartCursor
from ...models.render_response_with_metadata_array_advisory_microsoft_cvrf_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMicrosoftCvrfStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"microsoft-cvrf\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the microsoft-cvrf
    index. \
    ...
    **Index Description:** Microsoft Security Updates
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/microsoft-cvrf?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMicrosoftCvrfStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Microsoft Security Updates
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMicrosoftCVRFPaginatePagination, str]
     """
