...
from ...models.get_index_saint_start_cursor import GetIndexSaintStartCursor
from ...models.render_response_with_metadata_array_advisory_saint_exploit_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSaintStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySaintExploitPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySaintExploitPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySaintExploitPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"saint\"
    ...
    **Index Description:** SAINT Exploits
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/saint?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSaintStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** SAINT Exploits
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySaintExploitPaginatePagination, str]
     """
