...
from ...models.get_index_openjdk_start_cursor import GetIndexOpenjdkStartCursor
from ...models.render_response_with_metadata_array_advisory_open_jdk_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOpenjdkStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"openjdk\"
    ...
    **Index Description:** OpenJDK Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/openjdk?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOpenjdkStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** OpenJDK Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOpenJDKPaginatePagination, str]
     """
