...
from ...models.get_index_sudo_start_cursor import GetIndexSudoStartCursor
from ...models.render_response_with_metadata_array_advisory_sudo_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexSudoStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisorySudoPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisorySudoPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisorySudoPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"sudo\"
    ...
    **Index Description:** Sudo Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/sudo?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexSudoStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Sudo Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisorySudoPaginatePagination, str]
     """
