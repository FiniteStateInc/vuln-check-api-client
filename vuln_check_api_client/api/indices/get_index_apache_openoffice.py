...
from ...models.get_index_apache_openoffice_start_cursor import GetIndexApacheOpenofficeStartCursor
from ...models.render_response_with_metadata_array_advisory_apache_open_office_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexApacheOpenofficeStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"apache-openoffice\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the apache-openoffice
    index. \
    ...
    **Index Description:** Apache OpenOffice Security Bulletins
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/apache-openoffice?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexApacheOpenofficeStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Apache OpenOffice Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryApacheOpenOfficePaginatePagination, str]
     """
