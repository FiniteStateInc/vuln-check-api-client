...
from ...models.get_index_vulncheck_nvd_start_cursor import GetIndexVulncheckNvdStartCursor
from ...models.render_response_with_metadata_array_api_cve_items_extended_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVulncheckNvdStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiCveItemsExtendedPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiCveItemsExtendedPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiCveItemsExtendedPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vulncheck-nvd\"
    ...
    **Index Description:** VulnCheck NVD
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vulncheck-nvd?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVulncheckNvdStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck NVD
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiCveItemsExtendedPaginatePagination, str]
     """
