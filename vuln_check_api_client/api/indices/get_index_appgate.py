...
from ...models.get_index_appgate_start_cursor import GetIndexAppgateStartCursor
from ...models.render_response_with_metadata_array_advisory_appgate_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAppgateStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"appgate\"
    ...
    **Index Description:** Appgate SDP Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/appgate?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAppgateStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Appgate SDP Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAppgatePaginatePagination, str]
     """
