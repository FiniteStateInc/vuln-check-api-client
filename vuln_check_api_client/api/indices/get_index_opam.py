...
from ...models.get_index_opam_start_cursor import GetIndexOpamStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOpamStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"opam\"
    ...
    **Index Description:** opam (OCaml) packages with package versions
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/opam?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOpamStartCursor]):
        cve (Union[Unset, str]):
