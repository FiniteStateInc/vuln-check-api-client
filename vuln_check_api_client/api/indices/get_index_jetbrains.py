...
from ...models.get_index_jetbrains_start_cursor import GetIndexJetbrainsStartCursor
from ...models.render_response_with_metadata_array_advisory_jet_brains_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexJetbrainsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"jetbrains\"
    ...
    **Index Description:** JetBrains Security Issues
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/jetbrains?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexJetbrainsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** JetBrains Security Issues
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryJetBrainsPaginatePagination, str]
     """
