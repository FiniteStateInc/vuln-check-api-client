...
from ...models.get_index_debian_dsa_start_cursor import GetIndexDebianDsaStartCursor
from ...models.render_response_with_metadata_array_advisory_debian_security_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexDebianDsaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryDebianSecurityAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryDebianSecurityAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryDebianSecurityAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"debian-dsa\"
    ...
    **Index Description:** Debian Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/debian-dsa?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexDebianDsaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Debian Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryDebianSecurityAdvisoryPaginatePagination, str]
     """
