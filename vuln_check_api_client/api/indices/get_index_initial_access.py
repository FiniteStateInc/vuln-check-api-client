...
from ...models.get_index_initial_access_start_cursor import GetIndexInitialAccessStartCursor
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexInitialAccessStartCursor] = UNSET,
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"initial-access\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the initial-access
    index. \
    ...
    **Index Description:** VulnCheck Initial Access Intelligence
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/initial-access?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexInitialAccessStartCursor]):
        cve (Union[Unset, str]):
