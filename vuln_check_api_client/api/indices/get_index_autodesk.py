...
from ...models.get_index_autodesk_start_cursor import GetIndexAutodeskStartCursor
from ...models.render_response_with_metadata_array_advisory_autodesk_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAutodeskStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"autodesk\"
    ...
    **Index Description:** Autodesk Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/autodesk?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAutodeskStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Autodesk Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryAutodeskPaginatePagination, str]
     """
