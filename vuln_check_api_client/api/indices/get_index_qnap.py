...
from ...models.get_index_qnap_start_cursor import GetIndexQnapStartCursor
from ...models.render_response_with_metadata_array_advisory_qnap_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexQnapStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"qnap\"
    ...
    **Index Description:** QNAP Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/qnap?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexQnapStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** QNAP Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryQNAPAdvisoryPaginatePagination, str]
     """
