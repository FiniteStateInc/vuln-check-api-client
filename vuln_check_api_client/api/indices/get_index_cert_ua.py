...
from ...models.get_index_cert_ua_start_cursor import GetIndexCertUaStartCursor
from ...models.render_response_with_metadata_array_advisory_cert_ua_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexCertUaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryCertUAPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryCertUAPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryCertUAPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"cert-ua\"
    ...
    **Index Description:** Cert UA Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/cert-ua?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexCertUaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Cert UA Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryCertUAPaginatePagination, str]
     """
