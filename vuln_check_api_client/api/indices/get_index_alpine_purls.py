...
from ...models.get_index_alpine_purls_start_cursor import GetIndexAlpinePurlsStartCursor
from ...models.render_response_with_metadata_array_purls_purl_response_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexAlpinePurlsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"alpine-purls\"
    ...
    **Index Description:** Alpine Purls
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/alpine-purls?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexAlpinePurlsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Alpine Purls
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayPurlsPurlResponsePaginatePagination, str]
     """
