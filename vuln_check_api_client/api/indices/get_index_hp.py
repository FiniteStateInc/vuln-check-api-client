...
from ...models.get_index_hp_start_cursor import GetIndexHpStartCursor
from ...models.render_response_with_metadata_array_advisory_hp_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexHpStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryHPPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryHPPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryHPPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"hp\"
    ...
    **Index Description:** HP Security Bulletins
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexHpStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** HP Security Bulletins
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryHPPaginatePagination, str]
     """
