...
from ...models.get_index_vapidlabs_start_cursor import GetIndexVapidlabsStartCursor
from ...models.render_response_with_metadata_array_advisory_vapid_labs_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVapidlabsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vapidlabs\"
    ...
    **Index Description:** VapidLabs Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vapidlabs?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVapidlabsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VapidLabs Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVapidLabsAdvisoryPaginatePagination, str]
     """
