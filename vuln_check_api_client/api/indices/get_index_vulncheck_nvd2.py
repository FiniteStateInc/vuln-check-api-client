...
from ...models.get_index_vulncheck_nvd_2_start_cursor import GetIndexVulncheckNvd2StartCursor
from ...models.render_response_with_metadata_array_api_nvd20cve_extended_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVulncheckNvd2StartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayApiNVD20CVEExtendedPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayApiNVD20CVEExtendedPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayApiNVD20CVEExtendedPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"vulncheck-nvd2\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the vulncheck-nvd2
    index. \
    ...
    **Index Description:** VulnCheck NVD V2
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/vulncheck-nvd2?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVulncheckNvd2StartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** VulnCheck NVD V2
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayApiNVD20CVEExtendedPaginatePagination, str]
     """
