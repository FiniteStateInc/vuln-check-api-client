...
from ...models.get_index_owncloud_start_cursor import GetIndexOwncloudStartCursor
from ...models.render_response_with_metadata_array_advisory_own_cloud_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOwncloudStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOwnCloudPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOwnCloudPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOwnCloudPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"owncloud\"
    ...
    **Index Description:** OwnCloud Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/owncloud?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOwncloudStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** OwnCloud Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOwnCloudPaginatePagination, str]
     """
