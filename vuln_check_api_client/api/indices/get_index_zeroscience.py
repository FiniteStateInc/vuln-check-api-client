...
from ...models.get_index_zeroscience_start_cursor import GetIndexZeroscienceStartCursor
from ...models.render_response_with_metadata_array_advisory_zero_science_advisory_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexZeroscienceStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryZeroScienceAdvisoryPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryZeroScienceAdvisoryPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryZeroScienceAdvisoryPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"zeroscience\"
    ...
    **Index Description:** ZeroScience Vulnerabilities
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/zeroscience?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexZeroscienceStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** ZeroScience Vulnerabilities
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryZeroScienceAdvisoryPaginatePagination, str]
     """
