...
from ...models.get_index_trane_technology_start_cursor import GetIndexTraneTechnologyStartCursor
from ...models.render_response_with_metadata_array_advisory_trane_technology_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexTraneTechnologyStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryTraneTechnologyPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryTraneTechnologyPaginatePagination.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryTraneTechnologyPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"trane-technology\"

     ### Overview
    This endpoint allows you to retrieve a paginated list of all documents from the trane-technology
    index. \
    ...
    **Index Description:** Trane Technology Product Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/trane-technology?start_cursor`, the
    response will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexTraneTechnologyStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Trane Technology Product Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryTraneTechnologyPaginatePagination, str]
     """
