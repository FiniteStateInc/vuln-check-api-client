...
from ...models.get_index_aruba_start_cursor import GetIndexArubaStartCursor
from ...models.render_response_with_metadata_array_advisory_aruba_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexArubaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"aruba\"
    ...
    **Index Description:** Aruba Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/aruba?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexArubaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Aruba Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryArubaPaginatePagination, str]
     """
