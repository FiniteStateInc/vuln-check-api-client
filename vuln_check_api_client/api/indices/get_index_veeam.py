...
from ...models.get_index_veeam_start_cursor import GetIndexVeeamStartCursor
from ...models.render_response_with_metadata_array_advisory_veeam_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVeeamStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVeeamPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVeeamPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVeeamPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"veeam\"
    ...
    **Index Description:** Veeam Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/veeam?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVeeamStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Veeam Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVeeamPaginatePagination, str]
     """
