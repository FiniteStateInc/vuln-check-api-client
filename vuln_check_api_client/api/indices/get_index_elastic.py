...
from ...models.get_index_elastic_start_cursor import GetIndexElasticStartCursor
from ...models.render_response_with_metadata_array_advisory_elastic_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexElasticStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryElasticPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryElasticPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryElasticPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"elastic\"
    ...
    **Index Description:** Elastic Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/elastic?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexElasticStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Elastic Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryElasticPaginatePagination, str]
     """
