...
from ...models.get_index_glibc_start_cursor import GetIndexGlibcStartCursor
from ...models.render_response_with_metadata_array_advisory_glibc_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexGlibcStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryGlibcPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryGlibcPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryGlibcPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"glibc\"
    ...
    **Index Description:** Glibc Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/glibc?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexGlibcStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Glibc Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryGlibcPaginatePagination, str]
     """
