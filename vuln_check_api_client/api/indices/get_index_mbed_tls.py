...
from ...models.get_index_mbed_tls_start_cursor import GetIndexMbedTlsStartCursor
from ...models.render_response_with_metadata_array_advisory_mbed_tls_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexMbedTlsStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryMbedTLSPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryMbedTLSPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryMbedTLSPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"mbed-tls\"
    ...
    **Index Description:** Mbed TLS Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/mbed-tls?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexMbedTlsStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Mbed TLS Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryMbedTLSPaginatePagination, str]
     """
