...
from ...models.get_index_veritas_start_cursor import GetIndexVeritasStartCursor
from ...models.render_response_with_metadata_array_advisory_veritas_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexVeritasStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryVeritasPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryVeritasPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryVeritasPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"veritas\"
    ...
    **Index Description:** Veritas Security Alerts
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/veritas?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexVeritasStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Veritas Security Alerts
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryVeritasPaginatePagination, str]
     """
