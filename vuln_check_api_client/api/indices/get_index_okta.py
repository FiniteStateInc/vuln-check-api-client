...
from ...models.get_index_okta_start_cursor import GetIndexOktaStartCursor
from ...models.render_response_with_metadata_array_advisory_okta_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexOktaStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryOktaPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryOktaPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryOktaPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"okta\"
    ...
    **Index Description:** Okta Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/okta?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexOktaStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Okta Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryOktaPaginatePagination, str]
     """
