...
from ...models.get_index_festo_start_cursor import GetIndexFestoStartCursor
from ...models.render_response_with_metadata_array_advisory_festo_paginate_pagination import (
...
def _get_kwargs(
    *,
    ...
    start_cursor: Union[Unset, GetIndexFestoStartCursor] = UNSET,
...
) -> Optional[Union[RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination, str]]:
    if response.status_code == 200:
        response_200 = RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination, str]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r""" Return vulnerability data stored in index \"festo\"
    ...
    **Index Description:** Festo Security Advisories
    ...
    \"cursor\" mechanism. To use the cursor, first call `GET /index/festo?start_cursor`, the response
    will
    ...
    Args:
        ...
        start_cursor (Union[Unset, GetIndexFestoStartCursor]):
        cve (Union[Unset, str]):
...
def sync(
    ...
    **Index Description:** Festo Security Advisories
    ...
    Returns:
        Union[RenderResponseWithMetadataArrayAdvisoryFestoPaginatePagination, str]
     """
